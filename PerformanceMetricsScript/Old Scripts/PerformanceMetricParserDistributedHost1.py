...
host1_lst = ['MEASURE UNTRUSTED CREATE END', 'MEASURE UNTRUSTED CREATE SSM END', 'MEASURE TRUSTED CREATE START', 'MEASURE TRUSTED SEND START', 'MEASURE TRUSTED SEND 2 START', 'MEASURE UNTRUSTED SEND END', 'MEASURE UNTRUSTED SEND 2 END']
...
while curr_iteration < num_iterations:
    ...
    with open('PerformanceMetricsScript/PerformanceMetricsCacheDistributedHost1.txt', 'w') as file:
