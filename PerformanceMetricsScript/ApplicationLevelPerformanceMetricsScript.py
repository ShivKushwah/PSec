...
if is_host1:
    if is_perf_metrics_example:
        host_lst = ['MEASURE UNTRUSTED CREATE START', 'MEASURE UNTRUSTED CREATE SSM START', 'MEASURE TRUSTED CREATE START', 'MEASURE TRUSTED SEND END', 'MEASURE TRUSTED SEND 2 START', 'MEASURE UNTRUSTED SEND END', 'MEASURE UNTRUSTED SEND 2 END', 'MEASURE UNTRUSTED USM SEND END', 'MEASURE UNTRUSTED USM SEND 2 END']
    else:
        host_lst = []
elif is_host2:
    if is_perf_metrics_example:
