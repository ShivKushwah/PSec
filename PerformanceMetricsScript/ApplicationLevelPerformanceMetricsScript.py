...
if is_host1:
    if is_perf_metrics_example:
        host_lst = ['MEASURE UNTRUSTED CREATE START', 'MEASURE UNTRUSTED CREATE SSM START', 'MEASURE TRUSTED CREATE START', 'MEASURE TRUSTED SEND START', 'MEASURE UNTRUSTED SEND END', 'MEASURE UNTRUSTED SEND 2 END', 'MEASURE UNTRUSTED USM SEND END']
    else:
        host_lst = []
elif is_host2:
    if is_perf_metrics_example:
        host_lst = ['MEASURE UNTRUSTED CREATE END', 'MEASURE UNTRUSTED CREATE SSM END', 'MEASURE TRUSTED CREATE END', 'MEASURE TRUSTED SEND END', 'MEASURE UNTRUSTED SEND START', 'MEASURE UNTRUSTED SEND 2 START', 'MEASURE UNTRUSTED USM SEND START']
    else:
