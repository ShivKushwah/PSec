...
PRT_FUNDECL P_FUNCTION_EnclaveOneVerifyOTPCode =
{
    "EnclaveOneVerifyOTPCode",
    &P_EnclaveOneVerifyOTPCode_IMPL,
    NULL
};
...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_3 = PrtCloneValue(p_this->varValues[1]);
    ...
    *P_LVALUE_5 = PrtCloneValue((&P_EVENT_OTPSecretMsg.value));
    
    PRT_VALUE** P_LVALUE_6 = &(PTMP_tmp3);
    PrtFreeValue(*P_LVALUE_6);
    *P_LVALUE_6 = PrtCloneValue((p_this->id));
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_7 = PrtCloneValue(*P_VAR_payload_1);
    
    PRT_VALUE** P_LVALUE_8 = &(PTMP_tmp1_1);
    PrtFreeValue(*P_LVALUE_8);
    *P_LVALUE_8 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_2)), (_P_GEN_funval = P_EnclaveOneVerifyOTPCode_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_2), PTMP_tmp0_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_9 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp1_1, (&P_LIT_INT32_1)));
    ...
    if (PrtPrimGetBool(PTMP_tmp2_1))
    {
        ...
        *P_LVALUE_11 = PrtCloneValue((&P_EVENT_OTPCodeValidated.value));
        
        PrtSendInternal(context, PrtGetMachine(context->process, PTMP_tmp3_1), PTMP_tmp4, 0);
        *(&(PTMP_tmp4)) = NULL;
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_2;
        }
    ...
    else
    {
        ...
        *P_LVALUE_13 = PrtCloneValue((&P_EVENT_OTPCodeFailed.value));
...
PRT_EVENTDECL* P_WaitOTPSecret_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_WaitOTPSecret_DEFERS =
{
    0U,
    P_WaitOTPSecret_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_WaitOTPSecret_TRANS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_WaitOTPSecret_TRANS =
{
    0U,
    P_WaitOTPSecret_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_WaitOTPSecret_DOS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_WaitOTPSecret_DOS =
{
    0U,
    P_WaitOTPSecret_DOS_INNER,
    NULL
};

#define P_STATE_CLIENT_OTP_GENERATOR_WaitOTPSecret \
{ \
    "CLIENT_OTP_GENERATOR.WaitOTPSecret", \
    0U, \
    0U, \
    &P_EVENTSET_WaitOTPSecret_DEFERS, \
    &P_EVENTSET_WaitOTPSecret_TRANS, \
    &P_EVENTSET_WaitOTPSecret_DOS, \
    NULL, \
    NULL, \
    &P_FUNCTION_Anon_4, \
    &_P_NO_OP, \
...
PRT_STATEDECL P_CLIENT_OTP_GENERATOR_STATES[] = { P_STATE_CLIENT_OTP_GENERATOR_Init, P_STATE_CLIENT_OTP_GENERATOR_WaitOTPSecret, P_STATE_CLIENT_OTP_GENERATOR_GenerateOTPCode, P_STATE_CLIENT_OTP_GENERATOR_End };
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_14 = PrtCloneValue(*P_VAR_payload_2);
    ...
    *P_LVALUE_16 = PrtCloneValue((&P_EVENT_OTPSecretReceived.value));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_17 = &(PTMP_tmp0_4);
    PrtFreeValue(*P_LVALUE_17);
    *P_LVALUE_17 = ((_P_GEN_funval = P_EnclaveTwoGenerateOTPCode_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_5;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_18 = &(P_VAR_code);
        PrtFreeValue(*P_LVALUE_18);
        *P_LVALUE_18 = PTMP_tmp0_4;
        PTMP_tmp0_4 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_19 = &(PTMP_tmp1_3);
    ...
    *P_LVALUE_20 = PrtCloneValue((&P_EVENT_OTPCodeMsg.value));
    
    PRT_VALUE** P_LVALUE_21 = &(PTMP_tmp3_2);
    PrtFreeValue(*P_LVALUE_21);
    *P_LVALUE_21 = PrtCloneValue(P_VAR_code);
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp0_5);
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_23 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = PrtCloneValue(PrtMkInterface(context, 1, 0)->id);
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_24 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_25 = &(PTMP_tmp1_4);
    PrtFreeValue(*P_LVALUE_25);
    *P_LVALUE_25 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_26);
    *P_LVALUE_26 = PrtCloneValue(PrtMkInterface(context, 0, 1, &(PTMP_tmp1_4))->id);
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
