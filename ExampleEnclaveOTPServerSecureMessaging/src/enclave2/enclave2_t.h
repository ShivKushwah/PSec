...
uint32_t generate_response_enclave2(sgx_enclave_id_t src_enclave_id, secure_message_t* req_message, size_t req_message_size, size_t max_payload_size, secure_message_t* resp_message, size_t resp_message_size);
uint32_t end_session_enclave2(sgx_enclave_id_t src_enclave_id);
uint32_t test_create_session_enclave2(sgx_enclave_id_t src_enclave_id, sgx_enclave_id_t dest_enclave_id);
uint32_t test_enclave_to_enclave_call_enclave2(sgx_enclave_id_t src_enclave_id, sgx_enclave_id_t dest_enclave_id);
uint32_t test_message_exchange_enclave2(sgx_enclave_id_t src_enclave_id, sgx_enclave_id_t dest_enclave_id, char* message, int messagelen);
uint32_t test_close_session_enclave2(sgx_enclave_id_t src_enclave_id, sgx_enclave_id_t dest_enclave_id);
