...
typedef struct ms_createMachine_t {
	int ms_retval;
	char* ms_machineName;
...
sgx_status_t createMachine(sgx_enclave_id_t eid, int* retval, char* machineName, char* untrustedHostID, char* parentTrustedMachineID)
{
	sgx_status_t status;
	ms_createMachine_t ms;
