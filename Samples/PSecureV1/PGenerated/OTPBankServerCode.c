...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_18 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_20 = PrtCloneValue(*P_VAR_payload_1);
    ...
    *P_LVALUE_25 = PrtCloneValue(p_this->varValues[2]);
    ...
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp4_1);
    ...
    *P_LVALUE_29 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_1), PTMP_tmp6_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp8_1);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = PrtCloneValue(PrtCastValue(PTMP_tmp7_1, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_31 = &(PTMP_tmp0_4);
    PrtFreeValue(*P_LVALUE_31);
    *P_LVALUE_31 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp1_3);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_4)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_4), PTMP_tmp0_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_5;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_33 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_33);
    *P_LVALUE_33 = PrtTupleGet(*P_VAR_payload_2, 0);
    
    PRT_VALUE** P_LVALUE_34 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_34);
    *P_LVALUE_34 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp1_3, PTMP_tmp2_3));
    
    PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp9_1);
    PrtFreeValue(*P_LVALUE_35);
    *P_LVALUE_35 = PrtCloneValue(PTMP_tmp3_3);
    
    if (PrtPrimGetBool(PTMP_tmp9_1))
    {
        PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp4_2);
        PrtFreeValue(*P_LVALUE_36);
        *P_LVALUE_36 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_37 = &(PTMP_tmp5_2);
        PrtFreeValue(*P_LVALUE_37);
        *P_LVALUE_37 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp6_2);
        PrtFreeValue(*P_LVALUE_38);
        *P_LVALUE_38 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_2)), (_P_GEN_funargs[1] = &(PTMP_tmp5_2)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_2), PTMP_tmp4_2 = NULL), (PrtFreeValue(PTMP_tmp5_2), PTMP_tmp5_2 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_5;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_40 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp6_2, PTMP_tmp7_2));
        
        PRT_VALUE** P_LVALUE_41 = &(PTMP_tmp9_1);
        PrtFreeValue(*P_LVALUE_41);
        *P_LVALUE_41 = PrtCloneValue(PTMP_tmp8_2);
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_48 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_StringType));
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_56 = &(PTMP_tmp0_6);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp0_8);
    ...
    *P_LVALUE_65 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp2_6);
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_payload_7 = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp3_6);
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp0_9);
    ...
    *P_LVALUE_69 = PrtCloneValue(*P_VAR_payload_8);
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_74 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_7), &(PTMP_tmp3_7)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            *P_LVALUE_75 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            ...
            {
                PRT_VALUE** P_LVALUE_76 = &(p_this->varValues[2]);
                PrtFreeValue(*P_LVALUE_76);
                *P_LVALUE_76 = PTMP_tmp5_4;
                PTMP_tmp5_4 = NULL;
            }
