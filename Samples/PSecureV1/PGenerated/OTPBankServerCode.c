...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_2 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    PrtPrintf("created new client USM with key");
    ...
    *P_LVALUE_8 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionBankSSM.value));
    ...
    *P_LVALUE_11 = PrtCloneValue((&P_EVENT_BankPublicIDEvent.value));
    ...
    *P_LVALUE_13 = ((_P_GEN_funargs[0] = &(PTMP_tmp8)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8), PTMP_tmp8 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_1;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_14 = PrtCloneValue(PrtCastValue(PTMP_tmp9, &P_GEND_TYPE_machine_handle));
...
{
    { 2, &P_EVENT_AuthenticateRequest, 3, &_P_NO_OP }
};
...
PRT_STATEDECL P_BankEnclave_STATES[] = { P_STATE_BankEnclave_Initial, P_STATE_BankEnclave_ReceiveClientUSM, P_STATE_BankEnclave_AuthCheck, P_STATE_BankEnclave_Verify };
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_15 = PrtCloneValue(*P_VAR_payload);
    ...
    *P_LVALUE_19 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
    ...
    *P_LVALUE_21 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_22 = PTMP_tmp4_1;
        PTMP_tmp4_1 = NULL;
    }
    
    PrtPrintf("KIRAT-CRED");
    
    PRT_VALUE** P_LVALUE_23 = &(PTMP_tmp5_1);
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = PrtCloneValue(p_this->varValues[3]);
    
    _P_GEN_funargs[0] = &(PTMP_tmp5_1);
    PrtFreeValue(P_PrintRawSecureStringType_IMPL(context, _P_GEN_funargs));
    ...
    *P_LVALUE_24 = ((_P_GEN_funval = P_GenerateRandomMasterSecret_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_25 = &(p_this->varValues[2]);
    ...
    *P_LVALUE_29 = PrtCloneValue(p_this->varValues[2]);
    ...
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp11);
    ...
    *P_LVALUE_33 = ((_P_GEN_funargs[0] = &(PTMP_tmp13)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp13), PTMP_tmp13 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_34 = PrtCloneValue(PrtCastValue(PTMP_tmp14, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PrtPrintf("KIRAT2-CRED");
    
    PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp0_3);
    PrtFreeValue(*P_LVALUE_35);
    *P_LVALUE_35 = PrtTupleGet(*P_VAR_payload_1, 0);
    ...
    *P_LVALUE_37 = ((_P_GEN_funargs[0] = &(PTMP_tmp1_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp1_2), PTMP_tmp1_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_38 = PrtCloneValue(PrtCastValue(PTMP_tmp2_2, &P_GEND_TYPE_StringType));
    
    _P_GEN_funargs[0] = &(PTMP_tmp3_2);
    PrtFreeValue(P_PrintString_IMPL(context, _P_GEN_funargs));
    PrtFreeValue(PTMP_tmp3_2);
    PTMP_tmp3_2 = NULL;
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    ...
    *P_LVALUE_41 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp7_2);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp5_2, PTMP_tmp6_2));
    
    if (PrtPrimGetBool(PTMP_tmp7_2))
    {
        PrtPrintf("YEETKIRAT");
    ...
    *P_LVALUE_43 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp9_2);
    PrtFreeValue(*P_LVALUE_44);
    *P_LVALUE_44 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp10_2);
    PrtFreeValue(*P_LVALUE_45);
    *P_LVALUE_45 = ((_P_GEN_funargs[0] = &(PTMP_tmp8_2)), (_P_GEN_funargs[1] = &(PTMP_tmp9_2)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8_2), PTMP_tmp8_2 = NULL), (PrtFreeValue(PTMP_tmp9_2), PTMP_tmp9_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_46 = PrtTupleGet(*P_VAR_payload_1, 1);
    ...
    PRT_VALUE** P_LVALUE_47 = &(PTMP_tmp12_1);
    PrtFreeValue(*P_LVALUE_47);
    *P_LVALUE_47 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp10_2, PTMP_tmp11_1));
    
    if (PrtPrimGetBool(PTMP_tmp12_1))
    {
        PrtPrintf("YEETKIRAT2");
    ...
    PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp13_1);
    PrtFreeValue(*P_LVALUE_48);
    *P_LVALUE_48 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp14_1);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = ((_P_GEN_funargs[0] = &(PTMP_tmp13_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp13_1), PTMP_tmp13_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_50 = &(PTMP_tmp15_1);
    PrtFreeValue(*P_LVALUE_50);
    *P_LVALUE_50 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp16);
    PrtFreeValue(*P_LVALUE_51);
    *P_LVALUE_51 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp14_1, PTMP_tmp15_1));
    
    PRT_VALUE** P_LVALUE_52 = &(PTMP_tmp22);
    PrtFreeValue(*P_LVALUE_52);
    *P_LVALUE_52 = PrtCloneValue(PTMP_tmp16);
    
    if (PrtPrimGetBool(PTMP_tmp22))
    {
        PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp17);
        ...
        *P_LVALUE_54 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
        ...
        PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp19);
        PrtFreeValue(*P_LVALUE_55);
        *P_LVALUE_55 = ((_P_GEN_funargs[0] = &(PTMP_tmp17)), (_P_GEN_funargs[1] = &(PTMP_tmp18)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp17), PTMP_tmp17 = NULL), (PrtFreeValue(PTMP_tmp18), PTMP_tmp18 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_4;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_56 = PrtTupleGet(*P_VAR_payload_1, 1);
        
        PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp21);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp19, PTMP_tmp20));
        
        PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp22);
        PrtFreeValue(*P_LVALUE_58);
        *P_LVALUE_58 = PrtCloneValue(PTMP_tmp21);
    ...
    if (PrtPrimGetBool(PTMP_tmp22))
    {
        ...
        *P_LVALUE_59 = PrtCloneValue(p_this->varValues[1]);
        ...
        PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp24);
        PrtFreeValue(*P_LVALUE_60);
        *P_LVALUE_60 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    {
        PRT_VALUE** P_LVALUE_61 = &(PTMP_tmp25);
        PrtFreeValue(*P_LVALUE_61);
        *P_LVALUE_61 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp26);
        PrtFreeValue(*P_LVALUE_62);
        *P_LVALUE_62 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_63 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtCloneValue(*P_VAR_payload_2);
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_64 = PrtCloneValue(*P_VAR_payload_3);
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_66 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp1_3);
    PrtFreeValue(*P_LVALUE_67);
    *P_LVALUE_67 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_68);
    *P_LVALUE_68 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_5)), (_P_GEN_funargs[1] = &(PTMP_tmp1_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_5), PTMP_tmp0_5 = NULL), (PrtFreeValue(PTMP_tmp1_3), PTMP_tmp1_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_69 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_69);
        *P_LVALUE_69 = PTMP_tmp2_3;
        PTMP_tmp2_3 = NULL;
    }
    
    PrtPrintf("KIRAT3-CRED");
    ...
    *P_LVALUE_72 = PrtCloneValue(P_VAR_hashedString);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_77 = PrtCloneValue(*P_VAR_payload_5);
    
    PrtPrintf("Client Web Browser: Enter Credentials to login to bank!\n");
    
    PRT_VALUE** P_LVALUE_78 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_78);
    *P_LVALUE_78 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_9;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_79 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_79);
        *P_LVALUE_79 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_81 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_82 = &(PTMP_tmp2_4);
    PrtFreeValue(*P_LVALUE_82);
    *P_LVALUE_82 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE* P_PTMP_tmp_8 = PrtCloneValue(&(P_LIT_INT32_4));
    ...
    switch (P_eventId) {
        case 2: {
            ...
            *P_LVALUE_83 = PrtCloneValue(*P_VAR_payload_6);
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_84 = PrtCloneValue(*P_VAR_payload_7);
    ...
    *P_LVALUE_85 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_86 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_87 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_87);
    *P_LVALUE_87 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    
    PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp2_5);
    ...
    *P_LVALUE_89 = PrtCloneValue(p_this->varValues[3]);
    ...
    PRT_VALUE** P_LVALUE_90 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_90);
    *P_LVALUE_90 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_5), &(PTMP_tmp3_5)));
    
    PRT_VALUE* P_PTMP_tmp_9 = PrtCloneValue(&(P_LIT_INT32_5));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            *P_LVALUE_91 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_13;
            }
            if (p_this->isHalted == PRT_TRUE) {
...
PRT_FUNDECL* P_ClientWebBrowser_METHODS[] = { &P_FUNCTION_Anon_8, &P_FUNCTION_Anon_9, &P_FUNCTION_Anon_10, &P_FUNCTION_Anon_11, &P_FUNCTION_Anon_12, &P_FUNCTION_Anon_13 };
...
PRT_FOREIGNTYPEDECL* P_ALL_FOREIGN_TYPES[] = { &P_machine_handle, &P_secure_StringType, &P_StringType, &P_secure_machine_handle, &P_capability };
