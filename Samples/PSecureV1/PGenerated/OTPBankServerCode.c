...
PRT_VARDECL P_BankEnclave_VARS[] = {
    ...
    { "clientUSM", &P_GEND_TYPE_machine_handle },
    { "registeredCredentials", &P_GEND_TYPE_MKStringTypeVStringType },
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_username = PrtMkDefaultValue(&P_GEND_TYPE_StringType);
    PRT_VALUE* P_VAR_password = PrtMkDefaultValue(&P_GEND_TYPE_StringType);
    ...
    *P_LVALUE_19 = PrtTupleGet(*P_VAR_payload, 2);
    ...
    {
        PRT_VALUE** P_LVALUE_20 = &(P_VAR_password);
    ...
    *P_LVALUE_21 = ((_P_GEN_funval = P_GenerateRandomMasterSecret_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_22 = &(P_VAR_masterSecret);
        PrtFreeValue(*P_LVALUE_22);
        *P_LVALUE_22 = PTMP_tmp3_2;
        PTMP_tmp3_2 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_23 = &(*(PrtMapGetLValue(p_this->varValues[2], P_VAR_username, PRT_TRUE, &P_GEND_TYPE_MKStringTypeVStringType)));
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = PrtCloneValue(P_VAR_password);
    
    PRT_VALUE** P_LVALUE_24 = &(*(PrtMapGetLValue(p_this->varValues[3], P_VAR_username, PRT_TRUE, &P_GEND_TYPE_MKStringTypeVStringType)));
    PrtFreeValue(*P_LVALUE_24);
    *P_LVALUE_24 = PrtCloneValue(P_VAR_masterSecret);
    ...
    *P_LVALUE_25 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_31 = PrtCloneValue((&P_EVENT_MasterSecretEvent.value));
    
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp10);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = PrtCloneValue(P_VAR_masterSecret);
    ...
    *P_LVALUE_34 = PrtCloneValue((&P_EVENT_PublicIDEvent.value));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_inputUsername = PrtMkDefaultValue(&P_GEND_TYPE_StringType);
    PRT_VALUE* P_VAR_inputPassword = PrtMkDefaultValue(&P_GEND_TYPE_StringType);
    ...
    PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp0_4);
    PrtFreeValue(*P_LVALUE_36);
    *P_LVALUE_36 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    {
        PRT_VALUE** P_LVALUE_37 = &(P_VAR_inputUsername);
        PrtFreeValue(*P_LVALUE_37);
        *P_LVALUE_37 = PTMP_tmp0_4;
        PTMP_tmp0_4 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp1_3);
    PrtFreeValue(*P_LVALUE_38);
    *P_LVALUE_38 = PrtTupleGet(*P_VAR_payload_1, 1);
    
    {
        PRT_VALUE** P_LVALUE_39 = &(P_VAR_inputPassword);
        PrtFreeValue(*P_LVALUE_39);
        *P_LVALUE_39 = PTMP_tmp1_3;
        PTMP_tmp1_3 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_40);
    *P_LVALUE_40 = PrtMapGet(p_this->varValues[3], P_VAR_inputUsername);
    
    {
        PRT_VALUE** P_LVALUE_41 = &(P_VAR_masterSecret_1);
        PrtFreeValue(*P_LVALUE_41);
        *P_LVALUE_41 = PTMP_tmp2_3;
        PTMP_tmp2_3 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtMapGet(p_this->varValues[2], P_VAR_inputUsername);
    
    PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp4_2);
    PrtFreeValue(*P_LVALUE_43);
    *P_LVALUE_43 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp3_3, P_VAR_inputPassword));
    
    PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp10_1);
    PrtFreeValue(*P_LVALUE_44);
    *P_LVALUE_44 = PrtCloneValue(PTMP_tmp4_2);
    
    if (PrtPrimGetBool(PTMP_tmp10_1))
    {
        PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp5_1);
        PrtFreeValue(*P_LVALUE_45);
        *P_LVALUE_45 = PrtCloneValue(P_VAR_masterSecret_1);
        
        PRT_VALUE** P_LVALUE_46 = &(PTMP_tmp6_1);
        PrtFreeValue(*P_LVALUE_46);
        *P_LVALUE_46 = PrtCloneValue(P_VAR_inputPassword);
        
        PRT_VALUE** P_LVALUE_47 = &(PTMP_tmp7_1);
        PrtFreeValue(*P_LVALUE_47);
        *P_LVALUE_47 = ((_P_GEN_funargs[0] = &(PTMP_tmp5_1)), (_P_GEN_funargs[1] = &(PTMP_tmp6_1)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp5_1), PTMP_tmp5_1 = NULL), (PrtFreeValue(PTMP_tmp6_1), PTMP_tmp6_1 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_5;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_48 = PrtTupleGet(*P_VAR_payload_1, 2);
        
        PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp9_1);
        PrtFreeValue(*P_LVALUE_49);
        *P_LVALUE_49 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp7_1, PTMP_tmp8_1));
        
        PRT_VALUE** P_LVALUE_50 = &(PTMP_tmp10_1);
        PrtFreeValue(*P_LVALUE_50);
        *P_LVALUE_50 = PrtCloneValue(PTMP_tmp9_1);
    ...
    if (PrtPrimGetBool(PTMP_tmp10_1))
    {
        ...
        *P_LVALUE_52 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    else
    {
        ...
        *P_LVALUE_53 = PrtCloneValue(p_this->varValues[1]);
        ...
        PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp14);
        PrtFreeValue(*P_LVALUE_54);
        *P_LVALUE_54 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_56 = PrtCloneValue(*P_VAR_payload_3);
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp0_5);
    ...
    *P_LVALUE_58 = PrtCloneValue(*P_VAR_password_1);
    
    PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp2_4);
    PrtFreeValue(*P_LVALUE_59);
    *P_LVALUE_59 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_5)), (_P_GEN_funargs[1] = &(PTMP_tmp1_4)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_5), PTMP_tmp0_5 = NULL), (PrtFreeValue(PTMP_tmp1_4), PTMP_tmp1_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_60 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_60);
        *P_LVALUE_60 = PTMP_tmp2_4;
        PTMP_tmp2_4 = NULL;
    }
    ...
    *P_LVALUE_62 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp5_2);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtCloneValue(P_VAR_hashedString);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_65 = ((_P_GEN_funval = P_GetUsernameInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_67 = ((_P_GEN_funval = P_GetPasswordInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_69 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_70 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_70);
    *P_LVALUE_70 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveRegistrationCredentials.value));
    ...
    *P_LVALUE_72 = PrtCloneValue(p_this->varValues[2]);
    ...
    PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp6_2);
    PrtFreeValue(*P_LVALUE_73);
    *P_LVALUE_73 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp7_2);
    PrtFreeValue(*P_LVALUE_74);
    *P_LVALUE_74 = (PrtMkTuple(&P_GEND_TYPE_T3machine_handleStringTypeStringType, &(PTMP_tmp4_4), &(PTMP_tmp5_3), &(PTMP_tmp6_2)));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_76 = PrtMkStringValue(PrtFormatString("ClientEnclave", 0, 0));
    ;
    
    {
        PRT_VALUE** P_LVALUE_77 = &(P_VAR_machineTypeToValidate);
    ...
    *P_LVALUE_79 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_80 = &(PTMP_tmp3_6);
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_payload_6 = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_81 = &(PTMP_tmp4_5);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_82 = PrtCloneValue(*P_VAR_payload_7);
    ...
    PRT_VALUE** P_LVALUE_83 = &(p_this->varValues[4]);
    PrtFreeValue(*P_LVALUE_83);
    *P_LVALUE_83 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_85 = PrtCloneValue((&P_EVENT_UNTRUSTEDAuthenticateRequest.value));
    ...
    *P_LVALUE_87 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_88);
    *P_LVALUE_88 = PrtCloneValue(p_this->varValues[4]);
    
    PRT_VALUE** P_LVALUE_89 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_89);
    *P_LVALUE_89 = (PrtMkTuple(&P_GEND_TYPE_T3StringTypeStringTypeStringType, &(PTMP_tmp2_7), &(PTMP_tmp3_7), &(PTMP_tmp4_6)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            *P_LVALUE_90 = ((_P_GEN_funval = P_GetUsernameInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_15;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            
            {
                ...
                *P_LVALUE_91 = PTMP_tmp6_3;
                PTMP_tmp6_3 = NULL;
            }
            
            PRT_VALUE** P_LVALUE_92 = &(PTMP_tmp7_3);
            PrtFreeValue(*P_LVALUE_92);
            *P_LVALUE_92 = ((_P_GEN_funval = P_GetPasswordInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_15;
            }
            if (p_this->isHalted == PRT_TRUE) {
