...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_8 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_secure_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_17 = ((_P_GEN_funargs[0] = &(PTMP_tmp1_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp1_1), PTMP_tmp1_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_18 = PrtCloneValue(PrtCastValue(PTMP_tmp2_1, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_19 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_19);
        *P_LVALUE_19 = PTMP_tmp3_1;
        PTMP_tmp3_1 = NULL;
    }
    ...
    *P_LVALUE_21 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
    
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp6_1);
    PrtFreeValue(*P_LVALUE_22);
    *P_LVALUE_22 = PrtCloneValue(PrtCastValue(p_this->varValues[1], &P_GEND_TYPE_secure_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_23 = PrtCloneValue(*P_VAR_payload_1);
    ...
    *P_LVALUE_32 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_2), PTMP_tmp6_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_33 = PrtCloneValue(PrtCastValue(PTMP_tmp7_1, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_35 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_4)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_4), PTMP_tmp0_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_5;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_36 = PrtTupleGet(*P_VAR_payload_2, 0);
    
    PRT_VALUE** P_LVALUE_37 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_37);
    *P_LVALUE_37 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp1_3, PTMP_tmp2_3));
    
    PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp9_1);
    PrtFreeValue(*P_LVALUE_38);
    *P_LVALUE_38 = PrtCloneValue(PTMP_tmp3_3);
    
    if (PrtPrimGetBool(PTMP_tmp9_1))
    {
        PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp4_3);
        PrtFreeValue(*P_LVALUE_39);
        *P_LVALUE_39 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp5_3);
        PrtFreeValue(*P_LVALUE_40);
        *P_LVALUE_40 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_41 = &(PTMP_tmp6_3);
        PrtFreeValue(*P_LVALUE_41);
        *P_LVALUE_41 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_3)), (_P_GEN_funargs[1] = &(PTMP_tmp5_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_3), PTMP_tmp4_3 = NULL), (PrtFreeValue(PTMP_tmp5_3), PTMP_tmp5_3 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_5;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_42 = PrtTupleGet(*P_VAR_payload_2, 1);
        
        PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp8_2);
        PrtFreeValue(*P_LVALUE_43);
        *P_LVALUE_43 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp6_3, PTMP_tmp7_2));
        
        PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp9_1);
        PrtFreeValue(*P_LVALUE_44);
        *P_LVALUE_44 = PrtCloneValue(PTMP_tmp8_2);
    ...
    if (PrtPrimGetBool(PTMP_tmp9_1))
    {
        ...
        PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp10);
        PrtFreeValue(*P_LVALUE_45);
        *P_LVALUE_45 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_46 = &(PTMP_tmp11);
        PrtFreeValue(*P_LVALUE_46);
        *P_LVALUE_46 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    else
    {
        ...
        PRT_VALUE** P_LVALUE_47 = &(PTMP_tmp12);
        ...
        *P_LVALUE_48 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp0_5);
    ...
    *P_LVALUE_50 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_5)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_5), PTMP_tmp0_5 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_51 = PrtCloneValue(PrtCastValue(PTMP_tmp1_4, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_52 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_52);
        *P_LVALUE_52 = PTMP_tmp2_4;
        PTMP_tmp2_4 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_53 = PrtCloneValue(*P_VAR_payload_4);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_54);
    *P_LVALUE_54 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_55);
    *P_LVALUE_55 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_56 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_56);
    *P_LVALUE_56 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_6)), (_P_GEN_funargs[1] = &(PTMP_tmp1_5)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_6), PTMP_tmp0_6 = NULL), (PrtFreeValue(PTMP_tmp1_5), PTMP_tmp1_5 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_9;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_57 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PTMP_tmp2_5;
        PTMP_tmp2_5 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp3_4);
    ...
    *P_LVALUE_59 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_60);
    *P_LVALUE_60 = PrtCloneValue(P_VAR_hashedString);
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_61 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_61);
    *P_LVALUE_61 = PrtCloneValue(*P_VAR_payload_5);
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp0_7);
    ...
    *P_LVALUE_62 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    {
        PRT_VALUE** P_LVALUE_63 = &(P_VAR_credentials);
        PrtFreeValue(*P_LVALUE_63);
        *P_LVALUE_63 = PTMP_tmp0_7;
        PTMP_tmp0_7 = NULL;
    }
    ...
    PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_64);
    *P_LVALUE_64 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp2_6);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveRegistrationCredentials.value));
    
    PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_66);
    *P_LVALUE_66 = PrtCloneValue(P_VAR_credentials);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_67 = PrtCloneValue(*P_VAR_payload_6);
    
    PrtPrintf("Client Web Browser: Enter Credentials to login to bank!\n");
    
    PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_68);
    *P_LVALUE_68 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_12;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_payload_7 = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp3_6);
            PrtFreeValue(*P_LVALUE_73);
            *P_LVALUE_73 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp0_10);
    ...
    *P_LVALUE_75 = PrtCloneValue(*P_VAR_payload_8);
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_76);
    *P_LVALUE_76 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_77 = &(PTMP_tmp1_8);
    PrtFreeValue(*P_LVALUE_77);
    *P_LVALUE_77 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    
    PRT_VALUE** P_LVALUE_78 = &(PTMP_tmp2_8);
    ...
    *P_LVALUE_80 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_8), &(PTMP_tmp3_7)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            PRT_VALUE** P_LVALUE_81 = &(PTMP_tmp5_5);
