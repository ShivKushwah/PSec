...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_21 = ((_P_GEN_funval = P_GenerateRandomMasterSecret_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    {
        PRT_VALUE** P_LVALUE_22 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_22);
        *P_LVALUE_22 = PTMP_tmp5_1;
        PTMP_tmp5_1 = NULL;
    }
    ...
    *P_LVALUE_24 = PrtCloneValue((&P_EVENT_MasterSecretEvent.value));
    ...
    *P_LVALUE_27 = PrtCloneValue((&P_EVENT_PublicIDEvent.value));
    
    PRT_VALUE** P_LVALUE_28 = &(PTMP_tmp11);
    PrtFreeValue(*P_LVALUE_28);
    *P_LVALUE_28 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_29 = &(PTMP_tmp0_3);
    PrtFreeValue(*P_LVALUE_29);
    *P_LVALUE_29 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp1_2);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[3], PTMP_tmp0_3));
    
    PRT_VALUE** P_LVALUE_31 = &(PTMP_tmp7_2);
    ...
    *P_LVALUE_31 = PrtCloneValue(PTMP_tmp1_2);
    ...
    if (PrtPrimGetBool(PTMP_tmp7_2))
    {
        ...
        *P_LVALUE_32 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
        ...
        *P_LVALUE_34 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_2)), (_P_GEN_funargs[1] = &(PTMP_tmp3_2)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_2), PTMP_tmp2_2 = NULL), (PrtFreeValue(PTMP_tmp3_2), PTMP_tmp3_2 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_4;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_35 = PrtTupleGet(*P_VAR_payload_1, 1);
        
        PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp6_2);
        PrtFreeValue(*P_LVALUE_36);
        *P_LVALUE_36 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp4_2, PTMP_tmp5_2));
        
        PRT_VALUE** P_LVALUE_37 = &(PTMP_tmp7_2);
        PrtFreeValue(*P_LVALUE_37);
        *P_LVALUE_37 = PrtCloneValue(PTMP_tmp6_2);
    ...
    if (PrtPrimGetBool(PTMP_tmp7_2))
    {
        PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp8_2);
        ...
        *P_LVALUE_39 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    else
    {
        ...
        *P_LVALUE_41 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_42 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtCloneValue(*P_VAR_payload_2);
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_43 = &(p_this->varValues[0]);
    PrtFreeValue(*P_LVALUE_43);
    *P_LVALUE_43 = PrtCloneValue(*P_VAR_payload_3);
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_masterSecretDeclassifed = PrtMkDefaultValue(&P_GEND_TYPE_StringType);
    ...
    PrtPrintf("debug-1 bro");
    
    PrtPrintf("yellokirat2");
    
    PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp0_4);
    ...
    *P_LVALUE_45 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_StringType));
    
    {
        PRT_VALUE** P_LVALUE_46 = &(P_VAR_masterSecretDeclassifed);
        PrtFreeValue(*P_LVALUE_46);
        *P_LVALUE_46 = PTMP_tmp1_3;
        PTMP_tmp1_3 = NULL;
    }
    
    PrtPrintf("debug0 bro");
    
    PRT_VALUE** P_LVALUE_47 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_47);
    *P_LVALUE_47 = PrtCloneValue(P_VAR_masterSecretDeclassifed);
    ...
    *P_LVALUE_49 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_3)), (_P_GEN_funargs[1] = &(PTMP_tmp3_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_3), PTMP_tmp2_3 = NULL), (PrtFreeValue(PTMP_tmp3_3), PTMP_tmp3_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_50 = PTMP_tmp4_3;
        PTMP_tmp4_3 = NULL;
    }
    
    PrtPrintf("debug bro");
    
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp5_3);
    ...
    *P_LVALUE_53 = PrtCloneValue(P_VAR_hashedString);
    ...
    PrtPrintf("debug2 bro");
    
p_return_7: ;
    PrtFreeValue(P_VAR_hashedString); P_VAR_hashedString = NULL;
    PrtFreeValue(P_VAR_masterSecretDeclassifed); P_VAR_masterSecretDeclassifed = NULL;
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_59 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_62 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_62);
    *P_LVALUE_62 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_64 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_66);
    *P_LVALUE_66 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_67);
    *P_LVALUE_67 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_5), &(PTMP_tmp3_5)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp5_4);
