...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_11 = ((_P_GEN_funargs[0] = &(PTMP_tmp6)), (_P_GEN_funval = P_CastHandle_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6), PTMP_tmp6 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_1;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_12 = PrtCloneValue(*P_VAR_payload);
    
    PRT_VALUE** P_LVALUE_13 = &(PTMP_tmp0_2);
    ...
    *P_LVALUE_16 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_17 = PTMP_tmp2_1;
        PTMP_tmp2_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_18 = &(PTMP_tmp3_1);
    PrtFreeValue(*P_LVALUE_18);
    *P_LVALUE_18 = ((_P_GEN_funval = P_GenerateRandomMasterSecret_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_19 = &(p_this->varValues[2]);
    ...
    *P_LVALUE_21 = PrtCloneValue((&P_EVENT_MasterSecretEvent.value));
    
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp6_1);
    PrtFreeValue(*P_LVALUE_22);
    *P_LVALUE_22 = PrtCloneValue(p_this->varValues[2]);
    ...
    *P_LVALUE_23 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_24 = &(PTMP_tmp8);
    PrtFreeValue(*P_LVALUE_24);
    *P_LVALUE_24 = PrtCloneValue((&P_EVENT_PublicIDEvent.value));
    
    PRT_VALUE** P_LVALUE_25 = &(PTMP_tmp9);
    ...
    *P_LVALUE_26 = ((_P_GEN_funargs[0] = &(PTMP_tmp9)), (_P_GEN_funval = P_CastHandle_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp9), PTMP_tmp9 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_27 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    PRT_VALUE** P_LVALUE_28 = &(PTMP_tmp1_2);
    PrtFreeValue(*P_LVALUE_28);
    *P_LVALUE_28 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[3], PTMP_tmp0_3));
    
    PRT_VALUE** P_LVALUE_29 = &(PTMP_tmp7_2);
    PrtFreeValue(*P_LVALUE_29);
    *P_LVALUE_29 = PrtCloneValue(PTMP_tmp1_2);
    
    if (PrtPrimGetBool(PTMP_tmp7_2))
    {
        PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp2_2);
        PrtFreeValue(*P_LVALUE_30);
        *P_LVALUE_30 = PrtCloneValue(p_this->varValues[2]);
        ...
        *P_LVALUE_32 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_2)), (_P_GEN_funargs[1] = &(PTMP_tmp3_2)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_2), PTMP_tmp2_2 = NULL), (PrtFreeValue(PTMP_tmp3_2), PTMP_tmp3_2 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_3;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_33 = &(PTMP_tmp5_2);
        PrtFreeValue(*P_LVALUE_33);
        *P_LVALUE_33 = PrtTupleGet(*P_VAR_payload_1, 1);
        
        PRT_VALUE** P_LVALUE_34 = &(PTMP_tmp6_2);
        PrtFreeValue(*P_LVALUE_34);
        *P_LVALUE_34 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp4_2, PTMP_tmp5_2));
        
        PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp7_2);
        PrtFreeValue(*P_LVALUE_35);
        *P_LVALUE_35 = PrtCloneValue(PTMP_tmp6_2);
    ...
    if (PrtPrimGetBool(PTMP_tmp7_2))
    {
        PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp8_1);
        ...
        *P_LVALUE_37 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    else
    {
        ...
        *P_LVALUE_38 = PrtCloneValue(p_this->varValues[1]);
        ...
        PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp11);
        PrtFreeValue(*P_LVALUE_39);
        *P_LVALUE_39 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_40 = PrtCloneValue(*P_VAR_payload_2);
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_41 = &(p_this->varValues[0]);
    PrtFreeValue(*P_LVALUE_41);
    *P_LVALUE_41 = PrtCloneValue(*P_VAR_payload_3);
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_43 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_44);
    *P_LVALUE_44 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp3_3);
    ...
    *P_LVALUE_46 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_3)), (_P_GEN_funargs[1] = &(PTMP_tmp3_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_3), PTMP_tmp2_3 = NULL), (PrtFreeValue(PTMP_tmp3_3), PTMP_tmp3_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_6;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_49 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp0_6);
    ...
    *P_LVALUE_52 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    ...
    *P_LVALUE_53 = PrtCloneValue(p_this->varValues[2]);
    ...
    switch (P_eventId) {
        case 2: {
            ...
            *P_LVALUE_54 = PrtCloneValue(*P_VAR_payload_6);
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_55);
    *P_LVALUE_55 = PrtCloneValue(*P_VAR_payload_7);
    ...
    *P_LVALUE_56 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_58 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    ...
    *P_LVALUE_61 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_5), &(PTMP_tmp3_5)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp5_3);
