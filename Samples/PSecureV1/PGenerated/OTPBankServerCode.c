...
PRT_STATEDECL P_BankEnclave_STATES[] = { P_STATE_BankEnclave_Initial, P_STATE_BankEnclave_RegisterNewBankAccount, P_STATE_BankEnclave_AuthCheck, P_STATE_BankEnclave_Verify };
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_17 = PrtTupleGet(*P_VAR_payload, 1);
    ...
    {
        PRT_VALUE** P_LVALUE_18 = &(p_this->varValues[3]);
    ...
    *P_LVALUE_21 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_24 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
    
    PRT_VALUE** P_LVALUE_25 = &(PTMP_tmp6);
    ...
    *P_LVALUE_27 = PrtCloneValue((&P_EVENT_MasterSecretEvent.value));
    ...
    PRT_VALUE** P_LVALUE_28 = &(PTMP_tmp9);
    ...
    *P_LVALUE_28 = PrtCloneValue(p_this->varValues[2]);
    ...
    PRT_VALUE** P_LVALUE_29 = &(PTMP_tmp10);
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp0_4);
    ...
    *P_LVALUE_33 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[3], PTMP_tmp0_4));
    
    PRT_VALUE** P_LVALUE_34 = &(PTMP_tmp7_1);
    ...
    *P_LVALUE_34 = PrtCloneValue(PTMP_tmp1_3);
    ...
    if (PrtPrimGetBool(PTMP_tmp7_1))
    {
        ...
        *P_LVALUE_35 = PrtCloneValue(p_this->varValues[2]);
        ...
        PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp3_3);
        ...
        *P_LVALUE_37 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_3)), (_P_GEN_funargs[1] = &(PTMP_tmp3_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_3), PTMP_tmp2_3 = NULL), (PrtFreeValue(PTMP_tmp3_3), PTMP_tmp3_3 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_5;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp5_1);
        PrtFreeValue(*P_LVALUE_38);
        *P_LVALUE_38 = PrtTupleGet(*P_VAR_payload_1, 1);
        
        PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp6_1);
        PrtFreeValue(*P_LVALUE_39);
        *P_LVALUE_39 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp4_2, PTMP_tmp5_1));
        
        PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp7_1);
        PrtFreeValue(*P_LVALUE_40);
        *P_LVALUE_40 = PrtCloneValue(PTMP_tmp6_1);
    ...
    if (PrtPrimGetBool(PTMP_tmp7_1))
    {
        ...
        PRT_VALUE** P_LVALUE_41 = &(PTMP_tmp8_1);
        ...
        *P_LVALUE_42 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    else
    {
        ...
        *P_LVALUE_44 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_45 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_45);
    *P_LVALUE_45 = PrtCloneValue(*P_VAR_payload_2);
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_48 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp2_4);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_5)), (_P_GEN_funargs[1] = &(PTMP_tmp1_4)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_5), PTMP_tmp0_5 = NULL), (PrtFreeValue(PTMP_tmp1_4), PTMP_tmp1_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_50 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_50);
        *P_LVALUE_50 = PTMP_tmp2_4;
        PTMP_tmp2_4 = NULL;
    }
    ...
    *P_LVALUE_52 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp5_2);
    PrtFreeValue(*P_LVALUE_53);
    *P_LVALUE_53 = PrtCloneValue(P_VAR_hashedString);
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_54 = PrtCloneValue(*P_VAR_payload_4);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_55);
    *P_LVALUE_55 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_56 = &(P_VAR_credentials);
        PrtFreeValue(*P_LVALUE_56);
        *P_LVALUE_56 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
    ...
    *P_LVALUE_58 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveRegistrationCredentials.value));
    
    PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_59);
    *P_LVALUE_59 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    
    PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp4_4);
    ...
    *P_LVALUE_61 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handleStringType, &(PTMP_tmp3_5), &(PTMP_tmp4_4)));
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_62 = PrtCloneValue(*P_VAR_payload_5);
    
    PrtPrintf("Client Web Browser: Enter Credentials to login to bank!\n");
    
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_11;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtMkStringValue(PrtFormatString("ClientEnclave", 0, 0));
    ;
    
    {
        PRT_VALUE** P_LVALUE_66 = &(P_VAR_machineTypeToValidate);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = PTMP_tmp0_8;
        PTMP_tmp0_8 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_71 = &(PTMP_tmp0_9);
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp0_10);
    ...
    *P_LVALUE_75 = PrtCloneValue(p_this->varValues[2]);
    ...
    PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp3_7);
    PrtFreeValue(*P_LVALUE_76);
    *P_LVALUE_76 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_77 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_77);
    *P_LVALUE_77 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_7), &(PTMP_tmp3_7)));
