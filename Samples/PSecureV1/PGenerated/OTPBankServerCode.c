...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_11 = ((_P_GEN_funargs[0] = &(PTMP_tmp4)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4), PTMP_tmp4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_12 = PrtCloneValue(PrtCastValue(PTMP_tmp5, &P_GEND_TYPE_secure_machine_handle));
    ...
    *P_LVALUE_14 = PrtCloneValue((&P_EVENT_BankPublicIDEvent.value));
    ...
    *P_LVALUE_16 = ((_P_GEN_funargs[0] = &(PTMP_tmp9)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp9), PTMP_tmp9 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_17 = PrtCloneValue(PrtCastValue(PTMP_tmp10, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_20 = PrtCloneValue(p_this->varValues[0]);
    ...
    PRT_VALUE** P_LVALUE_21 = &(PTMP_tmp2_1);
    PrtFreeValue(*P_LVALUE_21);
    *P_LVALUE_21 = PrtCloneValue((&P_EVENT_TRUSTEDMeasureEvent1.value));
    
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp3_1);
    PrtFreeValue(*P_LVALUE_22);
    *P_LVALUE_22 = PrtCloneValue((&P_LIT_INT32_1));
    
    PRT_VALUE** P_LVALUE_23 = &(PTMP_tmp4_1);
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = ((_P_GEN_funargs[0] = &(PTMP_tmp3_1)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp3_1), PTMP_tmp3_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_24 = PrtCloneValue(PrtCastValue(PTMP_tmp4_1, &P_GEND_TYPE_s));
    
    PRT_VALUE** P_LVALUE_25 = &(PTMP_tmp6_1);
    PrtFreeValue(*P_LVALUE_25);
    *P_LVALUE_25 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_26 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_1)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_1), PTMP_tmp6_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_27 = &(PTMP_tmp8_1);
    PrtFreeValue(*P_LVALUE_27);
    *P_LVALUE_27 = PrtCloneValue(PrtCastValue(PTMP_tmp7_1, &P_GEND_TYPE_secure_StringType));
    
    PRT_VALUE** P_LVALUE_28 = &(PTMP_tmp9_1);
    PrtFreeValue(*P_LVALUE_28);
    *P_LVALUE_28 = (PrtMkTuple(&P_GEND_TYPE_T2ssecure_StringType, &(PTMP_tmp5_1), &(PTMP_tmp8_1)));
    ...
    PRT_VALUE** P_LVALUE_29 = &(PTMP_tmp10_1);
    PrtFreeValue(*P_LVALUE_29);
    *P_LVALUE_29 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp11_1);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = PrtCloneValue((&P_EVENT_TRUSTEDMeasureEvent2.value));
    
    PRT_VALUE** P_LVALUE_31 = &(PTMP_tmp12);
    PrtFreeValue(*P_LVALUE_31);
    *P_LVALUE_31 = PrtCloneValue((&P_LIT_INT32_1));
    
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp13);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = ((_P_GEN_funargs[0] = &(PTMP_tmp12)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp12), PTMP_tmp12 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_33 = &(PTMP_tmp14);
    PrtFreeValue(*P_LVALUE_33);
    *P_LVALUE_33 = PrtCloneValue(PrtCastValue(PTMP_tmp13, &P_GEND_TYPE_s));
    
    PRT_VALUE** P_LVALUE_34 = &(PTMP_tmp15);
    PrtFreeValue(*P_LVALUE_34);
    *P_LVALUE_34 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp16);
    PrtFreeValue(*P_LVALUE_35);
    *P_LVALUE_35 = ((_P_GEN_funargs[0] = &(PTMP_tmp15)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp15), PTMP_tmp15 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp17);
    PrtFreeValue(*P_LVALUE_36);
    *P_LVALUE_36 = PrtCloneValue(PrtCastValue(PTMP_tmp16, &P_GEND_TYPE_secure_StringType));
    
    PRT_VALUE** P_LVALUE_37 = &(PTMP_tmp18);
    PrtFreeValue(*P_LVALUE_37);
    *P_LVALUE_37 = (PrtMkTuple(&P_GEND_TYPE_T2ssecure_StringType, &(PTMP_tmp14), &(PTMP_tmp17)));
    ...
    PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp19);
    PrtFreeValue(*P_LVALUE_38);
    *P_LVALUE_38 = PrtCloneValue(*P_VAR_payload);
    
    PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp20);
    PrtFreeValue(*P_LVALUE_39);
    *P_LVALUE_39 = ((_P_GEN_funargs[0] = &(PTMP_tmp19)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp19), PTMP_tmp19 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp21);
    PrtFreeValue(*P_LVALUE_40);
    *P_LVALUE_40 = PrtCloneValue(PrtCastValue(PTMP_tmp20, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_41 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_41);
        *P_LVALUE_41 = PTMP_tmp21;
        PTMP_tmp21 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp22);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp23);
    PrtFreeValue(*P_LVALUE_43);
    *P_LVALUE_43 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
    
    PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp24);
    PrtFreeValue(*P_LVALUE_44);
    *P_LVALUE_44 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp25);
    PrtFreeValue(*P_LVALUE_45);
    *P_LVALUE_45 = ((_P_GEN_funargs[0] = &(PTMP_tmp24)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp24), PTMP_tmp24 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_46 = &(PTMP_tmp26);
    PrtFreeValue(*P_LVALUE_46);
    *P_LVALUE_46 = PrtCloneValue(PrtCastValue(PTMP_tmp25, &P_GEND_TYPE_secure_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_47 = PrtCloneValue(*P_VAR_payload_3);
    
    PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp1_3);
    PrtFreeValue(*P_LVALUE_48);
    *P_LVALUE_48 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_3)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_3), PTMP_tmp0_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp2_2);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = PrtCloneValue(PrtCastValue(PTMP_tmp1_3, &P_GEND_TYPE_secure_StringType));
    
    {
        PRT_VALUE** P_LVALUE_50 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_50);
        *P_LVALUE_50 = PTMP_tmp2_2;
        PTMP_tmp2_2 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp3_2);
    PrtFreeValue(*P_LVALUE_51);
    *P_LVALUE_51 = ((_P_GEN_funval = P_GenerateRandomMasterSecret_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_54 = PrtCloneValue((&P_EVENT_MasterSecretEvent.value));
    ...
    *P_LVALUE_57 = PrtCloneValue((&P_EVENT_PublicIDEvent.value));
    
    PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp9_2);
    PrtFreeValue(*P_LVALUE_58);
    *P_LVALUE_58 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp10_2);
    PrtFreeValue(*P_LVALUE_59);
    *P_LVALUE_59 = ((_P_GEN_funargs[0] = &(PTMP_tmp9_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp9_2), PTMP_tmp9_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_60 = PrtCloneValue(PrtCastValue(PTMP_tmp10_2, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_62 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_4)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_4), PTMP_tmp0_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtCloneValue(PrtCastValue(PTMP_tmp1_4, &P_GEND_TYPE_StringType));
    ...
    PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_64);
    *P_LVALUE_64 = PrtTupleGet(*P_VAR_payload_4, 0);
    
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp4_3);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtCloneValue(PrtCastValue(PTMP_tmp3_3, &P_GEND_TYPE_StringType));
    ...
    PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp5_3);
    PrtFreeValue(*P_LVALUE_66);
    *P_LVALUE_66 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp6_3);
    PrtFreeValue(*P_LVALUE_67);
    *P_LVALUE_67 = ((_P_GEN_funargs[0] = &(PTMP_tmp5_3)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp5_3), PTMP_tmp5_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp7_3);
    PrtFreeValue(*P_LVALUE_68);
    *P_LVALUE_68 = PrtCloneValue(PrtCastValue(PTMP_tmp6_3, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_69 = &(PTMP_tmp8_3);
    PrtFreeValue(*P_LVALUE_69);
    *P_LVALUE_69 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_70 = &(PTMP_tmp9_3);
    PrtFreeValue(*P_LVALUE_70);
    *P_LVALUE_70 = ((_P_GEN_funargs[0] = &(PTMP_tmp8_3)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8_3), PTMP_tmp8_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_71 = &(PTMP_tmp10_3);
    PrtFreeValue(*P_LVALUE_71);
    *P_LVALUE_71 = PrtCloneValue(PrtCastValue(PTMP_tmp9_3, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_72 = &(PTMP_tmp11_3);
    PrtFreeValue(*P_LVALUE_72);
    *P_LVALUE_72 = ((_P_GEN_funargs[0] = &(PTMP_tmp7_3)), (_P_GEN_funargs[1] = &(PTMP_tmp10_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp7_3), PTMP_tmp7_3 = NULL), (PrtFreeValue(PTMP_tmp10_3), PTMP_tmp10_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp12_1);
    PrtFreeValue(*P_LVALUE_73);
    *P_LVALUE_73 = PrtTupleGet(*P_VAR_payload_4, 1);
    ...
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp13_1);
    ...
    *P_LVALUE_75 = ((_P_GEN_funargs[0] = &(PTMP_tmp13_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp13_1), PTMP_tmp13_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp15_1);
    PrtFreeValue(*P_LVALUE_76);
    *P_LVALUE_76 = PrtCloneValue(PrtCastValue(PTMP_tmp14_1, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_77 = &(PTMP_tmp16_1);
    PrtFreeValue(*P_LVALUE_77);
    *P_LVALUE_77 = PrtTupleGet(*P_VAR_payload_4, 0);
    
    PRT_VALUE** P_LVALUE_78 = &(PTMP_tmp17_1);
    PrtFreeValue(*P_LVALUE_78);
    *P_LVALUE_78 = PrtCloneValue(PrtCastValue(PTMP_tmp16_1, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_79 = &(PTMP_tmp18_1);
    PrtFreeValue(*P_LVALUE_79);
    *P_LVALUE_79 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp15_1, PTMP_tmp17_1));
    
    PRT_VALUE** P_LVALUE_80 = &(PTMP_tmp28);
    PrtFreeValue(*P_LVALUE_80);
    *P_LVALUE_80 = PrtCloneValue(PTMP_tmp18_1);
    
    if (PrtPrimGetBool(PTMP_tmp28))
    {
        PRT_VALUE** P_LVALUE_81 = &(PTMP_tmp19_1);
        PrtFreeValue(*P_LVALUE_81);
        *P_LVALUE_81 = PrtCloneValue(p_this->varValues[2]);
        
        PRT_VALUE** P_LVALUE_82 = &(PTMP_tmp20_1);
        PrtFreeValue(*P_LVALUE_82);
        *P_LVALUE_82 = ((_P_GEN_funargs[0] = &(PTMP_tmp19_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp19_1), PTMP_tmp19_1 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_8;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_83 = &(PTMP_tmp21_1);
        PrtFreeValue(*P_LVALUE_83);
        *P_LVALUE_83 = PrtCloneValue(PrtCastValue(PTMP_tmp20_1, &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_84 = &(PTMP_tmp22_1);
        PrtFreeValue(*P_LVALUE_84);
        *P_LVALUE_84 = PrtCloneValue(p_this->varValues[3]);
        
        PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp23_1);
        PrtFreeValue(*P_LVALUE_85);
        *P_LVALUE_85 = ((_P_GEN_funargs[0] = &(PTMP_tmp22_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp22_1), PTMP_tmp22_1 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_8;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_86 = &(PTMP_tmp24_1);
        PrtFreeValue(*P_LVALUE_86);
        *P_LVALUE_86 = PrtCloneValue(PrtCastValue(PTMP_tmp23_1, &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_87 = &(PTMP_tmp25_1);
        PrtFreeValue(*P_LVALUE_87);
        *P_LVALUE_87 = ((_P_GEN_funargs[0] = &(PTMP_tmp21_1)), (_P_GEN_funargs[1] = &(PTMP_tmp24_1)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp21_1), PTMP_tmp21_1 = NULL), (PrtFreeValue(PTMP_tmp24_1), PTMP_tmp24_1 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_8;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp26_1);
        PrtFreeValue(*P_LVALUE_88);
        *P_LVALUE_88 = PrtTupleGet(*P_VAR_payload_4, 1);
        
        PRT_VALUE** P_LVALUE_89 = &(PTMP_tmp27);
        PrtFreeValue(*P_LVALUE_89);
        *P_LVALUE_89 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp25_1, PTMP_tmp26_1));
        
        PRT_VALUE** P_LVALUE_90 = &(PTMP_tmp28);
        PrtFreeValue(*P_LVALUE_90);
        *P_LVALUE_90 = PrtCloneValue(PTMP_tmp27);
    ...
    if (PrtPrimGetBool(PTMP_tmp28))
    {
        ...
        *P_LVALUE_91 = PrtCloneValue(p_this->varValues[1]);
        ...
        PRT_VALUE** P_LVALUE_92 = &(PTMP_tmp30);
        PrtFreeValue(*P_LVALUE_92);
        *P_LVALUE_92 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    {
        PRT_VALUE** P_LVALUE_93 = &(PTMP_tmp31);
        PrtFreeValue(*P_LVALUE_93);
        *P_LVALUE_93 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_94 = &(PTMP_tmp32);
        PrtFreeValue(*P_LVALUE_94);
        *P_LVALUE_94 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_95 = &(PTMP_tmp0_5);
    PrtFreeValue(*P_LVALUE_95);
    *P_LVALUE_95 = PrtCloneValue(*P_VAR_payload_7);
    
    PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_96);
    *P_LVALUE_96 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_5)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_5), PTMP_tmp0_5 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_12;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_97 = PrtCloneValue(PrtCastValue(PTMP_tmp1_5, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_98 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_98);
        *P_LVALUE_98 = PTMP_tmp2_4;
        PTMP_tmp2_4 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_100 = &(PTMP_tmp0_6);
    ...
    *P_LVALUE_101 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_6)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_6), PTMP_tmp0_6 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_14;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_102 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_102);
    *P_LVALUE_102 = PrtCloneValue(PrtCastValue(PTMP_tmp1_6, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_103 = &(PTMP_tmp3_4);
    PrtFreeValue(*P_LVALUE_103);
    *P_LVALUE_103 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_104 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_104);
    *P_LVALUE_104 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_5)), (_P_GEN_funargs[1] = &(PTMP_tmp3_4)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_5), PTMP_tmp2_5 = NULL), (PrtFreeValue(PTMP_tmp3_4), PTMP_tmp3_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_14;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_105 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_105);
        *P_LVALUE_105 = PTMP_tmp4_4;
        PTMP_tmp4_4 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_106 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_106);
    *P_LVALUE_106 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_107 = &(PTMP_tmp6_4);
    PrtFreeValue(*P_LVALUE_107);
    *P_LVALUE_107 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_108 = &(PTMP_tmp7_4);
    PrtFreeValue(*P_LVALUE_108);
    *P_LVALUE_108 = PrtCloneValue(P_VAR_hashedString);
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_109 = PrtCloneValue(*P_VAR_payload_9);
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_110 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_110);
    *P_LVALUE_110 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_16;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_111 = &(P_VAR_credentials);
        PrtFreeValue(*P_LVALUE_111);
        *P_LVALUE_111 = PTMP_tmp0_7;
        PTMP_tmp0_7 = NULL;
    }
    ...
    *P_LVALUE_115 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    PRT_VALUE** P_LVALUE_116 = &(PTMP_tmp5_5);
    PrtFreeValue(*P_LVALUE_116);
    *P_LVALUE_116 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp3_5), &(PTMP_tmp4_5)));
    ...
    *P_LVALUE_121 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp8_4), &(PTMP_tmp9_4)));
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_125 = PrtCloneValue(*P_VAR_payload_10);
    ...
    PRT_VALUE** P_LVALUE_126 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_126);
    *P_LVALUE_126 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_17;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_127 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_127);
        *P_LVALUE_127 = PTMP_tmp0_8;
        PTMP_tmp0_8 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_128 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_129 = &(PTMP_tmp1_8);
    PrtFreeValue(*P_LVALUE_129);
    *P_LVALUE_129 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_130 = &(PTMP_tmp2_7);
    ...
    *P_LVALUE_130 = PrtCloneValue(p_this->varValues[2]);
    ...
    switch (P_eventId) {
        case 2: {
            ...
            *P_LVALUE_131 = PrtCloneValue(*P_VAR_payload_11);
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_132 = PrtCloneValue(*P_VAR_payload_12);
    ...
    *P_LVALUE_133 = PrtCloneValue(*P_VAR_payload_12);
...
PRT_VALUE* P_Anon_IMPL_20(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_135 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    ...
    *P_LVALUE_137 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_138 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_138);
    *P_LVALUE_138 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_8), &(PTMP_tmp3_7)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            *P_LVALUE_139 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_21;
            }
            if (p_this->isHalted == PRT_TRUE) {
