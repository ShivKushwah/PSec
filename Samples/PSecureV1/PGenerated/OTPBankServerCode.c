...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_12 = ((_P_GEN_funargs[0] = &(PTMP_tmp7)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp7), PTMP_tmp7 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_1;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_13 = PrtCloneValue(PrtCastValue(PTMP_tmp8, &P_GEND_TYPE_machine_handle));
...
PRT_DODECL P_DOS_1[] =
{
    ...
    { 2, &P_EVENT_UNTRUSTEDReceiveRegistrationCredentials, &P_FUNCTION_Anon_6 }
};
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_18 = PrtCloneValue((&P_EVENT_TRUSTEDMeasureEvent1.value));
    
    PRT_VALUE** P_LVALUE_19 = &(PTMP_tmp3_1);
    PrtFreeValue(*P_LVALUE_19);
    *P_LVALUE_19 = PrtCloneValue((&P_LIT_INT32_1));
    
    PRT_VALUE** P_LVALUE_20 = &(PTMP_tmp4_1);
    PrtFreeValue(*P_LVALUE_20);
    *P_LVALUE_20 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_21 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp3_1), &(PTMP_tmp4_1)));
    
    PRT_VALUE* P_PTMP_tmp_2 = PrtCloneValue(&(P_LIT_INT32_1));
    _P_GEN_funargs[0] = &(PTMP_tmp1_1);
    ...
    *P_LVALUE_23 = PrtCloneValue((&P_EVENT_TRUSTEDMeasureEvent2.value));
    ...
    *P_LVALUE_25 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp10);
    PrtFreeValue(*P_LVALUE_26);
    *P_LVALUE_26 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp8_1), &(PTMP_tmp9_1)));
    ...
    *P_LVALUE_28 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_30 = PrtCloneValue(*P_VAR_payload_3);
    ...
    *P_LVALUE_38 = PrtCloneValue(p_this->varValues[0]);
    ...
    PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp7_2);
    PrtFreeValue(*P_LVALUE_39);
    *P_LVALUE_39 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_2), PTMP_tmp6_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_6;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp8_2);
    PrtFreeValue(*P_LVALUE_40);
    *P_LVALUE_40 = PrtCloneValue(PrtCastValue(PTMP_tmp7_2, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_44 = PrtTupleGet(*P_VAR_payload_4, 0);
    
    PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp4_3);
    PrtFreeValue(*P_LVALUE_45);
    *P_LVALUE_45 = PrtCloneValue(PrtCastValue(PTMP_tmp3_3, &P_GEND_TYPE_StringType));
    ...
    PRT_VALUE** P_LVALUE_46 = &(PTMP_tmp5_3);
    PrtFreeValue(*P_LVALUE_46);
    *P_LVALUE_46 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_47 = &(PTMP_tmp6_3);
    PrtFreeValue(*P_LVALUE_47);
    *P_LVALUE_47 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp7_3);
    PrtFreeValue(*P_LVALUE_48);
    *P_LVALUE_48 = ((_P_GEN_funargs[0] = &(PTMP_tmp5_3)), (_P_GEN_funargs[1] = &(PTMP_tmp6_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp5_3), PTMP_tmp5_3 = NULL), (PrtFreeValue(PTMP_tmp6_3), PTMP_tmp6_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp8_3);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = PrtTupleGet(*P_VAR_payload_4, 1);
    ...
    PRT_VALUE** P_LVALUE_50 = &(PTMP_tmp9_2);
    PrtFreeValue(*P_LVALUE_50);
    *P_LVALUE_50 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp10_1);
    PrtFreeValue(*P_LVALUE_51);
    *P_LVALUE_51 = ((_P_GEN_funargs[0] = &(PTMP_tmp9_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp9_2), PTMP_tmp9_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_52 = &(PTMP_tmp11_1);
    PrtFreeValue(*P_LVALUE_52);
    *P_LVALUE_52 = PrtCloneValue(PrtCastValue(PTMP_tmp10_1, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp12_1);
    PrtFreeValue(*P_LVALUE_53);
    *P_LVALUE_53 = PrtTupleGet(*P_VAR_payload_4, 0);
    
    PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp13_1);
    PrtFreeValue(*P_LVALUE_54);
    *P_LVALUE_54 = PrtCloneValue(PrtCastValue(PTMP_tmp12_1, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp14);
    PrtFreeValue(*P_LVALUE_55);
    *P_LVALUE_55 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp11_1, PTMP_tmp13_1));
    
    PRT_VALUE** P_LVALUE_56 = &(PTMP_tmp20);
    PrtFreeValue(*P_LVALUE_56);
    *P_LVALUE_56 = PrtCloneValue(PTMP_tmp14);
    
    if (PrtPrimGetBool(PTMP_tmp20))
    {
        PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp15);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp16);
        PrtFreeValue(*P_LVALUE_58);
        *P_LVALUE_58 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp17);
        PrtFreeValue(*P_LVALUE_59);
        *P_LVALUE_59 = ((_P_GEN_funargs[0] = &(PTMP_tmp15)), (_P_GEN_funargs[1] = &(PTMP_tmp16)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp15), PTMP_tmp15 = NULL), (PrtFreeValue(PTMP_tmp16), PTMP_tmp16 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_7;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_60 = PrtTupleGet(*P_VAR_payload_4, 1);
        
        PRT_VALUE** P_LVALUE_61 = &(PTMP_tmp19);
        PrtFreeValue(*P_LVALUE_61);
        *P_LVALUE_61 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp17, PTMP_tmp18));
        
        PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp20);
        PrtFreeValue(*P_LVALUE_62);
        *P_LVALUE_62 = PrtCloneValue(PTMP_tmp19);
    ...
    if (PrtPrimGetBool(PTMP_tmp20))
    {
        PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp21);
        PrtFreeValue(*P_LVALUE_63);
        *P_LVALUE_63 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp22);
        PrtFreeValue(*P_LVALUE_64);
        *P_LVALUE_64 = PrtCloneValue((&P_EVENT_AuthSuccess.value));
    ...
    {
        PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp23);
        PrtFreeValue(*P_LVALUE_65);
        *P_LVALUE_65 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp24);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = PrtCloneValue((&P_EVENT_AuthFailure.value));
...
PRT_FUNDECL* P_BankEnclave_METHODS[] = { &P_FUNCTION_Anon_2, &P_FUNCTION_Anon_3, &P_FUNCTION_Anon_4, &P_FUNCTION_Anon_5, &P_FUNCTION_Anon_6, &P_FUNCTION_Anon_7 };
...
PRT_EVENTDECL* P_Initial_DOS_INNER_3[] = { &P_EVENT_TRUSTEDMeasureEvent1, &P_EVENT_TRUSTEDMeasureEvent2, &P_EVENT_TRUSTEDProvisionClientSSM };
...
PRT_DODECL P_DOS_2[] =
{
    { 0, &P_EVENT_TRUSTEDMeasureEvent1, &P_FUNCTION_Anon_9 },
    { 0, &P_EVENT_TRUSTEDMeasureEvent2, &P_FUNCTION_Anon_10 },
    { 0, &P_EVENT_TRUSTEDProvisionClientSSM, &P_FUNCTION_Anon_11 }
};
...
PRT_DODECL P_DOS_3[] =
{
    { 3, &P_EVENT_GenerateOTPCodeEvent, &P_FUNCTION_Anon_13 }
};
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_67 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_68 = PrtCloneValue(*P_VAR_payload_8);
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_69 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_70 = &(PTMP_tmp1_4);
    PrtFreeValue(*P_LVALUE_70);
    *P_LVALUE_70 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_71 = &(PTMP_tmp2_4);
    PrtFreeValue(*P_LVALUE_71);
    *P_LVALUE_71 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_5)), (_P_GEN_funargs[1] = &(PTMP_tmp1_4)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_5), PTMP_tmp0_5 = NULL), (PrtFreeValue(PTMP_tmp1_4), PTMP_tmp1_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_13;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_72 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_72);
        *P_LVALUE_72 = PTMP_tmp2_4;
        PTMP_tmp2_4 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp3_4);
    PrtFreeValue(*P_LVALUE_73);
    *P_LVALUE_73 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_74);
    *P_LVALUE_74 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_75 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_75);
    *P_LVALUE_75 = PrtCloneValue(P_VAR_hashedString);
...
PRT_FUNDECL* P_ClientEnclave_METHODS[] = { &P_FUNCTION_Anon_8, &P_FUNCTION_Anon_9, &P_FUNCTION_Anon_10, &P_FUNCTION_Anon_11, &P_FUNCTION_Anon_12, &P_FUNCTION_Anon_13 };
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_76 = PrtCloneValue(*P_VAR_payload_9);
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_77 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    {
        PRT_VALUE** P_LVALUE_78 = &(P_VAR_credentials);
        PrtFreeValue(*P_LVALUE_78);
        *P_LVALUE_78 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
    ...
    *P_LVALUE_80 = PrtCloneValue((&P_EVENT_MeasureEvent1.value));
    
    PRT_VALUE** P_LVALUE_81 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_81);
    *P_LVALUE_81 = PrtCloneValue((&P_LIT_INT32_5));
    
    PRT_VALUE** P_LVALUE_82 = &(PTMP_tmp4_5);
    PrtFreeValue(*P_LVALUE_82);
    *P_LVALUE_82 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_15;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_83 = &(PTMP_tmp5_5);
    PrtFreeValue(*P_LVALUE_83);
    *P_LVALUE_83 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp3_5), &(PTMP_tmp4_5)));
    ...
    PRT_VALUE** P_LVALUE_84 = &(PTMP_tmp6_4);
    PrtFreeValue(*P_LVALUE_84);
    *P_LVALUE_84 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp7_4);
    PrtFreeValue(*P_LVALUE_85);
    *P_LVALUE_85 = PrtCloneValue((&P_EVENT_MeasureEvent2.value));
    
    PRT_VALUE** P_LVALUE_86 = &(PTMP_tmp8_4);
    PrtFreeValue(*P_LVALUE_86);
    *P_LVALUE_86 = PrtCloneValue((&P_LIT_INT32_5));
    
    PRT_VALUE** P_LVALUE_87 = &(PTMP_tmp9_3);
    PrtFreeValue(*P_LVALUE_87);
    *P_LVALUE_87 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_15;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp10_2);
    PrtFreeValue(*P_LVALUE_88);
    *P_LVALUE_88 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp8_4), &(PTMP_tmp9_3)));
    ...
    *P_LVALUE_89 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_90 = &(PTMP_tmp12_2);
    PrtFreeValue(*P_LVALUE_90);
    *P_LVALUE_90 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveRegistrationCredentials.value));
    
    PRT_VALUE** P_LVALUE_91 = &(PTMP_tmp13_2);
    PrtFreeValue(*P_LVALUE_91);
    *P_LVALUE_91 = PrtCloneValue(P_VAR_credentials);
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_92 = &(p_this->varValues[0]);
    PrtFreeValue(*P_LVALUE_92);
    *P_LVALUE_92 = PrtCloneValue(*P_VAR_payload_10);
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_95 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_96);
    *P_LVALUE_96 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_97 = &(PTMP_tmp2_6);
    PrtFreeValue(*P_LVALUE_97);
    *P_LVALUE_97 = PrtCloneValue(p_this->varValues[2]);
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_payload_11 = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_98 = &(PTMP_tmp3_6);
            PrtFreeValue(*P_LVALUE_98);
            *P_LVALUE_98 = PrtCloneValue(*P_VAR_payload_11);
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_99 = &(PTMP_tmp0_9);
    PrtFreeValue(*P_LVALUE_99);
    *P_LVALUE_99 = PrtCloneValue(*P_VAR_payload_12);
    ...
    PRT_VALUE** P_LVALUE_100 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_100);
    *P_LVALUE_100 = PrtCloneValue(*P_VAR_payload_12);
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_101 = &(PTMP_tmp0_10);
    PrtFreeValue(*P_LVALUE_101);
    *P_LVALUE_101 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_102 = &(PTMP_tmp1_7);
    PrtFreeValue(*P_LVALUE_102);
    *P_LVALUE_102 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    
    PRT_VALUE** P_LVALUE_103 = &(PTMP_tmp2_7);
    PrtFreeValue(*P_LVALUE_103);
    *P_LVALUE_103 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_104 = &(PTMP_tmp3_7);
    PrtFreeValue(*P_LVALUE_104);
    *P_LVALUE_104 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_105 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_105);
    *P_LVALUE_105 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_7), &(PTMP_tmp3_7)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            PRT_VALUE** P_LVALUE_106 = &(PTMP_tmp5_6);
            PrtFreeValue(*P_LVALUE_106);
            *P_LVALUE_106 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_20;
            }
            if (p_this->isHalted == PRT_TRUE) {
...
PRT_FUNDECL* P_ClientWebBrowser_METHODS[] = { &P_FUNCTION_Anon_14, &P_FUNCTION_Anon_15, &P_FUNCTION_Anon_16, &P_FUNCTION_Anon_17, &P_FUNCTION_Anon_18, &P_FUNCTION_Anon_19, &P_FUNCTION_Anon_20 };
