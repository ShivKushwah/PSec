...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_45 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    ...
    *P_LVALUE_47 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp4_3);
    PrtFreeValue(*P_LVALUE_48);
    *P_LVALUE_48 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_3)), (_P_GEN_funargs[1] = &(PTMP_tmp3_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_3), PTMP_tmp2_3 = NULL), (PrtFreeValue(PTMP_tmp3_3), PTMP_tmp3_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_49 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = PrtCloneValue(*P_VAR_payload_4);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_50 = PrtCloneValue(*P_VAR_payload_5);
    
    PrtPrintf("Client Web Browser: Enter Credentials to login to bank!\n");
    
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp0_5);
    PrtFreeValue(*P_LVALUE_51);
    *P_LVALUE_51 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_9;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp0_6);
    ...
    *P_LVALUE_54 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_payload_6 = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_56 = &(PTMP_tmp3_4);
            PrtFreeValue(*P_LVALUE_56);
            *P_LVALUE_56 = PrtCloneValue(*P_VAR_payload_6);
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_57);
    *P_LVALUE_57 = PrtCloneValue(*P_VAR_payload_7);
    ...
    PRT_VALUE** P_LVALUE_58 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_58);
    *P_LVALUE_58 = PrtCloneValue(*P_VAR_payload_7);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp0_8);
    ...
    *P_LVALUE_60 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    ...
    *P_LVALUE_63 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_5), &(PTMP_tmp3_5)));
    ...
    switch (P_eventId_1) {
        ...
        case 4: {
            ...
            *P_LVALUE_64 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_13;
            }
            if (p_this->isHalted == PRT_TRUE) {
...
PRT_FOREIGNTYPEDECL* P_ALL_FOREIGN_TYPES[] = { &P_machine_handle, &P_StringType, &P_secure_machine_handle, &P_capability, &P_secure_StringType };
