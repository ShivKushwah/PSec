...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_10 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_secure_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_16 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    PRT_VALUE** P_LVALUE_18 = &(PTMP_tmp1_2);
    ...
    *P_LVALUE_19 = PrtCloneValue((&P_EVENT_TRUSTEDMeasureEvent1.value));
    
    PRT_VALUE** P_LVALUE_20 = &(PTMP_tmp3_1);
    PrtFreeValue(*P_LVALUE_20);
    *P_LVALUE_20 = PrtCloneValue(PrtCastValue((&P_LIT_INT32_1), &P_GEND_TYPE_s));
    
    PRT_VALUE** P_LVALUE_21 = &(PTMP_tmp4_1);
    PrtFreeValue(*P_LVALUE_21);
    *P_LVALUE_21 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_22 = PrtCloneValue(PrtCastValue(PTMP_tmp4_1, &P_GEND_TYPE_secure_StringType));
    
    PRT_VALUE** P_LVALUE_23 = &(PTMP_tmp6_1);
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = (PrtMkTuple(&P_GEND_TYPE_T2ssecure_StringType, &(PTMP_tmp3_1), &(PTMP_tmp5_1)));
    ...
    *P_LVALUE_24 = PrtCloneValue(p_this->varValues[0]);
    ...
    PRT_VALUE** P_LVALUE_25 = &(PTMP_tmp8_1);
    PrtFreeValue(*P_LVALUE_25);
    *P_LVALUE_25 = PrtCloneValue((&P_EVENT_TRUSTEDMeasureEvent2.value));
    
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp9_1);
    PrtFreeValue(*P_LVALUE_26);
    *P_LVALUE_26 = PrtCloneValue(PrtCastValue((&P_LIT_INT32_1), &P_GEND_TYPE_s));
    ...
    *P_LVALUE_28 = PrtCloneValue(PrtCastValue(PTMP_tmp10, &P_GEND_TYPE_secure_StringType));
    
    PRT_VALUE** P_LVALUE_29 = &(PTMP_tmp12);
    PrtFreeValue(*P_LVALUE_29);
    *P_LVALUE_29 = (PrtMkTuple(&P_GEND_TYPE_T2ssecure_StringType, &(PTMP_tmp9_1), &(PTMP_tmp11)));
    ...
    PrtPrintf("About to declassify 2");
    
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp13);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = PrtCloneValue(*P_VAR_payload);
    
    PRT_VALUE** P_LVALUE_31 = &(PTMP_tmp14);
    PrtFreeValue(*P_LVALUE_31);
    *P_LVALUE_31 = ((_P_GEN_funargs[0] = &(PTMP_tmp13)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp13), PTMP_tmp13 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_4;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_32 = PrtCloneValue(PrtCastValue(PTMP_tmp14, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_33 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_33);
        *P_LVALUE_33 = PTMP_tmp15;
        PTMP_tmp15 = NULL;
    }
    ...
    *P_LVALUE_35 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionClientSSM.value));
    
    PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp18);
    PrtFreeValue(*P_LVALUE_36);
    *P_LVALUE_36 = PrtCloneValue(PrtCastValue(p_this->varValues[1], &P_GEND_TYPE_secure_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_37 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_37);
    *P_LVALUE_37 = PrtCloneValue(*P_VAR_payload_3);
    
    PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp0_3);
    PrtFreeValue(*P_LVALUE_38);
    *P_LVALUE_38 = ((_P_GEN_funval = P_GenerateRandomMasterSecret_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_39 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_39);
        *P_LVALUE_39 = PTMP_tmp0_3;
        PTMP_tmp0_3 = NULL;
    }
    ...
    *P_LVALUE_41 = PrtCloneValue((&P_EVENT_MasterSecretEvent.value));
    
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp3_2);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtCloneValue(p_this->varValues[2]);
    ...
    *P_LVALUE_44 = PrtCloneValue((&P_EVENT_PublicIDEvent.value));
    ...
    *P_LVALUE_46 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_2), PTMP_tmp6_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_47 = PrtCloneValue(PrtCastValue(PTMP_tmp7_2, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_49 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_4)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_4), PTMP_tmp0_4 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_50 = PrtCloneValue(PrtCastValue(PTMP_tmp1_4, &P_GEND_TYPE_StringType));
    ...
    *P_LVALUE_51 = PrtTupleGet(*P_VAR_payload_4, 0);
    ...
    *P_LVALUE_53 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp6_3);
    PrtFreeValue(*P_LVALUE_54);
    *P_LVALUE_54 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp7_3);
    PrtFreeValue(*P_LVALUE_55);
    *P_LVALUE_55 = ((_P_GEN_funargs[0] = &(PTMP_tmp5_3)), (_P_GEN_funargs[1] = &(PTMP_tmp6_3)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp5_3), PTMP_tmp5_3 = NULL), (PrtFreeValue(PTMP_tmp6_3), PTMP_tmp6_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_56 = PrtTupleGet(*P_VAR_payload_4, 1);
    ...
    *P_LVALUE_58 = ((_P_GEN_funargs[0] = &(PTMP_tmp9_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp9_2), PTMP_tmp9_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_8;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_59 = PrtCloneValue(PrtCastValue(PTMP_tmp10_1, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp12_1);
    PrtFreeValue(*P_LVALUE_60);
    *P_LVALUE_60 = PrtTupleGet(*P_VAR_payload_4, 0);
    
    PRT_VALUE** P_LVALUE_61 = &(PTMP_tmp13_1);
    PrtFreeValue(*P_LVALUE_61);
    *P_LVALUE_61 = PrtCloneValue(PrtCastValue(PTMP_tmp12_1, &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp14_1);
    PrtFreeValue(*P_LVALUE_62);
    *P_LVALUE_62 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp11_1, PTMP_tmp13_1));
    
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp20);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtCloneValue(PTMP_tmp14_1);
    
    if (PrtPrimGetBool(PTMP_tmp20))
    {
        PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp15_1);
        PrtFreeValue(*P_LVALUE_64);
        *P_LVALUE_64 = PrtCloneValue(PrtCastValue(p_this->varValues[2], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp16_1);
        PrtFreeValue(*P_LVALUE_65);
        *P_LVALUE_65 = PrtCloneValue(PrtCastValue(p_this->varValues[3], &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp17_1);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = ((_P_GEN_funargs[0] = &(PTMP_tmp15_1)), (_P_GEN_funargs[1] = &(PTMP_tmp16_1)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp15_1), PTMP_tmp15_1 = NULL), (PrtFreeValue(PTMP_tmp16_1), PTMP_tmp16_1 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_8;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp18_1);
        PrtFreeValue(*P_LVALUE_67);
        *P_LVALUE_67 = PrtTupleGet(*P_VAR_payload_4, 1);
        
        PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp19);
        PrtFreeValue(*P_LVALUE_68);
        *P_LVALUE_68 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp17_1, PTMP_tmp18_1));
        
        PRT_VALUE** P_LVALUE_69 = &(PTMP_tmp20);
        PrtFreeValue(*P_LVALUE_69);
        *P_LVALUE_69 = PrtCloneValue(PTMP_tmp19);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_74 = PrtCloneValue(*P_VAR_payload_7);
    ...
    *P_LVALUE_76 = PrtCloneValue(PrtCastValue(PTMP_tmp1_5, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_77 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_77);
        *P_LVALUE_77 = PTMP_tmp2_4;
        PTMP_tmp2_4 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_78 = PrtCloneValue(*P_VAR_payload_8);
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_79 = PrtCloneValue(PrtCastValue(p_this->varValues[0], &P_GEND_TYPE_StringType));
    
    PRT_VALUE** P_LVALUE_80 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_80);
    *P_LVALUE_80 = PrtCloneValue(*P_VAR_usernamePassword);
    
    PRT_VALUE** P_LVALUE_81 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_81);
    *P_LVALUE_81 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_6)), (_P_GEN_funargs[1] = &(PTMP_tmp1_6)), (_P_GEN_funval = P_Hash_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_6), PTMP_tmp0_6 = NULL), (PrtFreeValue(PTMP_tmp1_6), PTMP_tmp1_6 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_14;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_82 = &(P_VAR_hashedString);
        PrtFreeValue(*P_LVALUE_82);
        *P_LVALUE_82 = PTMP_tmp2_5;
        PTMP_tmp2_5 = NULL;
    }
    ...
    *P_LVALUE_84 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
    
    PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_85);
    *P_LVALUE_85 = PrtCloneValue(P_VAR_hashedString);
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_86 = PrtCloneValue(*P_VAR_payload_9);
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_87 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_16;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_88 = &(P_VAR_credentials);
    ...
    PRT_VALUE** P_LVALUE_89 = &(PTMP_tmp1_7);
    ...
    *P_LVALUE_90 = PrtCloneValue((&P_EVENT_MeasureEvent1.value));
    
    PRT_VALUE** P_LVALUE_91 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_91);
    *P_LVALUE_91 = PrtCloneValue((&P_LIT_INT32_5));
    
    PRT_VALUE** P_LVALUE_92 = &(PTMP_tmp4_5);
    PrtFreeValue(*P_LVALUE_92);
    *P_LVALUE_92 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_16;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_93 = &(PTMP_tmp5_5);
    PrtFreeValue(*P_LVALUE_93);
    *P_LVALUE_93 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp3_5), &(PTMP_tmp4_5)));
    ...
    PRT_VALUE** P_LVALUE_94 = &(PTMP_tmp6_4);
    PrtFreeValue(*P_LVALUE_94);
    *P_LVALUE_94 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_95 = &(PTMP_tmp7_4);
    PrtFreeValue(*P_LVALUE_95);
    *P_LVALUE_95 = PrtCloneValue((&P_EVENT_MeasureEvent2.value));
    
    PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp8_4);
    PrtFreeValue(*P_LVALUE_96);
    *P_LVALUE_96 = PrtCloneValue((&P_LIT_INT32_5));
    
    PRT_VALUE** P_LVALUE_97 = &(PTMP_tmp9_3);
    PrtFreeValue(*P_LVALUE_97);
    *P_LVALUE_97 = ((_P_GEN_funval = P_GetHelloWorld_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_16;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_98 = &(PTMP_tmp10_2);
    PrtFreeValue(*P_LVALUE_98);
    *P_LVALUE_98 = (PrtMkTuple(&P_GEND_TYPE_T2iStringType, &(PTMP_tmp8_4), &(PTMP_tmp9_3)));
    ...
    *P_LVALUE_100 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveRegistrationCredentials.value));
    
    PRT_VALUE** P_LVALUE_101 = &(PTMP_tmp13_2);
    PrtFreeValue(*P_LVALUE_101);
    *P_LVALUE_101 = PrtCloneValue(P_VAR_credentials);
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_102 = &(p_this->varValues[0]);
    PrtFreeValue(*P_LVALUE_102);
    *P_LVALUE_102 = PrtCloneValue(*P_VAR_payload_10);
    
    PrtPrintf("Client Web Browser: Enter Credentials to login to bank!\n");
    
    PRT_VALUE** P_LVALUE_103 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_103);
    *P_LVALUE_103 = ((_P_GEN_funval = P_GetUserInput_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_17;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_104 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_104);
        *P_LVALUE_104 = PTMP_tmp0_8;
        PTMP_tmp0_8 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_106 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    ...
    *P_LVALUE_107 = PrtCloneValue(p_this->varValues[2]);
    ...
    switch (P_eventId) {
        case 2: {
            ...
            *P_LVALUE_108 = PrtCloneValue(*P_VAR_payload_11);
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_109 = PrtCloneValue(*P_VAR_payload_12);
    ...
    PRT_VALUE** P_LVALUE_110 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_110);
    *P_LVALUE_110 = PrtCloneValue(*P_VAR_payload_12);
...
PRT_VALUE* P_Anon_IMPL_20(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_111 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_111);
    *P_LVALUE_111 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_112 = &(PTMP_tmp1_9);
    PrtFreeValue(*P_LVALUE_112);
    *P_LVALUE_112 = PrtCloneValue((&P_EVENT_AuthenticateRequest.value));
    
    PRT_VALUE** P_LVALUE_113 = &(PTMP_tmp2_8);
    PrtFreeValue(*P_LVALUE_113);
    *P_LVALUE_113 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_114 = &(PTMP_tmp3_7);
    PrtFreeValue(*P_LVALUE_114);
    *P_LVALUE_114 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_115 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_115);
    *P_LVALUE_115 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypeStringType, &(PTMP_tmp2_8), &(PTMP_tmp3_7)));
