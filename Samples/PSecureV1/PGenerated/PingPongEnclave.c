...
PRT_EVENTDECL* P_GodUntrusted_RECV_INNER[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_PublicIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_GodMachine_RECV_INNER[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_PublicIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_GodUntrusted_RECV_INNER_1[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_PublicIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_GodUntrusted_SEND_INNER[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_PublicIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_GodMachine_RECV_INNER_1[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_PublicIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_GodMachine_SEND_INNER[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_PublicIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_11 = ((_P_GEN_funval = P_GetStringFromUser_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_12 = &(p_this->varValues[3]);
    ...
    *P_LVALUE_15 = PrtCloneValue(p_this->varValues[3]);
    ...
    PrtPrintf("Bank Enclave about to print clientSSM");
    ...
    *P_LVALUE_18 = PrtCloneValue((&P_EVENT_PublicIDEvent.value));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_22 = PrtMkBoolValue(PrtIsEqualValue(*P_VAR_usernamePassword, p_this->varValues[0]));
    ...
    else
    {
        ...
        *P_LVALUE_23 = PrtCloneValue(*P_VAR_usernamePassword);
    ...
    PRT_VALUE** P_LVALUE_25 = &(PTMP_tmp3_1);
    ...
    *P_LVALUE_27 = ((_P_GEN_funargs[0] = &(PTMP_tmp3_1)), (_P_GEN_funargs[1] = &(PTMP_tmp4_1)), (_P_GEN_funval = P_Concat_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp3_1), PTMP_tmp3_1 = NULL), (PrtFreeValue(PTMP_tmp4_1), PTMP_tmp4_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_6;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_29 = PrtCloneValue((&P_EVENT_OTPCodeEvent.value));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_31 = PrtCloneValue(*P_VAR_payload_3);
    
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp0_4);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = ((_P_GEN_funval = P_GetStringFromUser_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_36 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    ...
    *P_LVALUE_37 = PrtCloneValue(p_this->varValues[1]);
    ...
    switch (P_eventId) {
        case 2: {
            ...
            *P_LVALUE_38 = PrtCloneValue(*P_VAR_payload_4);
            
            PrtGoto(p_this, 2U, 1, &(PTMP_tmp5_2));
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp0_5);
    PrtFreeValue(*P_LVALUE_39);
    *P_LVALUE_39 = PrtCloneValue(*P_VAR_payload_5);
