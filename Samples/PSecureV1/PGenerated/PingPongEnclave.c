...
PRT_EVENTDECL* P_ClientUSM_RECV_INNER[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_PublicIDEvent, &P_EVENT_Success, &P_EVENT_TestEvent, &P_EVENT_TestEvent2, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_ClientUSM_RECV =
{
    12U,
    P_ClientUSM_RECV_INNER,
    NULL
};

PRT_INTERFACEDECL P_I_ClientUSM =
{
    3U,
    "ClientUSM",
    &P_GEND_TYPE_n,
    &P_EVENTSET_ClientUSM_RECV
};
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_7 = PrtMkBoolValue(PrtIsEqualValue(*P_VAR_payload, (&P_LIT_INT32_2)));
    ...
    *P_LVALUE_11 = PrtCloneValue((&P_EVENT_TestEvent2.value));
    
    PRT_VALUE** P_LVALUE_12 = &(PTMP_tmp4);
    PrtFreeValue(*P_LVALUE_12);
    *P_LVALUE_12 = PrtCloneValue((&P_LIT_INT32_3));
...
PRT_EVENTDECL* P_Init_TRANS_INNER[] = { &P_EVENT_TestEvent2 };
...
{
    { 0, &P_EVENT_TestEvent2, 1, &_P_NO_OP }
};

#define P_STATE_ClientUSM_Init \
{ \
    "ClientUSM.Init", \
    1U, \
    0U, \
...
PRT_EVENTDECL* P_NextState_DEFERS_INNER_1[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_NextState_DEFERS_1 =
{
    0U,
    P_NextState_DEFERS_INNER_1,
    NULL
};

PRT_EVENTDECL* P_NextState_TRANS_INNER_1[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_NextState_TRANS_1 =
{
    0U,
    P_NextState_TRANS_INNER_1,
    NULL
};

PRT_EVENTDECL* P_NextState_DOS_INNER_1[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_NextState_DOS_1 =
{
    0U,
    P_NextState_DOS_INNER_1,
    NULL
};

#define P_STATE_ClientUSM_NextState \
{ \
    "ClientUSM.NextState", \
    0U, \
    0U, \
    &P_EVENTSET_NextState_DEFERS_1, \
    &P_EVENTSET_NextState_TRANS_1, \
    &P_EVENTSET_NextState_DOS_1, \
    NULL, \
    NULL, \
    &P_FUNCTION_Anon_3, \
    &_P_NO_OP, \
...
PRT_STATEDECL P_ClientUSM_STATES[] = { P_STATE_ClientUSM_Init, P_STATE_ClientUSM_NextState };
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_13 = PrtMkBoolValue(PrtIsEqualValue(*P_VAR_payload_1, (&P_LIT_INT32_5)));
    
    if (PrtPrimGetBool(PTMP_tmp0_3))
    {
        PrtPrintf("Test2 Successs!");
...
PRT_FUNDECL* P_ClientUSM_METHODS[] = { &P_FUNCTION_Anon_3 };

PRT_EVENTDECL* P_ClientUSM_RECV_INNER_1[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_PublicIDEvent, &P_EVENT_Success, &P_EVENT_TestEvent, &P_EVENT_TestEvent2, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_ClientUSM_RECV_1 =
{
    12U,
    P_ClientUSM_RECV_INNER_1,
    NULL
};

PRT_EVENTDECL* P_ClientUSM_SEND_INNER[] = { &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_PublicIDEvent, &P_EVENT_Success, &P_EVENT_TestEvent, &P_EVENT_TestEvent2, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_ClientUSM_SEND =
{
    12U,
    P_ClientUSM_SEND_INNER,
    NULL
};

PRT_MACHINEDECL P_MACHINE_ClientUSM = 
{
    3U,
    "ClientUSM",
    &P_EVENTSET_ClientUSM_RECV_1,
    &P_EVENTSET_ClientUSM_SEND,
    NULL,
    0U,
    2U,
    1U,
...
PRT_EVENTDECL* P_ALL_EVENTS[] = { &_P_EVENT_NULL_STRUCT, &_P_EVENT_HALT_STRUCT, &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &P_EVENT_Success, &P_EVENT_PublicIDEvent, &P_EVENT_MasterSecretEvent, &P_EVENT_GenerateOTPCodeEvent, &P_EVENT_OTPCodeEvent, &P_EVENT_MapEvent, &P_EVENT_TestEvent, &P_EVENT_TestEvent2 };
PRT_MACHINEDECL* P_ALL_MACHINES[] = { &P_MACHINE_GodUntrusted, &P_MACHINE_GodMachine, &P_MACHINE_BankEnclave, &P_MACHINE_ClientUSM };
PRT_INTERFACEDECL* P_ALL_INTERFACES[] = { &P_I_GodUntrusted, &P_I_GodMachine, &P_I_BankEnclave, &P_I_ClientUSM };
