...
PRT_VALUE* P_ReadSSNFromUser_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs);
extern PRT_FUNDECL P_FUNCTION_ReadSSNFromUser;
...
PRT_VALUE* P_ReadSSNFromUser_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE P_LIT_INT32 = { PRT_VALUE_KIND_INT, { .nt = 625674887 } };
    PrtFreeValue(_P_GEN_retval);
    _P_GEN_retval = PrtCloneValue((&P_LIT_INT32));
    goto p_return;
...
PRT_FUNDECL P_FUNCTION_ReadSSNFromUser =
{
    "ReadSSNFromUser",
    &P_ReadSSNFromUser_IMPL,
    NULL
};


PRT_EVENTDECL* P_VotingMachine_RECV_INNER[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_VotingMachine_RECV =
{
    4U,
    P_VotingMachine_RECV_INNER,
    NULL
};

PRT_INTERFACEDECL P_I_VotingMachine =
{
    0U,
    "VotingMachine",
    &P_GEND_TYPE_n,
    &P_EVENTSET_VotingMachine_RECV
};

PRT_EVENTDECL* P_Coordinator_RECV_INNER[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_SecureChild_RECV_INNER[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
...
PRT_VARDECL P_VotingMachine_VARS[] = {
    { "ssn", &P_GEND_TYPE_i_1 },
    { "insecure_int", &P_GEND_TYPE_i },
    { "s_int", &P_GEND_TYPE_i_1 },
    { "m", &P_GEND_TYPE_StringType }
};

PRT_EVENTDECL* P_Initial_DEFERS_INNER[] = { &P_EVENT_Pong };
...
#define P_STATE_VotingMachine_Initial \
{ \
    "VotingMachine.Initial", \
    0U, \
    0U, \
...
PRT_STATEDECL P_VotingMachine_STATES[] = { P_STATE_VotingMachine_Initial };
...
PRT_VALUE* P_Anon_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE P_LIT_INT32_1 = { PRT_VALUE_KIND_INT, { .nt = 625674887 } };
    ...
    PRT_VALUE P_LIT_INT32_6 = { PRT_VALUE_KIND_INT, { .nt = 15 } };
    PRT_VALUE P_LIT_INT32_7 = { PRT_VALUE_KIND_INT, { .nt = 20 } };
    PRT_VALUE P_LIT_INT32_8 = { PRT_VALUE_KIND_INT, { .nt = 0 } };
    PRT_VALUE P_LIT_BOOLEAN = { PRT_VALUE_KIND_BOOL, { .bl = PRT_TRUE } };
    PRT_VALUE** P_LVALUE = &(PTMP_tmp0);
    PrtFreeValue(*P_LVALUE);
    *P_LVALUE = ((_P_GEN_funval = P_ReadSSNFromUser_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    *P_LVALUE_2 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[0], (&P_LIT_INT32_1)));
    
    if (PrtPrimGetBool(PTMP_tmp1))
    {
        PRT_VALUE** P_LVALUE_3 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_3);
        *P_LVALUE_3 = PrtCloneValue((&P_LIT_INT32_2));
    ...
    else
    {
        ...
        *P_LVALUE_4 = PrtCloneValue((&P_LIT_INT32_3));
    ...
    *P_LVALUE_5 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[2]) + PrtPrimGetInt((&P_LIT_INT32_4)));
    ...
    *P_LVALUE_8 = PrtCloneValue(p_this->varValues[1]);
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN)))
    {
        ...
        *P_LVALUE_9 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[1]) < PrtPrimGetInt((&P_LIT_INT32_6)));
        
        PRT_VALUE** P_LVALUE_10 = &(PTMP_tmp4);
        PrtFreeValue(*P_LVALUE_10);
        *P_LVALUE_10 = PrtCloneValue(PTMP_tmp3);
        ...
        *P_LVALUE_11 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[2]) + PrtPrimGetInt((&P_LIT_INT32_4)));
        
        {
            PRT_VALUE** P_LVALUE_12 = &(p_this->varValues[2]);
            PrtFreeValue(*P_LVALUE_12);
            *P_LVALUE_12 = PTMP_tmp5;
            PTMP_tmp5 = NULL;
        }
        
        PRT_VALUE** P_LVALUE_13 = &(PTMP_tmp6);
        PrtFreeValue(*P_LVALUE_13);
        *P_LVALUE_13 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[1]) + PrtPrimGetInt((&P_LIT_INT32_4)));
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN)))
    {
        ...
        *P_LVALUE_15 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[2]) < PrtPrimGetInt((&P_LIT_INT32_7)));
        ...
        *P_LVALUE_17 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[2]) + PrtPrimGetInt((&P_LIT_INT32_4)));
        
        {
            PRT_VALUE** P_LVALUE_18 = &(p_this->varValues[2]);
            PrtFreeValue(*P_LVALUE_18);
            *P_LVALUE_18 = PTMP_tmp9;
            PTMP_tmp9 = NULL;
        }
        
        PRT_VALUE** P_LVALUE_19 = &(PTMP_tmp10);
        PrtFreeValue(*P_LVALUE_19);
        *P_LVALUE_19 = PrtCloneValue(p_this->varValues[3]);
        
        PRT_VALUE** P_LVALUE_20 = &(PTMP_tmp11);
        PrtFreeValue(*P_LVALUE_20);
        *P_LVALUE_20 = PrtCloneValue((&P_EVENT_Ping.value));
        
        PRT_VALUE* P_PTMP_tmp = PrtCloneValue(&(P_LIT_INT32_8));
...
PRT_FUNDECL* P_VotingMachine_METHODS[] = { &P_FUNCTION_Anon };

PRT_EVENTDECL* P_VotingMachine_RECV_INNER_1[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_VotingMachine_RECV_1 =
{
    4U,
    P_VotingMachine_RECV_INNER_1,
    NULL
};

PRT_EVENTDECL* P_VotingMachine_SEND_INNER[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_VotingMachine_SEND =
{
    4U,
    P_VotingMachine_SEND_INNER,
    NULL
};

PRT_MACHINEDECL P_MACHINE_VotingMachine = 
{
    0U,
    "VotingMachine",
    &P_EVENTSET_VotingMachine_RECV_1,
    &P_EVENTSET_VotingMachine_SEND,
    NULL,
    4U,
    1U,
    1U,
    4294967295U,
    0U,
    P_VotingMachine_VARS,
    P_VotingMachine_STATES,
    P_VotingMachine_METHODS,
    PRT_TRUE
};
...
PRT_EVENTDECL* P_Initial_TRANS_INNER_1[] = { &P_EVENT_UntrustedEventFromPing };
...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_21 = PrtCloneValue((&P_LIT_INT32_9));
    
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp0_1);
    PrtFreeValue(*P_LVALUE_22);
    *P_LVALUE_22 = PrtMkIntValue(-PrtPrimGetInt((&P_LIT_INT32_9)));
    
    {
        PRT_VALUE** P_LVALUE_23 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_23);
        *P_LVALUE_23 = PTMP_tmp0_1;
        PTMP_tmp0_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_24 = &(PTMP_tmp1_1);
    PrtFreeValue(*P_LVALUE_24);
    *P_LVALUE_24 = PrtMkIntValue(-PrtPrimGetInt((&P_LIT_INT32_9)));
    
    {
        PRT_VALUE** P_LVALUE_25 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_25);
        *P_LVALUE_25 = PTMP_tmp1_1;
        PTMP_tmp1_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp2_1);
    PrtFreeValue(*P_LVALUE_26);
    *P_LVALUE_26 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[2]) + PrtPrimGetInt((&P_LIT_INT32_10)));
    
    {
        PRT_VALUE** P_LVALUE_27 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_27);
        *P_LVALUE_27 = PTMP_tmp2_1;
        PTMP_tmp2_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_28 = &(PTMP_tmp3_1);
    PrtFreeValue(*P_LVALUE_28);
    *P_LVALUE_28 = PrtMkIntValue(-PrtPrimGetInt(p_this->varValues[2]));
    
    {
        PRT_VALUE** P_LVALUE_29 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_29);
        *P_LVALUE_29 = PTMP_tmp3_1;
        PTMP_tmp3_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp4_1);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = PrtMkIntValue(-PrtPrimGetInt(p_this->varValues[1]));
    
    {
        PRT_VALUE** P_LVALUE_31 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_31);
        *P_LVALUE_31 = PTMP_tmp4_1;
        PTMP_tmp4_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_32 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_33 = &(PTMP_tmp5_1);
    PrtFreeValue(*P_LVALUE_33);
    *P_LVALUE_33 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[1], (&P_LIT_INT32_9)));
    
    if (PrtPrimGetBool(PTMP_tmp5_1))
    {
        PRT_VALUE** P_LVALUE_34 = &(PTMP_tmp6_1);
        PrtFreeValue(*P_LVALUE_34);
        *P_LVALUE_34 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[1]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        
        {
            PRT_VALUE** P_LVALUE_35 = &(p_this->varValues[1]);
            PrtFreeValue(*P_LVALUE_35);
            *P_LVALUE_35 = PTMP_tmp6_1;
            PTMP_tmp6_1 = NULL;
        }
    ...
    else
    {
        ...
        *P_LVALUE_36 = PrtCloneValue((&P_LIT_INT32_11));
    ...
    *P_LVALUE_37 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[1], (&P_LIT_INT32_9)));
    
    if (PrtPrimGetBool(PTMP_tmp7_1))
    {
        PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp8_1);
        PrtFreeValue(*P_LVALUE_38);
        *P_LVALUE_38 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[1]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        
        {
            PRT_VALUE** P_LVALUE_39 = &(p_this->varValues[1]);
    ...
    *P_LVALUE_40 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[2], (&P_LIT_INT32_9)));
    
    if (PrtPrimGetBool(PTMP_tmp9_1))
    {
        PRT_VALUE** P_LVALUE_41 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_41);
        *P_LVALUE_41 = PrtCloneValue((&P_LIT_INT32_12));
    ...
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp10_1);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[1], (&P_LIT_INT32_9)));
    
    if (PrtPrimGetBool(PTMP_tmp10_1))
    {
        PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp11_1);
        PrtFreeValue(*P_LVALUE_43);
        *P_LVALUE_43 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[1]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        
        {
            PRT_VALUE** P_LVALUE_44 = &(p_this->varValues[1]);
            PrtFreeValue(*P_LVALUE_44);
            *P_LVALUE_44 = PTMP_tmp11_1;
            PTMP_tmp11_1 = NULL;
        }
    ...
    {
        PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp12);
        PrtFreeValue(*P_LVALUE_45);
        *P_LVALUE_45 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[1], (&P_LIT_INT32_13)));
        
        if (PrtPrimGetBool(PTMP_tmp12))
        {
            PRT_VALUE** P_LVALUE_46 = &(p_this->varValues[1]);
            PrtFreeValue(*P_LVALUE_46);
            *P_LVALUE_46 = PrtCloneValue((&P_LIT_INT32_12));
        ...
        else
        {
            ...
            *P_LVALUE_47 = PrtCloneValue((&P_LIT_INT32_11));
    ...
    {
        PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp13);
        PrtFreeValue(*P_LVALUE_48);
        *P_LVALUE_48 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[1], (&P_LIT_INT32_9)));
        
        PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp14);
        PrtFreeValue(*P_LVALUE_49);
        *P_LVALUE_49 = PrtCloneValue(PTMP_tmp13);
        ...
        PRT_VALUE** P_LVALUE_50 = &(PTMP_tmp15);
        PrtFreeValue(*P_LVALUE_50);
        *P_LVALUE_50 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[1]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        
        {
            PRT_VALUE** P_LVALUE_51 = &(p_this->varValues[1]);
            PrtFreeValue(*P_LVALUE_51);
            *P_LVALUE_51 = PTMP_tmp15;
            PTMP_tmp15 = NULL;
        }
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_1)))
    {
        PRT_VALUE** P_LVALUE_52 = &(PTMP_tmp16);
        PrtFreeValue(*P_LVALUE_52);
        *P_LVALUE_52 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[1], (&P_LIT_INT32_9)));
        
        PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp17);
        PrtFreeValue(*P_LVALUE_53);
        *P_LVALUE_53 = PrtCloneValue(PTMP_tmp16);
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_1)))
    {
        ...
        *P_LVALUE_54 = PrtMkBoolValue(PrtIsEqualValue(p_this->varValues[2], (&P_LIT_INT32_9)));
        
        PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp19);
        PrtFreeValue(*P_LVALUE_55);
        *P_LVALUE_55 = PrtCloneValue(PTMP_tmp18);
        ...
        *P_LVALUE_56 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[1]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        
        {
            PRT_VALUE** P_LVALUE_57 = &(p_this->varValues[1]);
            PrtFreeValue(*P_LVALUE_57);
            *P_LVALUE_57 = PTMP_tmp20;
            PTMP_tmp20 = NULL;
        }
    ...
    _P_GEN_funargs[0] = "VotingMachine";
    _P_GEN_funargs[1] = "0";
    PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp21);
...
PRT_FUNDECL* P_Coordinator_METHODS[] = { &P_FUNCTION_Anon_1, &P_FUNCTION_Anon_2 };

PRT_EVENTDECL* P_Coordinator_RECV_INNER_1[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_Coordinator_SEND_INNER[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
...
PRT_UINT32 P_Coordinator_CREATES_ARR[] = { 0 };
...
PRT_EVENTDECL* P_SecureChild_RECV_INNER_1[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_SecureChild_SEND_INNER[] = { &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_ALL_EVENTS[] = { &_P_EVENT_NULL_STRUCT, &_P_EVENT_HALT_STRUCT, &P_EVENT_Ping, &P_EVENT_Pong, &P_EVENT_UntrustedEventFromPing };
PRT_MACHINEDECL* P_ALL_MACHINES[] = { &P_MACHINE_VotingMachine, &P_MACHINE_Coordinator, &P_MACHINE_SecureChild };
PRT_INTERFACEDECL* P_ALL_INTERFACES[] = { &P_I_VotingMachine, &P_I_Coordinator, &P_I_SecureChild };
PRT_FUNDECL* P_ALL_FUNCTIONS[] = { &P_FUNCTION_ReadSSNFromUser };
PRT_FOREIGNTYPEDECL* P_ALL_FOREIGN_TYPES[] = { &P_StringType };
int P_DefaultImpl_LME_0[] = { -1,-1,-1 };
int P_DefaultImpl_LME_1[] = { 0,-1,-1 };
