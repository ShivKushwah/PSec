...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_47 = PrtCloneValue((&P_EVENT_GenerateOTPCodeEvent.value));
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_payload_4 = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp5_2);
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_50 = &(PTMP_tmp0_6);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_51);
    *P_LVALUE_51 = PrtMapGet(*P_VAR_payload_6, (&P_LIT_INT32_7));
...
PRT_FOREIGNTYPEDECL* P_ALL_FOREIGN_TYPES[] = { &P_StringType, &P_machine_handle };
