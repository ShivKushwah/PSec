...
static PRT_TYPE* P_TUP_T[] = { &P_GEND_TYPE_secure_machine_handle, &P_GEND_TYPE_secure_machine_handle };
static PRT_TUPTYPE P_TUP = { 2U, P_TUP_T };
static PRT_TYPE P_GEND_TYPE_T2secure_machine_handlesecure_machine_handle = { PRT_KIND_TUPLE, { .tuple = &P_TUP } };
...
PRT_EVENTDECL P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "UNTRUSTEDSecureHealthAnalyzerIDEvent",
    4294967295U,
    &P_GEND_TYPE_machine_handle,
    0
};

PRT_EVENTDECL P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "UNTRUSTEDReceiveUserEnclaveIDEvent",
    4294967295U,
    &P_GEND_TYPE_machine_handle,
    0
};

PRT_EVENTDECL P_EVENT_UNTRUSTEDUserEnclaveIDEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "UNTRUSTEDUserEnclaveIDEvent",
    4294967295U,
    &P_GEND_TYPE_machine_handle,
    0
};

PRT_EVENTDECL P_EVENT_UNTRUSTEDHealthInfoEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "UNTRUSTEDHealthInfoEvent",
    4294967295U,
    &P_GEND_TYPE_StringType,
    0
};

PRT_EVENTDECL P_EVENT_UNTRUSTEDHealthInfoResultEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "UNTRUSTEDHealthInfoResultEvent",
    4294967295U,
    &P_GEND_TYPE_b,
    0
};

PRT_EVENTDECL P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "TRUSTEDSecureHealthAnalyzerIDEvent",
    4294967295U,
    &P_GEND_TYPE_secure_machine_handle,
    1
};

PRT_EVENTDECL P_EVENT_TRUSTEDProvisionUserEnclave = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "TRUSTEDProvisionUserEnclave",
    4294967295U,
    &P_GEND_TYPE_T2secure_machine_handlesecure_machine_handle,
    1
};

PRT_EVENTDECL P_EVENT_TRUSTEDHealthInfoEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "TRUSTEDHealthInfoEvent",
    4294967295U,
    &P_GEND_TYPE_T2secure_machine_handlesecure_StringType,
    1
};

PRT_EVENTDECL P_EVENT_TRUSTEDHealthInfoResultEvent = 
{
    { PRT_VALUE_KIND_EVENT, 0U },
    "TRUSTEDHealthInfoResultEvent",
    4294967295U,
    &P_GEND_TYPE_sb,
    1
};
...
PRT_EVENTDECL* P_UserEnclave_RECV_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_UserEnclave_RECV =
{
    10U,
    P_UserEnclave_RECV_INNER,
    NULL
};

PRT_INTERFACEDECL P_I_UserEnclave =
{
    0U,
    "UserEnclave",
    &P_GEND_TYPE_n,
    &P_EVENTSET_UserEnclave_RECV
};

PRT_EVENTDECL* P_User_RECV_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_User_RECV =
{
    10U,
    P_User_RECV_INNER,
    NULL
...
PRT_INTERFACEDECL P_I_User =
{
    1U,
    "User",
    &P_GEND_TYPE_n,
    &P_EVENTSET_User_RECV
};

PRT_EVENTDECL* P_UntrustedInitializer_RECV_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_TrustedInitializer_RECV_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_EVENTDECL* P_SecureHealthAnalyzer_RECV_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_SecureHealthAnalyzer_RECV =
{
    10U,
    P_SecureHealthAnalyzer_RECV_INNER,
    NULL
};

PRT_INTERFACEDECL P_I_SecureHealthAnalyzer =
{
    4U,
    "SecureHealthAnalyzer",
    &P_GEND_TYPE_n,
    &P_EVENTSET_SecureHealthAnalyzer_RECV
};

PRT_EVENTDECL* P_awsMLHost_RECV_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_awsMLHost_RECV =
{
    10U,
    P_awsMLHost_RECV_INNER,
    NULL
};

PRT_INTERFACEDECL P_I_awsMLHost =
{
    5U,
    "awsMLHost",
    &P_GEND_TYPE_n,
    &P_EVENTSET_awsMLHost_RECV
};

PRT_VARDECL P_UserEnclave_VARS[] = {
    { "healthAnalyzerSSM", &P_GEND_TYPE_secure_machine_handle },
    { "userUSM", &P_GEND_TYPE_machine_handle }
};
...
PRT_EVENTDECL* P_Initial_DOS_INNER[] = { &P_EVENT_TRUSTEDProvisionUserEnclave };
...
PRT_DODECL P_DOS[] =
{
    { 0, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_FUNCTION_Anon }
};

#define P_STATE_UserEnclave_Initial \
{ \
    "UserEnclave.Initial", \
    0U, \
    1U, \
...
PRT_EVENTDECL* P_ReceiveHealthInfoAndSendHealthRequest_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_ReceiveHealthInfoAndSendHealthRequest_DEFERS =
{
    0U,
    P_ReceiveHealthInfoAndSendHealthRequest_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_ReceiveHealthInfoAndSendHealthRequest_TRANS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_ReceiveHealthInfoAndSendHealthRequest_TRANS =
{
    0U,
    P_ReceiveHealthInfoAndSendHealthRequest_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_ReceiveHealthInfoAndSendHealthRequest_DOS_INNER[] = { &P_EVENT_UNTRUSTEDHealthInfoEvent };
PRT_EVENTSETDECL P_EVENTSET_ReceiveHealthInfoAndSendHealthRequest_DOS =
{
    1U,
    P_ReceiveHealthInfoAndSendHealthRequest_DOS_INNER,
    NULL
};

PRT_DODECL P_DOS_1[] =
{
    { 1, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_FUNCTION_Anon_1 }
};

#define P_STATE_UserEnclave_ReceiveHealthInfoAndSendHealthRequest \
{ \
    "UserEnclave.ReceiveHealthInfoAndSendHealthRequest", \
    0U, \
    1U, \
    &P_EVENTSET_ReceiveHealthInfoAndSendHealthRequest_DEFERS, \
    &P_EVENTSET_ReceiveHealthInfoAndSendHealthRequest_TRANS, \
    &P_EVENTSET_ReceiveHealthInfoAndSendHealthRequest_DOS, \
    NULL, \
    P_DOS_1, \
    &_P_NO_OP, \
    &_P_NO_OP, \
...
PRT_EVENTDECL* P_ReceiveHealthInfoResult_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_ReceiveHealthInfoResult_DEFERS =
{
    0U,
    P_ReceiveHealthInfoResult_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_ReceiveHealthInfoResult_TRANS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_ReceiveHealthInfoResult_TRANS =
{
    0U,
    P_ReceiveHealthInfoResult_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_ReceiveHealthInfoResult_DOS_INNER[] = { &P_EVENT_TRUSTEDHealthInfoResultEvent };
PRT_EVENTSETDECL P_EVENTSET_ReceiveHealthInfoResult_DOS =
{
    1U,
    P_ReceiveHealthInfoResult_DOS_INNER,
    NULL
};

PRT_DODECL P_DOS_2[] =
{
    { 2, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_FUNCTION_Anon_2 }
};

#define P_STATE_UserEnclave_ReceiveHealthInfoResult \
{ \
    "UserEnclave.ReceiveHealthInfoResult", \
    0U, \
    1U, \
    &P_EVENTSET_ReceiveHealthInfoResult_DEFERS, \
    &P_EVENTSET_ReceiveHealthInfoResult_TRANS, \
    &P_EVENTSET_ReceiveHealthInfoResult_DOS, \
    NULL, \
    P_DOS_2, \
    &_P_NO_OP, \
    &_P_NO_OP, \
...
PRT_STATEDECL P_UserEnclave_STATES[] = { P_STATE_UserEnclave_Initial, P_STATE_UserEnclave_ReceiveHealthInfoAndSendHealthRequest, P_STATE_UserEnclave_ReceiveHealthInfoResult };
...
PRT_VALUE* P_Anon_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_9 = ((_P_GEN_funargs[0] = &(PTMP_tmp1_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp1_1), PTMP_tmp1_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_1;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_10 = &(PTMP_tmp3_1);
    PrtFreeValue(*P_LVALUE_10);
    *P_LVALUE_10 = PrtCloneValue(PrtCastValue(PTMP_tmp2_1, &P_GEND_TYPE_machine_handle));
    
    {
        PRT_VALUE** P_LVALUE_11 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_11);
        *P_LVALUE_11 = PTMP_tmp3_1;
        PTMP_tmp3_1 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_13 = PrtCloneValue((&P_EVENT_TRUSTEDHealthInfoEvent.value));
    
    PRT_VALUE** P_LVALUE_14 = &(PTMP_tmp2_2);
    PrtFreeValue(*P_LVALUE_14);
    *P_LVALUE_14 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    
    PRT_VALUE** P_LVALUE_15 = &(PTMP_tmp3_2);
    PrtFreeValue(*P_LVALUE_15);
    *P_LVALUE_15 = PrtCloneValue(*P_VAR_payload_1);
    
    PRT_VALUE** P_LVALUE_16 = &(PTMP_tmp4);
    PrtFreeValue(*P_LVALUE_16);
    *P_LVALUE_16 = ((_P_GEN_funargs[0] = &(PTMP_tmp3_2)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp3_2), PTMP_tmp3_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_17 = PrtCloneValue(PrtCastValue(PTMP_tmp4, &P_GEND_TYPE_secure_StringType));
    
    PRT_VALUE** P_LVALUE_18 = &(PTMP_tmp6);
    PrtFreeValue(*P_LVALUE_18);
    *P_LVALUE_18 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_StringType, &(PTMP_tmp2_2), &(PTMP_tmp5)));
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_19 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_20 = &(PTMP_tmp1_3);
    PrtFreeValue(*P_LVALUE_20);
    *P_LVALUE_20 = PrtCloneValue((&P_EVENT_UNTRUSTEDHealthInfoResultEvent.value));
    
    PRT_VALUE** P_LVALUE_21 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_21);
    *P_LVALUE_21 = PrtCloneValue(*P_VAR_payload_2);
    
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_22);
    *P_LVALUE_22 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_3)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_3), PTMP_tmp2_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_23 = &(PTMP_tmp4_1);
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = PrtCloneValue(PrtCastValue(PTMP_tmp3_3, &P_GEND_TYPE_b));
...
PRT_FUNDECL* P_UserEnclave_METHODS[] = { &P_FUNCTION_Anon, &P_FUNCTION_Anon_1, &P_FUNCTION_Anon_2 };

PRT_EVENTDECL* P_UserEnclave_RECV_INNER_1[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_UserEnclave_RECV_1 =
{
    10U,
    P_UserEnclave_RECV_INNER_1,
    NULL
};

PRT_EVENTDECL* P_UserEnclave_SEND_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_UserEnclave_SEND =
{
    10U,
    P_UserEnclave_SEND_INNER,
    NULL
};

PRT_MACHINEDECL P_MACHINE_UserEnclave = 
{
    0U,
    "UserEnclave",
    &P_EVENTSET_UserEnclave_RECV_1,
    &P_EVENTSET_UserEnclave_SEND,
    NULL,
    2U,
    3U,
    3U,
    ...
    0U,
    P_UserEnclave_VARS,
    P_UserEnclave_STATES,
    P_UserEnclave_METHODS,
    PRT_TRUE
};

PRT_VARDECL P_User_VARS[] = {
    { "healthAnalyzerSSM", &P_GEND_TYPE_machine_handle },
    { "userEnclaveSSM", &P_GEND_TYPE_machine_handle }
};
...
PRT_EVENTDECL* P_Initial_TRANS_INNER_1[] = { &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent };
...
{
    { 0, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, 1, &_P_NO_OP }
};

#define P_STATE_User_Initial \
{ \
    "User.Initial", \
    1U, \
    0U, \
...
PRT_EVENTDECL* P_SaveSecureHealthAnalyzer_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_SaveSecureHealthAnalyzer_DEFERS =
{
    0U,
    P_SaveSecureHealthAnalyzer_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_SaveSecureHealthAnalyzer_TRANS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_SaveSecureHealthAnalyzer_TRANS =
{
    0U,
    P_SaveSecureHealthAnalyzer_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_SaveSecureHealthAnalyzer_DOS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_SaveSecureHealthAnalyzer_DOS =
{
    0U,
    P_SaveSecureHealthAnalyzer_DOS_INNER,
    NULL
};

#define P_STATE_User_SaveSecureHealthAnalyzer \
{ \
    "User.SaveSecureHealthAnalyzer", \
    0U, \
    0U, \
    &P_EVENTSET_SaveSecureHealthAnalyzer_DEFERS, \
    &P_EVENTSET_SaveSecureHealthAnalyzer_TRANS, \
    &P_EVENTSET_SaveSecureHealthAnalyzer_DOS, \
    NULL, \
    NULL, \
    &P_FUNCTION_Anon_3, \
    &_P_NO_OP, \
...
PRT_EVENTDECL* P_SaveUserEnclave_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_SaveUserEnclave_DEFERS =
{
    0U,
    P_SaveUserEnclave_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_SaveUserEnclave_TRANS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_SaveUserEnclave_TRANS =
{
    0U,
    P_SaveUserEnclave_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_SaveUserEnclave_DOS_INNER[] = { &P_EVENT_UNTRUSTEDUserEnclaveIDEvent };
PRT_EVENTSETDECL P_EVENTSET_SaveUserEnclave_DOS =
{
    1U,
    P_SaveUserEnclave_DOS_INNER,
    NULL
};

PRT_DODECL P_DOS_3[] =
{
    { 2, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &P_FUNCTION_Anon_5 }
};

#define P_STATE_User_SaveUserEnclave \
{ \
    "User.SaveUserEnclave", \
    0U, \
    1U, \
    &P_EVENTSET_SaveUserEnclave_DEFERS, \
    &P_EVENTSET_SaveUserEnclave_TRANS, \
    &P_EVENTSET_SaveUserEnclave_DOS, \
    NULL, \
    P_DOS_3, \
    &P_FUNCTION_Anon_4, \
    &_P_NO_OP, \
...
PRT_EVENTDECL* P_RequestHealthCheck_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_RequestHealthCheck_DEFERS =
{
    0U,
    P_RequestHealthCheck_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_RequestHealthCheck_TRANS_INNER[] = { &P_EVENT_UNTRUSTEDHealthInfoResultEvent };
PRT_EVENTSETDECL P_EVENTSET_RequestHealthCheck_TRANS =
{
    1U,
    P_RequestHealthCheck_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_RequestHealthCheck_DOS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_RequestHealthCheck_DOS =
{
    0U,
    P_RequestHealthCheck_DOS_INNER,
    NULL
};

PRT_TRANSDECL P_TRANS_1[] =
{
    { 3, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, 4, &_P_NO_OP }
};

#define P_STATE_User_RequestHealthCheck \
{ \
    "User.RequestHealthCheck", \
    1U, \
    0U, \
    &P_EVENTSET_RequestHealthCheck_DEFERS, \
    &P_EVENTSET_RequestHealthCheck_TRANS, \
    &P_EVENTSET_RequestHealthCheck_DOS, \
    P_TRANS_1, \
    NULL, \
    &P_FUNCTION_Anon_6, \
    &_P_NO_OP, \
...
PRT_STATEDECL P_User_STATES[] = { P_STATE_User_Initial, P_STATE_User_SaveSecureHealthAnalyzer, P_STATE_User_SaveUserEnclave, P_STATE_User_RequestHealthCheck, P_STATE_User_Done };
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_25 = PrtCloneValue(p_this->varValues[0]);
    ...
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp1_4);
    PrtFreeValue(*P_LVALUE_26);
    *P_LVALUE_26 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent.value));
    
    PRT_VALUE** P_LVALUE_27 = &(PTMP_tmp2_4);
    PrtFreeValue(*P_LVALUE_27);
    *P_LVALUE_27 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_28 = PrtCloneValue(*P_VAR_payload_4);
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_MACHINEINST_PRIV* p_this = (PRT_MACHINEINST_PRIV*)context;
    PRT_VALUE* _P_GEN_retval = NULL;
    PRT_VALUE* P_VAR_healthInfo = PrtMkDefaultValue(&P_GEND_TYPE_StringType);
    ...
    *P_LVALUE_29 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = PrtCloneValue((&P_EVENT_UNTRUSTEDHealthInfoEvent.value));
    
    PRT_VALUE** P_LVALUE_31 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_31);
    *P_LVALUE_31 = PrtCloneValue(P_VAR_healthInfo);
...
p_return_7: ;
    PrtFreeValue(P_VAR_healthInfo); P_VAR_healthInfo = NULL;
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = PrtMkBoolValue(PrtIsEqualValue(*P_VAR_payload_5, (&P_LIT_BOOLEAN)));
...
PRT_FUNDECL* P_User_METHODS[] = { &P_FUNCTION_Anon_3, &P_FUNCTION_Anon_4, &P_FUNCTION_Anon_5, &P_FUNCTION_Anon_6, &P_FUNCTION_Anon_7 };

PRT_EVENTDECL* P_User_RECV_INNER_1[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_User_RECV_1 =
{
    10U,
    P_User_RECV_INNER_1,
    NULL
...
PRT_EVENTDECL* P_User_SEND_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_User_SEND =
{
    10U,
    P_User_SEND_INNER,
    NULL
...
PRT_MACHINEDECL P_MACHINE_User = 
{
    1U,
    "User",
    &P_EVENTSET_User_RECV_1,
    &P_EVENTSET_User_SEND,
    NULL,
    2U,
    5U,
    5U,
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_33 = &(PTMP_tmp0_7);
...
PRT_EVENTDECL* P_UntrustedInitializer_RECV_INNER_1[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    _P_GEN_funargs[0] = "User";
    _P_GEN_funargs[1] = "0";
    _P_GEN_funargs[2] = NULL;
    PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_35);
    *P_LVALUE_35 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_36 = PTMP_tmp0_8;
        PTMP_tmp0_8 = NULL;
    }
    
    _P_GEN_funargs[0] = "SecureHealthAnalyzer";
    _P_GEN_funargs[1] = "0";
    ...
    *P_LVALUE_37 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    
    {
        ...
        *P_LVALUE_38 = PTMP_tmp1_6;
        PTMP_tmp1_6 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp2_6);
    PrtFreeValue(*P_LVALUE_39);
    *P_LVALUE_39 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp3_4);
    PrtFreeValue(*P_LVALUE_40);
    *P_LVALUE_40 = PrtCloneValue((&P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent.value));
    
    PRT_VALUE** P_LVALUE_41 = &(PTMP_tmp4_2);
    PrtFreeValue(*P_LVALUE_41);
    *P_LVALUE_41 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp5_1);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_2), PTMP_tmp4_2 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp6_1);
    PrtFreeValue(*P_LVALUE_43);
    *P_LVALUE_43 = PrtCloneValue(PrtCastValue(PTMP_tmp5_1, &P_GEND_TYPE_machine_handle));
...
PRT_UINT32 P_TrustedInitializer_CREATES_ARR[] = { 4, 1 };
...
PRT_VARDECL P_SecureHealthAnalyzer_VARS[] = {
    { "MLHost", &P_GEND_TYPE_secure_machine_handle }
};
...
PRT_EVENTDECL* P_Initial_DOS_INNER_4[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent };
...
PRT_DODECL P_DOS_4[] =
{
    { 0, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_FUNCTION_Anon_11 },
    { 0, &P_EVENT_TRUSTEDHealthInfoEvent, &P_FUNCTION_Anon_12 }
};

#define P_STATE_SecureHealthAnalyzer_Initial \
{ \
    "SecureHealthAnalyzer.Initial", \
    0U, \
    2U, \
...
PRT_STATEDECL P_SecureHealthAnalyzer_STATES[] = { P_STATE_SecureHealthAnalyzer_Initial };
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_userEnclaveSSM = PrtMkDefaultValue(&P_GEND_TYPE_secure_machine_handle);
    ...
    _P_GEN_funargs[0] = "UserEnclave";
    _P_GEN_funargs[1] = "0";
    _P_GEN_funargs[2] = &(*P_VAR_payload_6);
    PRT_VALUE** P_LVALUE_46 = &(PTMP_tmp0_10);
    PrtFreeValue(*P_LVALUE_46);
    *P_LVALUE_46 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_12;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_47 = &(P_VAR_userEnclaveSSM);
        PrtFreeValue(*P_LVALUE_47);
        *P_LVALUE_47 = PTMP_tmp0_10;
        PTMP_tmp0_10 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp1_7);
    PrtFreeValue(*P_LVALUE_48);
    *P_LVALUE_48 = PrtCloneValue(P_VAR_userEnclaveSSM);
    
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp2_7);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionUserEnclave.value));
    
    PRT_VALUE** P_LVALUE_50 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_50);
    *P_LVALUE_50 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    ...
    *P_LVALUE_52 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_3)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_3), PTMP_tmp4_3 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_12;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_53 = PrtCloneValue(PrtCastValue(PTMP_tmp5_2, &P_GEND_TYPE_secure_machine_handle));
    
    PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp7);
    PrtFreeValue(*P_LVALUE_54);
    *P_LVALUE_54 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_machine_handle, &(PTMP_tmp3_5), &(PTMP_tmp6_2)));
    ...
    PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp8);
    PrtFreeValue(*P_LVALUE_55);
    *P_LVALUE_55 = PrtCloneValue(*P_VAR_payload_6);
    
    PRT_VALUE** P_LVALUE_56 = &(PTMP_tmp9);
    PrtFreeValue(*P_LVALUE_56);
    *P_LVALUE_56 = PrtCloneValue((&P_EVENT_UNTRUSTEDUserEnclaveIDEvent.value));
    
    PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp10);
    PrtFreeValue(*P_LVALUE_57);
    *P_LVALUE_57 = PrtCloneValue(P_VAR_userEnclaveSSM);
    
    PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp11);
    PrtFreeValue(*P_LVALUE_58);
    *P_LVALUE_58 = ((_P_GEN_funargs[0] = &(PTMP_tmp10)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp10), PTMP_tmp10 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_12;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp12);
    PrtFreeValue(*P_LVALUE_59);
    *P_LVALUE_59 = PrtCloneValue(PrtCastValue(PTMP_tmp11, &P_GEND_TYPE_machine_handle));
...
p_return_12: ;
    PrtFreeValue(P_VAR_userEnclaveSSM); P_VAR_userEnclaveSSM = NULL;
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_60);
    *P_LVALUE_60 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_61 = &(PTMP_tmp1_8);
    PrtFreeValue(*P_LVALUE_61);
    *P_LVALUE_61 = PrtCloneValue((&P_EVENT_TRUSTEDHealthInfoEvent.value));
    
    PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp2_8);
    PrtFreeValue(*P_LVALUE_62);
    *P_LVALUE_62 = PrtTupleGet(*P_VAR_payload_7, 0);
    
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp3_6);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtTupleGet(*P_VAR_payload_7, 1);
    
    PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_64);
    *P_LVALUE_64 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_StringType, &(PTMP_tmp2_8), &(PTMP_tmp3_6)));
...
PRT_FUNDECL* P_SecureHealthAnalyzer_METHODS[] = { &P_FUNCTION_Anon_10, &P_FUNCTION_Anon_11, &P_FUNCTION_Anon_12 };

PRT_EVENTDECL* P_SecureHealthAnalyzer_RECV_INNER_1[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_SecureHealthAnalyzer_RECV_1 =
{
    10U,
    P_SecureHealthAnalyzer_RECV_INNER_1,
    NULL
};

PRT_EVENTDECL* P_SecureHealthAnalyzer_SEND_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_SecureHealthAnalyzer_SEND =
{
    10U,
    P_SecureHealthAnalyzer_SEND_INNER,
    NULL
};

PRT_UINT32 P_SecureHealthAnalyzer_CREATES_ARR[] = { 0, 5 };
PRT_INTERFACESETDECL P_SecureHealthAnalyzer_CREATES = { 2, P_SecureHealthAnalyzer_CREATES_ARR };
PRT_MACHINEDECL P_MACHINE_SecureHealthAnalyzer = 
{
    4U,
    "SecureHealthAnalyzer",
    &P_EVENTSET_SecureHealthAnalyzer_RECV_1,
    &P_EVENTSET_SecureHealthAnalyzer_SEND,
    &P_SecureHealthAnalyzer_CREATES,
    1U,
    1U,
    3U,
    4294967295U,
    0U,
    P_SecureHealthAnalyzer_VARS,
    P_SecureHealthAnalyzer_STATES,
    P_SecureHealthAnalyzer_METHODS,
    PRT_TRUE
};
...
PRT_EVENTDECL* P_Initial_DOS_INNER_5[] = { &P_EVENT_TRUSTEDHealthInfoEvent };
...
PRT_DODECL P_DOS_5[] =
{
    { 0, &P_EVENT_TRUSTEDHealthInfoEvent, &P_FUNCTION_Anon_13 }
};

#define P_STATE_awsMLHost_Initial \
{ \
    "awsMLHost.Initial", \
    0U, \
    1U, \
...
PRT_STATEDECL P_awsMLHost_STATES[] = { P_STATE_awsMLHost_Initial };
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_userEnclaveSSM_1 = PrtMkDefaultValue(&P_GEND_TYPE_secure_machine_handle);
    ...
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp0_12);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtTupleGet(*P_VAR_payload_8, 0);
    
    {
        PRT_VALUE** P_LVALUE_66 = &(P_VAR_userEnclaveSSM_1);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = PTMP_tmp0_12;
        PTMP_tmp0_12 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp1_9);
    PrtFreeValue(*P_LVALUE_67);
    *P_LVALUE_67 = (PrtMkNondetBoolValue());
    
    if (PrtPrimGetBool(PTMP_tmp1_9))
    {
        PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp2_9);
        PrtFreeValue(*P_LVALUE_68);
        *P_LVALUE_68 = PrtCloneValue(P_VAR_userEnclaveSSM_1);
        
        PRT_VALUE** P_LVALUE_69 = &(PTMP_tmp3_7);
        PrtFreeValue(*P_LVALUE_69);
        *P_LVALUE_69 = PrtCloneValue((&P_EVENT_TRUSTEDHealthInfoResultEvent.value));
        
        PRT_VALUE** P_LVALUE_70 = &(PTMP_tmp4_5);
        PrtFreeValue(*P_LVALUE_70);
        *P_LVALUE_70 = PrtCloneValue((&P_LIT_BOOLEAN_1));
        
        PRT_VALUE** P_LVALUE_71 = &(PTMP_tmp5_3);
        PrtFreeValue(*P_LVALUE_71);
        *P_LVALUE_71 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_5)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_5), PTMP_tmp4_5 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_14;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_72 = PrtCloneValue(PrtCastValue(PTMP_tmp5_3, &P_GEND_TYPE_sb));
    ...
    {
        PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp7_1);
        PrtFreeValue(*P_LVALUE_73);
        *P_LVALUE_73 = PrtCloneValue(P_VAR_userEnclaveSSM_1);
        
        PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp8_1);
        PrtFreeValue(*P_LVALUE_74);
        *P_LVALUE_74 = PrtCloneValue((&P_EVENT_TRUSTEDHealthInfoResultEvent.value));
        
        PRT_VALUE** P_LVALUE_75 = &(PTMP_tmp9_1);
        PrtFreeValue(*P_LVALUE_75);
        *P_LVALUE_75 = PrtCloneValue((&P_LIT_BOOLEAN_2));
        
        PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp10_1);
        PrtFreeValue(*P_LVALUE_76);
        *P_LVALUE_76 = ((_P_GEN_funargs[0] = &(PTMP_tmp9_1)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp9_1), PTMP_tmp9_1 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_14;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_77 = &(PTMP_tmp11_1);
        PrtFreeValue(*P_LVALUE_77);
        *P_LVALUE_77 = PrtCloneValue(PrtCastValue(PTMP_tmp10_1, &P_GEND_TYPE_sb));
...
p_return_14: ;
    PrtFreeValue(P_VAR_userEnclaveSSM_1); P_VAR_userEnclaveSSM_1 = NULL;
...
PRT_FUNDECL* P_awsMLHost_METHODS[] = { &P_FUNCTION_Anon_13 };

PRT_EVENTDECL* P_awsMLHost_RECV_INNER_1[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_awsMLHost_RECV_1 =
{
    10U,
    P_awsMLHost_RECV_INNER_1,
    NULL
};

PRT_EVENTDECL* P_awsMLHost_SEND_INNER[] = { &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &_P_EVENT_HALT_STRUCT };
PRT_EVENTSETDECL P_EVENTSET_awsMLHost_SEND =
{
    10U,
    P_awsMLHost_SEND_INNER,
    NULL
};

PRT_MACHINEDECL P_MACHINE_awsMLHost = 
{
    5U,
    "awsMLHost",
    &P_EVENTSET_awsMLHost_RECV_1,
    &P_EVENTSET_awsMLHost_SEND,
    NULL,
    0U,
    1U,
    1U,
...
PRT_EVENTDECL* P_ALL_EVENTS[] = { &_P_EVENT_NULL_STRUCT, &_P_EVENT_HALT_STRUCT, &P_EVENT_UNTRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_UNTRUSTEDReceiveUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDUserEnclaveIDEvent, &P_EVENT_UNTRUSTEDHealthInfoEvent, &P_EVENT_UNTRUSTEDHealthInfoResultEvent, &P_EVENT_TRUSTEDSecureHealthAnalyzerIDEvent, &P_EVENT_TRUSTEDProvisionUserEnclave, &P_EVENT_TRUSTEDHealthInfoEvent, &P_EVENT_TRUSTEDHealthInfoResultEvent };
PRT_MACHINEDECL* P_ALL_MACHINES[] = { &P_MACHINE_UserEnclave, &P_MACHINE_User, &P_MACHINE_UntrustedInitializer, &P_MACHINE_TrustedInitializer, &P_MACHINE_SecureHealthAnalyzer, &P_MACHINE_awsMLHost };
PRT_INTERFACEDECL* P_ALL_INTERFACES[] = { &P_I_UserEnclave, &P_I_User, &P_I_UntrustedInitializer, &P_I_TrustedInitializer, &P_I_SecureHealthAnalyzer, &P_I_awsMLHost };
...
int P_DefaultImpl_LME_4[] = { 0,-1,-1,-1,-1,5 };
