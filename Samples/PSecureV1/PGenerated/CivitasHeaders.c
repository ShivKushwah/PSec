...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_47 = PrtCloneValue((&P_LIT_BOOLEAN));
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_1)))
    {
        ...
        *P_LVALUE_52 = PrtCloneValue(PrtCastValue(PTMP_tmp3_3, &P_GEND_TYPE_StringType));
        ...
        *P_LVALUE_54 = PrtCloneValue(PrtCastValue(PTMP_tmp5_3, &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp7_3);
        PrtFreeValue(*P_LVALUE_55);
        *P_LVALUE_55 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp4_3, PTMP_tmp6_3));
        
        if (PrtPrimGetBool(PTMP_tmp7_3))
        {
            PRT_VALUE** P_LVALUE_56 = &(P_VAR_found);
            PrtFreeValue(*P_LVALUE_56);
            *P_LVALUE_56 = PrtCloneValue((&P_LIT_BOOLEAN_1));
        ...
        PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp8_3);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_1) + PrtPrimGetInt((&P_LIT_INT32_6)));
        
        {
            PRT_VALUE** P_LVALUE_58 = &(P_VAR_i_1);
            PrtFreeValue(*P_LVALUE_58);
            *P_LVALUE_58 = PTMP_tmp8_3;
            PTMP_tmp8_3 = NULL;
        }
    ...
    if (PrtPrimGetBool(P_VAR_found))
    {
        ...
        *P_LVALUE_59 = PrtTupleGet(*P_VAR_payload, 0);
        ...
        PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp10_3);
        PrtFreeValue(*P_LVALUE_60);
        *P_LVALUE_60 = PrtCloneValue(PTMP_tmp9_3);
        
        PRT_VALUE** P_LVALUE_61 = &(PTMP_tmp11_2);
        PrtFreeValue(*P_LVALUE_61);
        *P_LVALUE_61 = PrtCloneValue((&P_EVENT_TRUSTEDValidCredential.value));
        
        PRT_VALUE* P_PTMP_tmp_6 = PrtCloneValue(&(P_LIT_INT32_5));
        _P_GEN_funargs[0] = &(PTMP_tmp10_3);
    ...
    else
    {
        ...
        *P_LVALUE_62 = PrtTupleGet(*P_VAR_payload, 0);
        
        PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp13_1);
        PrtFreeValue(*P_LVALUE_63);
        *P_LVALUE_63 = PrtCloneValue(PTMP_tmp12_2);
        
        PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp14_1);
        PrtFreeValue(*P_LVALUE_64);
        *P_LVALUE_64 = PrtCloneValue((&P_EVENT_TRUSTEDInvalidCredential.value));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp0_4);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    {
        PRT_VALUE** P_LVALUE_66 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = PTMP_tmp0_4;
        PTMP_tmp0_4 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp1_4);
    PrtFreeValue(*P_LVALUE_67);
    *P_LVALUE_67 = PrtTupleGet(*P_VAR_payload_1, 1);
    
    {
        PRT_VALUE** P_LVALUE_68 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_68);
        *P_LVALUE_68 = PTMP_tmp1_4;
        PTMP_tmp1_4 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_73 = PrtCloneValue((&P_LIT_INT32_8));
    ...
    *P_LVALUE_78 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    ...
    PRT_VALUE** P_LVALUE_79 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_79);
    *P_LVALUE_79 = (PrtMkTuple(&P_GEND_TYPE_T3StringTypeimachine_handle, &(PTMP_tmp2_5), &(PTMP_tmp3_5), &(PTMP_tmp4_5)));
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_87 = PrtCloneValue((&P_LIT_INT32_9));
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_2)))
    {
        ...
        *P_LVALUE_93 = ((_P_GEN_funargs[0] = &(PTMP_tmp5_5)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp5_5), PTMP_tmp5_5 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_9;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        *P_LVALUE_94 = PrtCloneValue(PrtCastValue(PTMP_tmp6_4, &P_GEND_TYPE_i));
        
        PRT_VALUE** P_LVALUE_95 = &(PTMP_tmp8_4);
        PrtFreeValue(*P_LVALUE_95);
        *P_LVALUE_95 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp7_4, (&P_LIT_INT32_9)));
        ...
        {
            PRT_VALUE** P_LVALUE_98 = &(PTMP_tmp10_4);
    ...
    *P_LVALUE_102 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_countCandidate0) > PrtPrimGetInt(P_VAR_countCandidate1));
    ...
    {
        PRT_VALUE** P_LVALUE_104 = &(PTMP_tmp13_2);
    ...
    *P_LVALUE_107 = PrtCloneValue(*P_VAR_requestingMachine_1);
    ...
    PRT_VALUE** P_LVALUE_108 = &(PTMP_tmp15_1);
    ...
    *P_LVALUE_110 = PrtCloneValue(P_VAR_winner);
    ...
    PRT_VALUE** P_LVALUE_111 = &(PTMP_tmp18);
    PrtFreeValue(*P_LVALUE_111);
    *P_LVALUE_111 = (PrtMkTuple(&P_GEND_TYPE_T2MKsecure_StringTypeVss, &(PTMP_tmp16), &(PTMP_tmp17)));
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_124 = PrtTupleGet(*P_VAR_payload_5, 1);
    ...
    PRT_VALUE** P_LVALUE_125 = &(PTMP_tmp10_5);
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_163 = PrtCloneValue((&P_LIT_INT32_22));
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_4)))
    {
        ...
        *P_LVALUE_167 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_168 = &(PTMP_tmp4_11);
        PrtFreeValue(*P_LVALUE_168);
        *P_LVALUE_168 = PrtCloneValue((&P_EVENT_TRUSTEDValidateCredential.value));
        
        PRT_VALUE** P_LVALUE_169 = &(PTMP_tmp5_10);
        PrtFreeValue(*P_LVALUE_169);
        *P_LVALUE_169 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
        ...
        *P_LVALUE_171 = PrtTupleGet(PTMP_tmp6_9, 0);
        
        PRT_VALUE** P_LVALUE_172 = &(PTMP_tmp8_7);
        PrtFreeValue(*P_LVALUE_172);
        *P_LVALUE_172 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_StringType, &(PTMP_tmp5_10), &(PTMP_tmp7_7)));
        ...
        switch (P_eventId_2) {
            case 4: {
                ...
                *P_LVALUE_174 = PrtTupleGet(PTMP_tmp9_7, 0);
                ...
                *P_LVALUE_176 = PrtTupleGet(PTMP_tmp11_4, 1);
                
                {
                    PRT_VALUE** P_LVALUE_177 = &(*(PrtMapGetLValue(P_VAR_result_1, PTMP_tmp10_6, PRT_TRUE, &P_GEND_TYPE_MKsecure_StringTypeVs)));
                    PrtFreeValue(*P_LVALUE_177);
                    *P_LVALUE_177 = PTMP_tmp12_4;
                    PTMP_tmp12_4 = NULL;
                }
        ...
        *P_LVALUE_178 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_3) + PrtPrimGetInt((&P_LIT_INT32_23)));
        
        {
            PRT_VALUE** P_LVALUE_179 = &(P_VAR_i_3);
            PrtFreeValue(*P_LVALUE_179);
            *P_LVALUE_179 = PTMP_tmp13_3;
            PTMP_tmp13_3 = NULL;
        }
...
PRT_VALUE* P_Anon_IMPL_20(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_187 = &(PTMP_tmp0_17);
    PrtFreeValue(*P_LVALUE_187);
    *P_LVALUE_187 = PrtTupleGet(*P_VAR_payload_14, 2);
    
    {
        PRT_VALUE** P_LVALUE_188 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_188);
        *P_LVALUE_188 = PTMP_tmp0_17;
        PTMP_tmp0_17 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_189 = &(PTMP_tmp1_16);
    PrtFreeValue(*P_LVALUE_189);
    *P_LVALUE_189 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    {
        PRT_VALUE** P_LVALUE_190 = &(P_VAR_secure_vote);
        PrtFreeValue(*P_LVALUE_190);
        *P_LVALUE_190 = PTMP_tmp1_16;
        PTMP_tmp1_16 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_191 = &(PTMP_tmp2_13);
    PrtFreeValue(*P_LVALUE_191);
    *P_LVALUE_191 = PrtTupleGet(*P_VAR_payload_14, 0);
    
    {
        PRT_VALUE** P_LVALUE_192 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_192);
        *P_LVALUE_192 = PTMP_tmp2_13;
        PTMP_tmp2_13 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_193 = &(PTMP_tmp3_12);
    PrtFreeValue(*P_LVALUE_193);
    *P_LVALUE_193 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_194 = &(PTMP_tmp4_12);
    PrtFreeValue(*P_LVALUE_194);
    *P_LVALUE_194 = PrtCloneValue((&P_EVENT_TRUSTEDeVote.value));
    
    PRT_VALUE** P_LVALUE_195 = &(PTMP_tmp5_11);
    PrtFreeValue(*P_LVALUE_195);
    *P_LVALUE_195 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_196 = &(PTMP_tmp6_10);
    PrtFreeValue(*P_LVALUE_196);
    *P_LVALUE_196 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    PRT_VALUE** P_LVALUE_197 = &(PTMP_tmp7_8);
    PrtFreeValue(*P_LVALUE_197);
    *P_LVALUE_197 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    
    PRT_VALUE** P_LVALUE_198 = &(PTMP_tmp8_8);
    PrtFreeValue(*P_LVALUE_198);
    *P_LVALUE_198 = (PrtMkTuple(&P_GEND_TYPE_T3secure_StringTypeisecure_machine_handle, &(PTMP_tmp5_11), &(PTMP_tmp6_10), &(PTMP_tmp7_8)));
...
PRT_VALUE* P_Anon_IMPL_23(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_202 = &(PTMP_tmp0_19);
    PrtFreeValue(*P_LVALUE_202);
    *P_LVALUE_202 = PrtTupleGet(*P_VAR_payload_15, 0);
    
    PRT_VALUE** P_LVALUE_203 = &(PTMP_tmp1_18);
    PrtFreeValue(*P_LVALUE_203);
    *P_LVALUE_203 = PrtMkBoolValue(PrtMapExists(PTMP_tmp0_19, p_this->varValues[0]));;
    
    PRT_VALUE** P_LVALUE_204 = &(PTMP_tmp2_15);
    PrtFreeValue(*P_LVALUE_204);
    *P_LVALUE_204 = PrtMkBoolValue(!PrtPrimGetBool(PTMP_tmp1_18));
    
    PRT_VALUE** P_LVALUE_205 = &(PTMP_tmp3_13);
    PrtFreeValue(*P_LVALUE_205);
    *P_LVALUE_205 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_15)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_15), PTMP_tmp2_15 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_28;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_206 = PrtCloneValue(PrtCastValue(PTMP_tmp3_13, &P_GEND_TYPE_b));
    
    if (PrtPrimGetBool(PTMP_tmp4_13))
    {
        PrtPrintf("ERROR: Vote not found!");
        
        PRT_VALUE** P_LVALUE_207 = &(PTMP_tmp5_12);
        PrtFreeValue(*P_LVALUE_207);
        *P_LVALUE_207 = PrtCloneValue((&_P_EVENT_HALT_STRUCT.value));
    ...
    {
        PRT_VALUE** P_LVALUE_208 = &(P_VAR_voteCounted);
        PrtFreeValue(*P_LVALUE_208);
        *P_LVALUE_208 = PrtCloneValue((&P_LIT_BOOLEAN_5));
        
    }
    
    
    PRT_VALUE** P_LVALUE_209 = &(PTMP_tmp6_11);
    PrtFreeValue(*P_LVALUE_209);
    *P_LVALUE_209 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_210 = &(PTMP_tmp7_9);
    PrtFreeValue(*P_LVALUE_210);
    *P_LVALUE_210 = PrtCloneValue((&P_EVENT_UNTRUSTEDGetResults.value));
    
    PRT_VALUE** P_LVALUE_211 = &(PTMP_tmp8_9);
    PrtFreeValue(*P_LVALUE_211);
    *P_LVALUE_211 = PrtTupleGet(*P_VAR_payload_15, 1);
    
    PRT_VALUE** P_LVALUE_212 = &(PTMP_tmp9_8);
    PrtFreeValue(*P_LVALUE_212);
    *P_LVALUE_212 = ((_P_GEN_funargs[0] = &(PTMP_tmp8_9)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8_9), PTMP_tmp8_9 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_28;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_213 = &(PTMP_tmp10_7);
    PrtFreeValue(*P_LVALUE_213);
    *P_LVALUE_213 = PrtCloneValue(PrtCastValue(PTMP_tmp9_8, &P_GEND_TYPE_i));
    
    PRT_VALUE** P_LVALUE_214 = &(PTMP_tmp11_5);
    PrtFreeValue(*P_LVALUE_214);
    *P_LVALUE_214 = PrtCloneValue(P_VAR_voteCounted);
    
    PRT_VALUE** P_LVALUE_215 = &(PTMP_tmp12_5);
    PrtFreeValue(*P_LVALUE_215);
    *P_LVALUE_215 = (PrtMkTuple(&P_GEND_TYPE_T2ib, &(PTMP_tmp10_7), &(PTMP_tmp11_5)));
