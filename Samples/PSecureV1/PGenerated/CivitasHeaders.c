...
static PRT_TYPE* P_NMDTUP_T[] = { &P_GEND_TYPE_i, &P_GEND_TYPE_i, &P_GEND_TYPE_machine_handle };
static PRT_NMDTUPTYPE P_NMDTUP = { 3U, P_NMDTUP_N, P_NMDTUP_T };
static PRT_TYPE P_GEND_TYPE_T3iimachine_handle = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP } };
...
static PRT_TYPE* P_NMDTUP_T_2[] = { &P_GEND_TYPE_i, &P_GEND_TYPE_s, &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_2 = { 4U, P_NMDTUP_N_2, P_NMDTUP_T_2 };
static PRT_TYPE P_GEND_TYPE_T4ismachine_handlecapability = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_2 } };
static PRT_STRING P_NMDTUP_N_3[] = { "credential", "vote" };
static PRT_TYPE* P_NMDTUP_T_3[] = { &P_GEND_TYPE_i, &P_GEND_TYPE_s };
static PRT_NMDTUPTYPE P_NMDTUP_3 = { 2U, P_NMDTUP_N_3, P_NMDTUP_T_3 };
static PRT_TYPE P_GEND_TYPE_T2is = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_3 } };
...
static PRT_TYPE* P_NMDTUP_T_4[] = { &P_GEND_TYPE_i, &P_GEND_TYPE_ST2is };
static PRT_NMDTUPTYPE P_NMDTUP_4 = { 2U, P_NMDTUP_N_4, P_NMDTUP_T_4 };
static PRT_TYPE P_GEND_TYPE_T2iST2is = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_4 } };
static PRT_STRING P_NMDTUP_N_5[] = { "tabulationTellerMachine", "tabulationTellerCapability", "credentialToCheck" };
static PRT_TYPE* P_NMDTUP_T_5[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability, &P_GEND_TYPE_i };
static PRT_NMDTUPTYPE P_NMDTUP_5 = { 3U, P_NMDTUP_N_5, P_NMDTUP_T_5 };
static PRT_TYPE P_GEND_TYPE_T3machine_handlecapabilityi = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_5 } };
static PRT_MAPTYPE P_MAPTYPE = { &P_GEND_TYPE_i, &P_GEND_TYPE_s };
static PRT_TYPE P_GEND_TYPE_MKiVs = { PRT_KIND_MAP, { .map = &P_MAPTYPE } };
static PRT_STRING P_NMDTUP_N_6[] = { "allVotes", "whoWon" };
static PRT_TYPE* P_NMDTUP_T_6[] = { &P_GEND_TYPE_MKiVs, &P_GEND_TYPE_s };
static PRT_NMDTUPTYPE P_NMDTUP_6 = { 2U, P_NMDTUP_N_6, P_NMDTUP_T_6 };
static PRT_TYPE P_GEND_TYPE_T2MKiVss = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_6 } };
static PRT_STRING P_NMDTUP_N_7[] = { "requestingMachine", "requestingMachineCapability" };
static PRT_TYPE* P_NMDTUP_T_7[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_7 = { 2U, P_NMDTUP_N_7, P_NMDTUP_T_7 };
static PRT_TYPE P_GEND_TYPE_T2machine_handlecapability = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_7 } };
static PRT_STRING P_NMDTUP_N_8[] = { "supervisor", "credential" };
static PRT_TYPE* P_NMDTUP_T_8[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_i };
static PRT_NMDTUPTYPE P_NMDTUP_8 = { 2U, P_NMDTUP_N_8, P_NMDTUP_T_8 };
static PRT_TYPE P_GEND_TYPE_T2machine_handlei = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_8 } };
static PRT_STRING P_NMDTUP_N_9[] = { "bBoard", "bBoardCapability", "supervisor", "supervisorCapability" };
static PRT_TYPE* P_NMDTUP_T_9[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability, &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_9 = { 4U, P_NMDTUP_N_9, P_NMDTUP_T_9 };
static PRT_TYPE P_GEND_TYPE_T4machine_handlecapabilitymachine_handlecapability = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_9 } };
static PRT_STRING P_NMDTUP_N_10[] = { "parentMachine", "parentCapability" };
static PRT_TYPE* P_NMDTUP_T_10[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_10 = { 2U, P_NMDTUP_N_10, P_NMDTUP_T_10 };
static PRT_TYPE P_GEND_TYPE_T2machine_handlecapability_1 = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_10 } };
static PRT_STRING P_NMDTUP_N_11[] = { "ballotBox", "bulletinBoard", "ballotBoxCapability", "bulletinBoardCapability" };
static PRT_TYPE* P_NMDTUP_T_11[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_11 = { 4U, P_NMDTUP_N_11, P_NMDTUP_T_11 };
static PRT_TYPE P_GEND_TYPE_T4machine_handlemachine_handlecapabilitycapability = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_11 } };
static PRT_SEQTYPE P_SEQTYPE_1 = { &P_GEND_TYPE_i };
static PRT_TYPE P_GEND_TYPE_Si = { PRT_KIND_SEQ, { .seq = &P_SEQTYPE_1 } };
static PRT_STRING P_NMDTUP_N_12[] = { "credential", "vote", "requestingMachine", "requestingMachineCapability" };
static PRT_TYPE* P_NMDTUP_T_12[] = { &P_GEND_TYPE_i, &P_GEND_TYPE_i, &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_12 = { 4U, P_NMDTUP_N_12, P_NMDTUP_T_12 };
static PRT_TYPE P_GEND_TYPE_T4iimachine_handlecapability = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_12 } };
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_73 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp5_4);
    PrtFreeValue(*P_LVALUE_74);
    *P_LVALUE_74 = (PrtMkTuple(&P_GEND_TYPE_T3iimachine_handle, &(PTMP_tmp2_5), &(PTMP_tmp3_5), &(PTMP_tmp4_5)));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_75 = PrtTupleGet(*P_VAR_payload_3, 1);
    ...
    *P_LVALUE_76 = PrtTupleGet(*P_VAR_payload_3, 0);
    
    PrtFormatPrintf("", 1, PTMP_tmp1_6, 1, 0, " won the election\n");
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_77 = &(p_this->varValues[0]);
    PrtFreeValue(*P_LVALUE_77);
    *P_LVALUE_77 = PrtCloneValue(*P_VAR_payload_4);
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_78 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_78);
    *P_LVALUE_78 = PrtTupleGet(*P_VAR_payload_5, 1);
    ...
    PRT_VALUE** P_LVALUE_79 = &(PTMP_tmp1_7);
    PrtFreeValue(*P_LVALUE_79);
    *P_LVALUE_79 = PrtMapGetKeys(p_this->varValues[0]);
    
    {
        PRT_VALUE** P_LVALUE_80 = &(P_VAR_electionResultsKeys);
        PrtFreeValue(*P_LVALUE_80);
        *P_LVALUE_80 = PTMP_tmp1_7;
        PTMP_tmp1_7 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_81 = &(P_VAR_i_2);
    PrtFreeValue(*P_LVALUE_81);
    *P_LVALUE_81 = PrtCloneValue((&P_LIT_INT32_12));
    
    PRT_VALUE** P_LVALUE_82 = &(P_VAR_countCandidate0);
    PrtFreeValue(*P_LVALUE_82);
    *P_LVALUE_82 = PrtCloneValue((&P_LIT_INT32_12));
    
    PRT_VALUE** P_LVALUE_83 = &(P_VAR_countCandidate1);
    PrtFreeValue(*P_LVALUE_83);
    *P_LVALUE_83 = PrtCloneValue((&P_LIT_INT32_12));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_2)))
    {
        PRT_VALUE** P_LVALUE_84 = &(PTMP_tmp2_6);
        PrtFreeValue(*P_LVALUE_84);
        *P_LVALUE_84 = PrtMkIntValue(PrtSeqSizeOf(P_VAR_electionResultsKeys));
        
        PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp3_6);
        PrtFreeValue(*P_LVALUE_85);
        *P_LVALUE_85 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_2) < PrtPrimGetInt(PTMP_tmp2_6));
        
        PRT_VALUE** P_LVALUE_86 = &(PTMP_tmp4_6);
        PrtFreeValue(*P_LVALUE_86);
        *P_LVALUE_86 = PrtCloneValue(PTMP_tmp3_6);
        ...
        PRT_VALUE** P_LVALUE_87 = &(PTMP_tmp5_5);
        PrtFreeValue(*P_LVALUE_87);
        *P_LVALUE_87 = PrtSeqGet(P_VAR_electionResultsKeys, P_VAR_i_2);
        
        PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp6_4);
        PrtFreeValue(*P_LVALUE_88);
        *P_LVALUE_88 = PrtMapGet(p_this->varValues[0], PTMP_tmp5_5);
        
        PRT_VALUE** P_LVALUE_89 = &(PTMP_tmp7_4);
        PrtFreeValue(*P_LVALUE_89);
        *P_LVALUE_89 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp6_4, (&P_LIT_INT32_12)));
        
        if (PrtPrimGetBool(PTMP_tmp7_4))
        {
            PRT_VALUE** P_LVALUE_90 = &(PTMP_tmp8_4);
            PrtFreeValue(*P_LVALUE_90);
            *P_LVALUE_90 = PrtMkIntValue(PrtPrimGetInt(P_VAR_countCandidate0) + PrtPrimGetInt((&P_LIT_INT32_13)));
            
            {
                PRT_VALUE** P_LVALUE_91 = &(P_VAR_countCandidate0);
                PrtFreeValue(*P_LVALUE_91);
                *P_LVALUE_91 = PTMP_tmp8_4;
                PTMP_tmp8_4 = NULL;
            }
        ...
        {
            PRT_VALUE** P_LVALUE_92 = &(PTMP_tmp9_3);
            PrtFreeValue(*P_LVALUE_92);
            *P_LVALUE_92 = PrtMkIntValue(PrtPrimGetInt(P_VAR_countCandidate1) + PrtPrimGetInt((&P_LIT_INT32_13)));
            
            {
                PRT_VALUE** P_LVALUE_93 = &(P_VAR_countCandidate1);
                PrtFreeValue(*P_LVALUE_93);
                *P_LVALUE_93 = PTMP_tmp9_3;
                PTMP_tmp9_3 = NULL;
            }
        ...
        PRT_VALUE** P_LVALUE_94 = &(PTMP_tmp10_3);
        PrtFreeValue(*P_LVALUE_94);
        *P_LVALUE_94 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_2) + PrtPrimGetInt((&P_LIT_INT32_13)));
        
        {
            PRT_VALUE** P_LVALUE_95 = &(P_VAR_i_2);
            PrtFreeValue(*P_LVALUE_95);
            *P_LVALUE_95 = PTMP_tmp10_3;
            PTMP_tmp10_3 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp11_2);
    PrtFreeValue(*P_LVALUE_96);
    *P_LVALUE_96 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_countCandidate0) > PrtPrimGetInt(P_VAR_countCandidate1));
    
    if (PrtPrimGetBool(PTMP_tmp11_2))
    {
        PRT_VALUE** P_LVALUE_97 = &(P_VAR_winner);
        PrtFreeValue(*P_LVALUE_97);
        *P_LVALUE_97 = PrtCloneValue((&P_LIT_INT32_12));
        
    }
    
    else
    {
        PRT_VALUE** P_LVALUE_98 = &(PTMP_tmp12_2);
        PrtFreeValue(*P_LVALUE_98);
        *P_LVALUE_98 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_countCandidate1) > PrtPrimGetInt(P_VAR_countCandidate0));
        
        if (PrtPrimGetBool(PTMP_tmp12_2))
        {
            PRT_VALUE** P_LVALUE_99 = &(P_VAR_winner);
            PrtFreeValue(*P_LVALUE_99);
            *P_LVALUE_99 = PrtCloneValue((&P_LIT_INT32_13));
            
        }
        
        else
        {
            PRT_VALUE** P_LVALUE_100 = &(P_VAR_winner);
    ...
    PRT_VALUE** P_LVALUE_101 = &(PTMP_tmp13_2);
    PrtFreeValue(*P_LVALUE_101);
    *P_LVALUE_101 = PrtTupleGet(*P_VAR_payload_5, 0);
    
    PRT_VALUE** P_LVALUE_102 = &(PTMP_tmp14_1);
    PrtFreeValue(*P_LVALUE_102);
    *P_LVALUE_102 = PrtCloneValue(PTMP_tmp13_2);
    
    PRT_VALUE** P_LVALUE_103 = &(PTMP_tmp15_1);
    PrtFreeValue(*P_LVALUE_103);
    *P_LVALUE_103 = PrtCloneValue((&P_EVENT_TRUSTEDeRespElectionResults.value));
    
    PRT_VALUE** P_LVALUE_104 = &(PTMP_tmp16);
    PrtFreeValue(*P_LVALUE_104);
    *P_LVALUE_104 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_105 = &(PTMP_tmp17);
    PrtFreeValue(*P_LVALUE_105);
    *P_LVALUE_105 = PrtCloneValue(P_VAR_winner);
    
    PRT_VALUE** P_LVALUE_106 = &(PTMP_tmp18);
    PrtFreeValue(*P_LVALUE_106);
    *P_LVALUE_106 = (PrtMkTuple(&P_GEND_TYPE_T2MKiVss, &(PTMP_tmp16), &(PTMP_tmp17)));
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_107 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_107);
    *P_LVALUE_107 = PrtTupleGet(*P_VAR_payload_6, 0);
    
    {
        PRT_VALUE** P_LVALUE_108 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_108);
        *P_LVALUE_108 = PTMP_tmp0_8;
        PTMP_tmp0_8 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_109 = &(PTMP_tmp1_8);
    PrtFreeValue(*P_LVALUE_109);
    *P_LVALUE_109 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_110 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_111 = &(PTMP_tmp3_7);
    PrtFreeValue(*P_LVALUE_111);
    *P_LVALUE_111 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_7)), (_P_GEN_funval = P_GetCapability_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_7), PTMP_tmp2_7 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_112 = &(PTMP_tmp4_7);
    PrtFreeValue(*P_LVALUE_112);
    *P_LVALUE_112 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlecapability_1, &(PTMP_tmp1_8), &(PTMP_tmp3_7)));
    
    _P_GEN_funargs[0] = "SecureTamperEvidentLogMachine";
    _P_GEN_funargs[1] = "1";
    _P_GEN_funargs[2] = &(PTMP_tmp4_7);
    PRT_VALUE** P_LVALUE_113 = &(PTMP_tmp5_6);
    PrtFreeValue(*P_LVALUE_113);
    *P_LVALUE_113 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_114 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_114);
        *P_LVALUE_114 = PTMP_tmp5_6;
        PTMP_tmp5_6 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_115 = &(PTMP_tmp6_5);
    PrtFreeValue(*P_LVALUE_115);
    *P_LVALUE_115 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_116 = &(PTMP_tmp7_5);
    PrtFreeValue(*P_LVALUE_116);
    *P_LVALUE_116 = PrtTupleGet(*P_VAR_payload_6, 1);
    
    PRT_VALUE** P_LVALUE_117 = &(PTMP_tmp8_5);
    PrtFreeValue(*P_LVALUE_117);
    *P_LVALUE_117 = PrtTupleGet(*P_VAR_payload_6, 2);
    
    PRT_VALUE** P_LVALUE_118 = &(PTMP_tmp9_4);
    PrtFreeValue(*P_LVALUE_118);
    *P_LVALUE_118 = PrtTupleGet(*P_VAR_payload_6, 3);
    
    PRT_VALUE** P_LVALUE_119 = &(PTMP_tmp10_4);
    PrtFreeValue(*P_LVALUE_119);
    *P_LVALUE_119 = (PrtMkTuple(&P_GEND_TYPE_T4machine_handlecapabilitymachine_handlecapability, &(PTMP_tmp6_5), &(PTMP_tmp7_5), &(PTMP_tmp8_5), &(PTMP_tmp9_4)));
    
    _P_GEN_funargs[0] = "SecureTabulationTellerMachine";
    _P_GEN_funargs[1] = "1";
    _P_GEN_funargs[2] = &(PTMP_tmp10_4);
    PRT_VALUE** P_LVALUE_120 = &(PTMP_tmp11_3);
    PrtFreeValue(*P_LVALUE_120);
    *P_LVALUE_120 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_121 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_121);
        *P_LVALUE_121 = PTMP_tmp11_3;
        PTMP_tmp11_3 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_122 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_122);
    *P_LVALUE_122 = PrtCloneValue(*P_VAR_payload_7);
    
    PRT_VALUE** P_LVALUE_123 = &(p_this->varValues[4]);
    PrtFreeValue(*P_LVALUE_123);
    *P_LVALUE_123 = PrtCloneValue((&P_LIT_INT32_15));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_124 = &(PTMP_tmp0_9);
    PrtFreeValue(*P_LVALUE_124);
    *P_LVALUE_124 = PrtTupleGet(*P_VAR_payload_8, 3);
    ...
    *P_LVALUE_125 = PrtCloneValue(p_this->varValues[2]);
    ...
    PRT_VALUE** P_LVALUE_126 = &(PTMP_tmp2_8);
    PrtFreeValue(*P_LVALUE_126);
    *P_LVALUE_126 = PrtCloneValue((&P_EVENT_TRUSTEDeAddItem.value));
    
    PRT_VALUE** P_LVALUE_127 = &(PTMP_tmp3_8);
    PrtFreeValue(*P_LVALUE_127);
    *P_LVALUE_127 = PrtTupleGet(*P_VAR_payload_8, 0);
    
    PRT_VALUE** P_LVALUE_128 = &(PTMP_tmp4_8);
    PrtFreeValue(*P_LVALUE_128);
    *P_LVALUE_128 = PrtTupleGet(*P_VAR_payload_8, 1);
    
    PRT_VALUE** P_LVALUE_129 = &(PTMP_tmp5_7);
    PrtFreeValue(*P_LVALUE_129);
    *P_LVALUE_129 = (PrtMkTuple(&P_GEND_TYPE_T2is, &(PTMP_tmp3_8), &(PTMP_tmp4_8)));
    ...
    switch (P_eventId) {
        case 2: {
                        ...
                        if (PrtPrimGetBool(*P_VAR_result))
            {
                ...
                *P_LVALUE_130 = PrtTupleGet(*P_VAR_payload_8, 2);
                
                PRT_VALUE** P_LVALUE_131 = &(PTMP_tmp7_6);
                PrtFreeValue(*P_LVALUE_131);
                *P_LVALUE_131 = PrtCloneValue(PTMP_tmp6_6);
                
                PRT_VALUE** P_LVALUE_132 = &(PTMP_tmp8_6);
                PrtFreeValue(*P_LVALUE_132);
                *P_LVALUE_132 = PrtCloneValue((&P_EVENT_TRUSTEDeRespConfirmVote.value));
                ...
                PRT_VALUE** P_LVALUE_133 = &(PTMP_tmp9_5);
                PrtFreeValue(*P_LVALUE_133);
                *P_LVALUE_133 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[4]) + PrtPrimGetInt((&P_LIT_INT32_18)));
                
                {
                    PRT_VALUE** P_LVALUE_134 = &(p_this->varValues[4]);
                    PrtFreeValue(*P_LVALUE_134);
                    *P_LVALUE_134 = PTMP_tmp9_5;
                    PTMP_tmp9_5 = NULL;
                }
    ...
    PRT_VALUE** P_LVALUE_135 = &(PTMP_tmp10_5);
    PrtFreeValue(*P_LVALUE_135);
    *P_LVALUE_135 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[4]) >= PrtPrimGetInt(p_this->varValues[3]));
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_136 = &(PTMP_tmp0_10);
    PrtFreeValue(*P_LVALUE_136);
    *P_LVALUE_136 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_137 = &(PTMP_tmp1_10);
    PrtFreeValue(*P_LVALUE_137);
    *P_LVALUE_137 = PrtCloneValue((&P_EVENT_TRUSTEDeGetLog.value));
    ...
    switch (P_eventId_1) {
        case 3: {
            PRT_VALUE** P_VAR_payload_9 = &P_VAR_P_payload_1;
            ...
            PRT_VALUE** P_LVALUE_138 = &(PTMP_tmp2_9);
            PrtFreeValue(*P_LVALUE_138);
            *P_LVALUE_138 = PrtCloneValue(p_this->varValues[1]);
            
            PRT_VALUE** P_LVALUE_139 = &(PTMP_tmp3_9);
            PrtFreeValue(*P_LVALUE_139);
            *P_LVALUE_139 = PrtCloneValue((&P_EVENT_TRUSTEDeAllVotes.value));
            
            PRT_VALUE** P_LVALUE_140 = &(PTMP_tmp4_9);
            PrtFreeValue(*P_LVALUE_140);
            *P_LVALUE_140 = PrtCloneValue((&P_LIT_INT32_20));
            
            PRT_VALUE** P_LVALUE_141 = &(PTMP_tmp5_8);
            PrtFreeValue(*P_LVALUE_141);
            *P_LVALUE_141 = PrtCloneValue(*P_VAR_payload_9);
            
            PRT_VALUE** P_LVALUE_142 = &(PTMP_tmp6_7);
            PrtFreeValue(*P_LVALUE_142);
            *P_LVALUE_142 = (PrtMkTuple(&P_GEND_TYPE_T2iST2is, &(PTMP_tmp4_9), &(PTMP_tmp5_8)));
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_143 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_143);
    *P_LVALUE_143 = PrtTupleGet(*P_VAR_payload_10, 0);
    
    {
        PRT_VALUE** P_LVALUE_144 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_144);
        *P_LVALUE_144 = PTMP_tmp0_11;
        PTMP_tmp0_11 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_145 = &(PTMP_tmp1_11);
    PrtFreeValue(*P_LVALUE_145);
    *P_LVALUE_145 = PrtTupleGet(*P_VAR_payload_10, 1);
    
    _P_GEN_funargs[0] = &(PTMP_tmp1_11);
    PrtFreeValue(P_SaveCapability_IMPL(context, _P_GEN_funargs));
    PrtFreeValue(PTMP_tmp1_11);
    PTMP_tmp1_11 = NULL;
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_16;
    }
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_146 = &(PTMP_tmp0_12);
    PrtFreeValue(*P_LVALUE_146);
    *P_LVALUE_146 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[0]));
    
    PRT_VALUE** P_LVALUE_147 = &(PTMP_tmp1_12);
    PrtFreeValue(*P_LVALUE_147);
    *P_LVALUE_147 = PrtTupleGet(*P_VAR_payload_11, 0);
    
    PRT_VALUE** P_LVALUE_148 = &(PTMP_tmp2_10);
    PrtFreeValue(*P_LVALUE_148);
    *P_LVALUE_148 = PrtTupleGet(*P_VAR_payload_11, 1);
    
    PRT_VALUE** P_LVALUE_149 = &(PTMP_tmp3_10);
    PrtFreeValue(*P_LVALUE_149);
    *P_LVALUE_149 = (PrtMkTuple(&P_GEND_TYPE_T2is, &(PTMP_tmp1_12), &(PTMP_tmp2_10)));
    
    PrtSeqInsertEx(p_this->varValues[0], PTMP_tmp0_12, PTMP_tmp3_10, PRT_FALSE);
    *(&(PTMP_tmp3_10)) = NULL;
    
    PRT_VALUE** P_LVALUE_150 = &(PTMP_tmp4_10);
    PrtFreeValue(*P_LVALUE_150);
    *P_LVALUE_150 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_151 = &(PTMP_tmp5_9);
    PrtFreeValue(*P_LVALUE_151);
    *P_LVALUE_151 = PrtCloneValue((&P_EVENT_TRUSTEDeRespAddItem.value));
    
    PRT_VALUE** P_LVALUE_152 = &(PTMP_tmp6_8);
    PrtFreeValue(*P_LVALUE_152);
    *P_LVALUE_152 = PrtCloneValue((&P_LIT_BOOLEAN_3));
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_154 = PrtCloneValue((&P_EVENT_TRUSTEDeRespGetLog.value));
    
    PRT_VALUE** P_LVALUE_155 = &(PTMP_tmp2_11);
    PrtFreeValue(*P_LVALUE_155);
    *P_LVALUE_155 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE* P_PTMP_tmp_12 = PrtCloneValue(&(P_LIT_INT32_23));
    _P_GEN_funargs[0] = &(PTMP_tmp0_13);
    _P_GEN_funargs[1] = &(PTMP_tmp1_13);
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_156 = &(PTMP_tmp0_14);
    PrtFreeValue(*P_LVALUE_156);
    *P_LVALUE_156 = PrtTupleGet(*P_VAR_payload_12, 0);
    
    {
        PRT_VALUE** P_LVALUE_157 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_157);
        *P_LVALUE_157 = PTMP_tmp0_14;
        PTMP_tmp0_14 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_158 = &(PTMP_tmp1_14);
    PrtFreeValue(*P_LVALUE_158);
    *P_LVALUE_158 = PrtTupleGet(*P_VAR_payload_12, 2);
    
    {
        PRT_VALUE** P_LVALUE_159 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_159);
        *P_LVALUE_159 = PTMP_tmp1_14;
        PTMP_tmp1_14 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_160 = &(PTMP_tmp2_12);
    ...
    *P_LVALUE_160 = PrtTupleGet(*P_VAR_payload_12, 1);
    ...
    PRT_VALUE** P_LVALUE_161 = &(PTMP_tmp3_11);
    PrtFreeValue(*P_LVALUE_161);
    *P_LVALUE_161 = PrtTupleGet(*P_VAR_payload_12, 3);
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_162 = &(PTMP_tmp0_15);
    PrtFreeValue(*P_LVALUE_162);
    *P_LVALUE_162 = PrtTupleGet(*P_VAR_payload_13, 1);
    
    {
        PRT_VALUE** P_LVALUE_163 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_163);
        *P_LVALUE_163 = PTMP_tmp0_15;
        PTMP_tmp0_15 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_164 = &(P_VAR_i_3);
    PrtFreeValue(*P_LVALUE_164);
    *P_LVALUE_164 = PrtCloneValue((&P_LIT_INT32_24));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_4)))
    {
        PRT_VALUE** P_LVALUE_165 = &(PTMP_tmp0_16);
        PrtFreeValue(*P_LVALUE_165);
        *P_LVALUE_165 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[2]));
        
        PRT_VALUE** P_LVALUE_166 = &(PTMP_tmp1_15);
        PrtFreeValue(*P_LVALUE_166);
        *P_LVALUE_166 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_3) < PrtPrimGetInt(PTMP_tmp0_16));
        
        PRT_VALUE** P_LVALUE_167 = &(PTMP_tmp2_13);
        PrtFreeValue(*P_LVALUE_167);
        *P_LVALUE_167 = PrtCloneValue(PTMP_tmp1_15);
        ...
        PRT_VALUE** P_LVALUE_168 = &(PTMP_tmp3_12);
        PrtFreeValue(*P_LVALUE_168);
        *P_LVALUE_168 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_169 = &(PTMP_tmp4_11);
        PrtFreeValue(*P_LVALUE_169);
        *P_LVALUE_169 = PrtCloneValue((&P_EVENT_TRUSTEDValidateCredential.value));
        
        PRT_VALUE** P_LVALUE_170 = &(PTMP_tmp5_10);
        PrtFreeValue(*P_LVALUE_170);
        *P_LVALUE_170 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_21;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_171 = &(PTMP_tmp6_9);
        PrtFreeValue(*P_LVALUE_171);
        *P_LVALUE_171 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_21;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_172 = &(PTMP_tmp7_7);
        PrtFreeValue(*P_LVALUE_172);
        *P_LVALUE_172 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_9)), (_P_GEN_funval = P_GetCapability_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_9), PTMP_tmp6_9 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_21;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_173 = &(PTMP_tmp8_7);
        PrtFreeValue(*P_LVALUE_173);
        *P_LVALUE_173 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
        
        PRT_VALUE** P_LVALUE_174 = &(PTMP_tmp9_6);
        PrtFreeValue(*P_LVALUE_174);
        *P_LVALUE_174 = PrtTupleGet(PTMP_tmp8_7, 0);
        
        PRT_VALUE** P_LVALUE_175 = &(PTMP_tmp10_6);
        PrtFreeValue(*P_LVALUE_175);
        *P_LVALUE_175 = (PrtMkTuple(&P_GEND_TYPE_T3machine_handlecapabilityi, &(PTMP_tmp5_10), &(PTMP_tmp7_7), &(PTMP_tmp9_6)));
        ...
        switch (P_eventId_2) {
            case 4: {
                                PRT_VALUE** P_LVALUE_176 = &(PTMP_tmp11_4);
                PrtFreeValue(*P_LVALUE_176);
                *P_LVALUE_176 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
                
                PRT_VALUE** P_LVALUE_177 = &(PTMP_tmp12_3);
                PrtFreeValue(*P_LVALUE_177);
                *P_LVALUE_177 = PrtTupleGet(PTMP_tmp11_4, 0);
                
                PRT_VALUE** P_LVALUE_178 = &(PTMP_tmp13_3);
                PrtFreeValue(*P_LVALUE_178);
                *P_LVALUE_178 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
                
                PRT_VALUE** P_LVALUE_179 = &(PTMP_tmp14_2);
                PrtFreeValue(*P_LVALUE_179);
                *P_LVALUE_179 = PrtTupleGet(PTMP_tmp13_3, 1);
                
                {
                    PRT_VALUE** P_LVALUE_180 = &(*(PrtMapGetLValue(P_VAR_result_1, PTMP_tmp12_3, PRT_TRUE, &P_GEND_TYPE_MKiVs)));
                    PrtFreeValue(*P_LVALUE_180);
                    *P_LVALUE_180 = PTMP_tmp14_2;
                    PTMP_tmp14_2 = NULL;
                }
        ...
        PRT_VALUE** P_LVALUE_181 = &(PTMP_tmp15_2);
        PrtFreeValue(*P_LVALUE_181);
        *P_LVALUE_181 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_3) + PrtPrimGetInt((&P_LIT_INT32_25)));
        
        {
            PRT_VALUE** P_LVALUE_182 = &(P_VAR_i_3);
            PrtFreeValue(*P_LVALUE_182);
            *P_LVALUE_182 = PTMP_tmp15_2;
            PTMP_tmp15_2 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_183 = &(PTMP_tmp16_1);
    PrtFreeValue(*P_LVALUE_183);
    *P_LVALUE_183 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_184 = &(PTMP_tmp17_1);
    PrtFreeValue(*P_LVALUE_184);
    *P_LVALUE_184 = PrtCloneValue((&P_EVENT_TRUSTEDeElectionResults.value));
    
    PRT_VALUE** P_LVALUE_185 = &(PTMP_tmp18_1);
    PrtFreeValue(*P_LVALUE_185);
    *P_LVALUE_185 = PrtCloneValue(P_VAR_result_1);
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_186 = &(PTMP_tmp0_17);
    PrtFreeValue(*P_LVALUE_186);
    *P_LVALUE_186 = PrtTupleGet(*P_VAR_payload_14, 0);
    
    {
        PRT_VALUE** P_LVALUE_187 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_187);
        *P_LVALUE_187 = PTMP_tmp0_17;
        PTMP_tmp0_17 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_188 = &(PTMP_tmp1_16);
    PrtFreeValue(*P_LVALUE_188);
    *P_LVALUE_188 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    {
        PRT_VALUE** P_LVALUE_189 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_189);
        *P_LVALUE_189 = PTMP_tmp1_16;
        PTMP_tmp1_16 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_190 = &(PTMP_tmp2_14);
    PrtFreeValue(*P_LVALUE_190);
    *P_LVALUE_190 = PrtTupleGet(*P_VAR_payload_14, 2);
    ...
    PRT_VALUE** P_LVALUE_191 = &(PTMP_tmp3_13);
    PrtFreeValue(*P_LVALUE_191);
    *P_LVALUE_191 = PrtTupleGet(*P_VAR_payload_14, 3);
...
PRT_VALUE* P_Anon_IMPL_20(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_192 = &(PTMP_tmp0_18);
    PrtFreeValue(*P_LVALUE_192);
    *P_LVALUE_192 = PrtTupleGet(*P_VAR_payload_15, 2);
    
    {
        PRT_VALUE** P_LVALUE_193 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_193);
        *P_LVALUE_193 = PTMP_tmp0_18;
        PTMP_tmp0_18 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_194 = &(PTMP_tmp1_17);
    PrtFreeValue(*P_LVALUE_194);
    *P_LVALUE_194 = PrtTupleGet(*P_VAR_payload_15, 1);
    
    {
        PRT_VALUE** P_LVALUE_195 = &(P_VAR_secure_vote);
        PrtFreeValue(*P_LVALUE_195);
        *P_LVALUE_195 = PTMP_tmp1_17;
        PTMP_tmp1_17 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_196 = &(PTMP_tmp2_15);
    PrtFreeValue(*P_LVALUE_196);
    *P_LVALUE_196 = PrtTupleGet(*P_VAR_payload_15, 0);
    
    {
        PRT_VALUE** P_LVALUE_197 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_197);
        *P_LVALUE_197 = PTMP_tmp2_15;
        PTMP_tmp2_15 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_198 = &(PTMP_tmp3_14);
    PrtFreeValue(*P_LVALUE_198);
    *P_LVALUE_198 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_199 = &(PTMP_tmp4_12);
    PrtFreeValue(*P_LVALUE_199);
    *P_LVALUE_199 = PrtCloneValue((&P_EVENT_TRUSTEDeVote.value));
    
    PRT_VALUE** P_LVALUE_200 = &(PTMP_tmp5_11);
    PrtFreeValue(*P_LVALUE_200);
    *P_LVALUE_200 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_201 = &(PTMP_tmp6_10);
    PrtFreeValue(*P_LVALUE_201);
    *P_LVALUE_201 = PrtTupleGet(*P_VAR_payload_15, 1);
    
    PRT_VALUE** P_LVALUE_202 = &(PTMP_tmp7_8);
    PrtFreeValue(*P_LVALUE_202);
    *P_LVALUE_202 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_25;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_203 = &(PTMP_tmp8_8);
    PrtFreeValue(*P_LVALUE_203);
    *P_LVALUE_203 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_25;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_204 = &(PTMP_tmp9_7);
    PrtFreeValue(*P_LVALUE_204);
    *P_LVALUE_204 = ((_P_GEN_funargs[0] = &(PTMP_tmp8_8)), (_P_GEN_funval = P_GetCapability_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8_8), PTMP_tmp8_8 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_25;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_205 = &(PTMP_tmp10_7);
    PrtFreeValue(*P_LVALUE_205);
    *P_LVALUE_205 = (PrtMkTuple(&P_GEND_TYPE_T4iimachine_handlecapability, &(PTMP_tmp5_11), &(PTMP_tmp6_10), &(PTMP_tmp7_8), &(PTMP_tmp9_7)));
...
PRT_VALUE* P_Anon_IMPL_22(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_206 = &(PTMP_tmp0_19);
    PrtFreeValue(*P_LVALUE_206);
    *P_LVALUE_206 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_207 = &(PTMP_tmp1_18);
    PrtFreeValue(*P_LVALUE_207);
    *P_LVALUE_207 = PrtCloneValue((&P_EVENT_TRUSTEDeGetElectionResults.value));
    
    PRT_VALUE** P_LVALUE_208 = &(PTMP_tmp2_16);
    PrtFreeValue(*P_LVALUE_208);
    *P_LVALUE_208 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_27;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_209 = &(PTMP_tmp3_15);
    PrtFreeValue(*P_LVALUE_209);
    *P_LVALUE_209 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_27;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_210 = &(PTMP_tmp4_13);
    PrtFreeValue(*P_LVALUE_210);
    *P_LVALUE_210 = ((_P_GEN_funargs[0] = &(PTMP_tmp3_15)), (_P_GEN_funval = P_GetCapability_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp3_15), PTMP_tmp3_15 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_27;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_211 = &(PTMP_tmp5_12);
    PrtFreeValue(*P_LVALUE_211);
    *P_LVALUE_211 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlecapability, &(PTMP_tmp2_16), &(PTMP_tmp4_13)));
...
PRT_VALUE* P_Anon_IMPL_23(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_212 = &(PTMP_tmp0_20);
    PrtFreeValue(*P_LVALUE_212);
    *P_LVALUE_212 = PrtTupleGet(*P_VAR_payload_16, 0);
    
    PRT_VALUE** P_LVALUE_213 = &(PTMP_tmp1_19);
    PrtFreeValue(*P_LVALUE_213);
    *P_LVALUE_213 = PrtMkBoolValue(PrtMapExists(PTMP_tmp0_20, p_this->varValues[0]));;
    
    PRT_VALUE** P_LVALUE_214 = &(PTMP_tmp2_17);
    PrtFreeValue(*P_LVALUE_214);
    *P_LVALUE_214 = PrtMkBoolValue(!PrtPrimGetBool(PTMP_tmp1_19));
    
    if (PrtPrimGetBool(PTMP_tmp2_17))
    {
        PrtPrintf("ERROR: Vote not found!");
        
        PRT_VALUE** P_LVALUE_215 = &(PTMP_tmp3_16);
        PrtFreeValue(*P_LVALUE_215);
        *P_LVALUE_215 = PrtCloneValue((&_P_EVENT_HALT_STRUCT.value));
    ...
    {
        PRT_VALUE** P_LVALUE_216 = &(P_VAR_voteCounted);
        PrtFreeValue(*P_LVALUE_216);
        *P_LVALUE_216 = PrtCloneValue((&P_LIT_BOOLEAN_5));
        
    }
    
    
    PRT_VALUE** P_LVALUE_217 = &(PTMP_tmp4_14);
    PrtFreeValue(*P_LVALUE_217);
    *P_LVALUE_217 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_218 = &(PTMP_tmp5_13);
    PrtFreeValue(*P_LVALUE_218);
    *P_LVALUE_218 = PrtCloneValue((&P_EVENT_UNTRUSTEDGetResults.value));
    
    PRT_VALUE** P_LVALUE_219 = &(PTMP_tmp6_11);
    PrtFreeValue(*P_LVALUE_219);
    *P_LVALUE_219 = PrtTupleGet(*P_VAR_payload_16, 1);
    
    PRT_VALUE** P_LVALUE_220 = &(PTMP_tmp7_9);
    PrtFreeValue(*P_LVALUE_220);
    *P_LVALUE_220 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_11)), (_P_GEN_funval = P_DeclassifyInt_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_11), PTMP_tmp6_11 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_28;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_221 = &(PTMP_tmp8_9);
    PrtFreeValue(*P_LVALUE_221);
    *P_LVALUE_221 = PrtCloneValue(P_VAR_voteCounted);
    
    PRT_VALUE** P_LVALUE_222 = &(PTMP_tmp9_8);
    PrtFreeValue(*P_LVALUE_222);
    *P_LVALUE_222 = (PrtMkTuple(&P_GEND_TYPE_T2ib, &(PTMP_tmp7_9), &(PTMP_tmp8_9)));
    
    PRT_VALUE* P_PTMP_tmp_17 = PrtCloneValue(&(P_LIT_INT32_28));
    _P_GEN_funargs[0] = &(PTMP_tmp4_14);
    _P_GEN_funargs[1] = &(PTMP_tmp5_13);
    _P_GEN_funargs[2] = &(P_PTMP_tmp_17);
    _P_GEN_funargs[3] = &(PTMP_tmp9_8);
    PrtFreeValue(P_UntrustedSend_IMPL(context, _P_GEN_funargs));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_28;
    }
