...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_81 = PrtCloneValue(*P_VAR_payload_4);
    ...
    PRT_VALUE** P_LVALUE_82 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_82);
    *P_LVALUE_82 = PrtCloneValue((&P_EVENT_TRUSTEDeRespElectionResults.value));
    
    PRT_VALUE** P_LVALUE_83 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_83);
    *P_LVALUE_83 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_84 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_84);
    *P_LVALUE_84 = PrtCloneValue((&P_LIT_INT32_9));
    
    PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp4_5);
    PrtFreeValue(*P_LVALUE_85);
    *P_LVALUE_85 = (PrtMkTuple(&P_GEND_TYPE_T2MKiVii, &(PTMP_tmp2_5), &(PTMP_tmp3_5)));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_86 = PrtCloneValue(*P_VAR_bBoard);
    
    PRT_VALUE** P_LVALUE_87 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_87);
    *P_LVALUE_87 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_88);
    *P_LVALUE_88 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_91 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_7;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_93 = PrtCloneValue(*P_VAR_payload_5);
    
    PRT_VALUE** P_LVALUE_94 = &(p_this->varValues[4]);
    PrtFreeValue(*P_LVALUE_94);
    *P_LVALUE_94 = PrtCloneValue((&P_LIT_INT32_11));
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_95 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp1_7);
    PrtFreeValue(*P_LVALUE_96);
    *P_LVALUE_96 = PrtCloneValue((&P_EVENT_TRUSTEDeAddItem.value));
    
    PRT_VALUE** P_LVALUE_97 = &(PTMP_tmp2_7);
    PrtFreeValue(*P_LVALUE_97);
    *P_LVALUE_97 = PrtTupleGet(*P_VAR_payload_6, 0);
    
    PRT_VALUE** P_LVALUE_98 = &(PTMP_tmp3_7);
    PrtFreeValue(*P_LVALUE_98);
    *P_LVALUE_98 = PrtTupleGet(*P_VAR_payload_6, 1);
    
    PRT_VALUE** P_LVALUE_99 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_99);
    *P_LVALUE_99 = (PrtMkTuple(&P_GEND_TYPE_T2ii, &(PTMP_tmp2_7), &(PTMP_tmp3_7)));
    ...
    switch (P_eventId) {
        case 2: {
                        ...
                        if (PrtPrimGetBool(*P_VAR_result))
            {
                ...
                *P_LVALUE_100 = PrtTupleGet(*P_VAR_payload_6, 2);
                
                PRT_VALUE** P_LVALUE_101 = &(PTMP_tmp6_4);
                PrtFreeValue(*P_LVALUE_101);
                *P_LVALUE_101 = PrtCloneValue(PTMP_tmp5_5);
                
                PRT_VALUE** P_LVALUE_102 = &(PTMP_tmp7_4);
                PrtFreeValue(*P_LVALUE_102);
                *P_LVALUE_102 = PrtCloneValue((&P_EVENT_TRUSTEDeRespConfirmVote.value));
                ...
                PRT_VALUE** P_LVALUE_103 = &(PTMP_tmp8_3);
                PrtFreeValue(*P_LVALUE_103);
                *P_LVALUE_103 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[4]) + PrtPrimGetInt((&P_LIT_INT32_14)));
                
                {
                    PRT_VALUE** P_LVALUE_104 = &(p_this->varValues[4]);
                    PrtFreeValue(*P_LVALUE_104);
                    *P_LVALUE_104 = PTMP_tmp8_3;
                    PTMP_tmp8_3 = NULL;
                }
    ...
    *P_LVALUE_105 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[4]) >= PrtPrimGetInt(p_this->varValues[3]));
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_106 = &(PTMP_tmp0_8);
    ...
    *P_LVALUE_107 = PrtCloneValue((&P_EVENT_TRUSTEDeGetLog.value));
    ...
    switch (P_eventId_1) {
        case 3: {
            ...
            *P_LVALUE_109 = PrtCloneValue((&P_EVENT_TRUSTEDeAllVotes.value));
            
            PRT_VALUE** P_LVALUE_110 = &(PTMP_tmp4_7);
            PrtFreeValue(*P_LVALUE_110);
            *P_LVALUE_110 = PrtCloneValue((&P_LIT_INT32_16));
            
            PRT_VALUE** P_LVALUE_111 = &(PTMP_tmp5_6);
            PrtFreeValue(*P_LVALUE_111);
            *P_LVALUE_111 = PrtCloneValue(*P_VAR_payload_7);
            
            PRT_VALUE** P_LVALUE_112 = &(PTMP_tmp6_5);
            PrtFreeValue(*P_LVALUE_112);
            *P_LVALUE_112 = (PrtMkTuple(&P_GEND_TYPE_T2iST2ii, &(PTMP_tmp4_7), &(PTMP_tmp5_6)));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_113 = PrtCloneValue(*P_VAR_payload_8);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_114 = &(PTMP_tmp0_9);
    PrtFreeValue(*P_LVALUE_114);
    *P_LVALUE_114 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[0]));
    
    PRT_VALUE** P_LVALUE_115 = &(PTMP_tmp1_9);
    PrtFreeValue(*P_LVALUE_115);
    *P_LVALUE_115 = PrtTupleGet(*P_VAR_payload_9, 0);
    
    PRT_VALUE** P_LVALUE_116 = &(PTMP_tmp2_9);
    PrtFreeValue(*P_LVALUE_116);
    *P_LVALUE_116 = PrtTupleGet(*P_VAR_payload_9, 1);
    
    PRT_VALUE** P_LVALUE_117 = &(PTMP_tmp3_9);
    PrtFreeValue(*P_LVALUE_117);
    *P_LVALUE_117 = (PrtMkTuple(&P_GEND_TYPE_T2ii, &(PTMP_tmp1_9), &(PTMP_tmp2_9)));
    ...
    *P_LVALUE_118 = PrtCloneValue(p_this->varValues[1]);
    ...
    PRT_VALUE** P_LVALUE_119 = &(PTMP_tmp5_7);
    PrtFreeValue(*P_LVALUE_119);
    *P_LVALUE_119 = PrtCloneValue((&P_EVENT_TRUSTEDeRespAddItem.value));
    
    PRT_VALUE** P_LVALUE_120 = &(PTMP_tmp6_6);
    PrtFreeValue(*P_LVALUE_120);
    *P_LVALUE_120 = PrtCloneValue((&P_LIT_BOOLEAN_2));
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_122 = PrtCloneValue((&P_EVENT_TRUSTEDeRespGetLog.value));
    
    PRT_VALUE** P_LVALUE_123 = &(PTMP_tmp2_10);
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_124 = PrtCloneValue(*P_VAR_bBoard_1);
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_125 = PrtTupleGet(*P_VAR_payload_10, 1);
    
    {
        PRT_VALUE** P_LVALUE_126 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_126);
        *P_LVALUE_126 = PTMP_tmp0_11;
        PTMP_tmp0_11 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_127 = &(P_VAR_i);
    PrtFreeValue(*P_LVALUE_127);
    *P_LVALUE_127 = PrtCloneValue((&P_LIT_INT32_20));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_3)))
    {
        PRT_VALUE** P_LVALUE_128 = &(PTMP_tmp0_12);
        PrtFreeValue(*P_LVALUE_128);
        *P_LVALUE_128 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[1]));
        
        PRT_VALUE** P_LVALUE_129 = &(PTMP_tmp1_11);
        PrtFreeValue(*P_LVALUE_129);
        *P_LVALUE_129 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i) < PrtPrimGetInt(PTMP_tmp0_12));
        
        PRT_VALUE** P_LVALUE_130 = &(PTMP_tmp2_11);
        PrtFreeValue(*P_LVALUE_130);
        *P_LVALUE_130 = PrtCloneValue(PTMP_tmp1_11);
        ...
        *P_LVALUE_131 = PrtSeqGet(p_this->varValues[1], P_VAR_i);
        
        PRT_VALUE** P_LVALUE_132 = &(PTMP_tmp4_9);
        PrtFreeValue(*P_LVALUE_132);
        *P_LVALUE_132 = PrtTupleGet(PTMP_tmp3_10, 0);
        
        PRT_VALUE** P_LVALUE_133 = &(PTMP_tmp5_8);
        PrtFreeValue(*P_LVALUE_133);
        *P_LVALUE_133 = PrtSeqGet(p_this->varValues[1], P_VAR_i);
        
        PRT_VALUE** P_LVALUE_134 = &(PTMP_tmp6_7);
        PrtFreeValue(*P_LVALUE_134);
        *P_LVALUE_134 = PrtTupleGet(PTMP_tmp5_8, 1);
        
        {
            PRT_VALUE** P_LVALUE_135 = &(*(PrtMapGetLValue(P_VAR_result_1, PTMP_tmp4_9, PRT_TRUE, &P_GEND_TYPE_MKiVi)));
            PrtFreeValue(*P_LVALUE_135);
            *P_LVALUE_135 = PTMP_tmp6_7;
            PTMP_tmp6_7 = NULL;
        }
        
        PRT_VALUE** P_LVALUE_136 = &(PTMP_tmp7_5);
        PrtFreeValue(*P_LVALUE_136);
        *P_LVALUE_136 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i) + PrtPrimGetInt((&P_LIT_INT32_21)));
        
        {
            PRT_VALUE** P_LVALUE_137 = &(P_VAR_i);
            PrtFreeValue(*P_LVALUE_137);
            *P_LVALUE_137 = PTMP_tmp7_5;
            PTMP_tmp7_5 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_138 = &(PTMP_tmp8_4);
    PrtFreeValue(*P_LVALUE_138);
    *P_LVALUE_138 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_139 = &(PTMP_tmp9_4);
    PrtFreeValue(*P_LVALUE_139);
    *P_LVALUE_139 = PrtCloneValue((&P_EVENT_TRUSTEDeElectionResults.value));
    
    PRT_VALUE** P_LVALUE_140 = &(PTMP_tmp10_3);
    PrtFreeValue(*P_LVALUE_140);
    *P_LVALUE_140 = PrtCloneValue(P_VAR_result_1);
    
    PRT_VALUE* P_PTMP_tmp_11 = PrtCloneValue(&(P_LIT_INT32_21));
    _P_GEN_funargs[0] = &(PTMP_tmp8_4);
    _P_GEN_funargs[1] = &(PTMP_tmp9_4);
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_141 = &(PTMP_tmp0_13);
    PrtFreeValue(*P_LVALUE_141);
    *P_LVALUE_141 = PrtTupleGet(*P_VAR_payload_11, 2);
    
    PRT_VALUE** P_LVALUE_142 = &(PTMP_tmp1_12);
    PrtFreeValue(*P_LVALUE_142);
    *P_LVALUE_142 = PrtTupleGet(*P_VAR_payload_11, 3);
    
    PRT_VALUE** P_LVALUE_143 = &(PTMP_tmp2_12);
    PrtFreeValue(*P_LVALUE_143);
    *P_LVALUE_143 = PrtMkIntValue(PrtPrimGetInt(PTMP_tmp0_13) + PrtPrimGetInt(PTMP_tmp1_12));
    
    {
        PRT_VALUE** P_LVALUE_144 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_144);
        *P_LVALUE_144 = PTMP_tmp2_12;
        PTMP_tmp2_12 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_145 = &(PTMP_tmp3_11);
    PrtFreeValue(*P_LVALUE_145);
    *P_LVALUE_145 = PrtTupleGet(*P_VAR_payload_11, 2);
    
    {
        PRT_VALUE** P_LVALUE_146 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_146);
        *P_LVALUE_146 = PTMP_tmp3_11;
        PTMP_tmp3_11 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_147 = &(PTMP_tmp4_10);
    PrtFreeValue(*P_LVALUE_147);
    *P_LVALUE_147 = PrtTupleGet(*P_VAR_payload_11, 3);
    
    {
        PRT_VALUE** P_LVALUE_148 = &(p_this->varValues[4]);
        PrtFreeValue(*P_LVALUE_148);
        *P_LVALUE_148 = PTMP_tmp4_10;
        PTMP_tmp4_10 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_153 = PrtTupleGet(*P_VAR_payload_12, 0);
    
    PRT_VALUE** P_LVALUE_154 = &(PTMP_tmp1_13);
    PrtFreeValue(*P_LVALUE_154);
    *P_LVALUE_154 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp0_14, p_this->varValues[3]));
    
    PRT_VALUE** P_LVALUE_155 = &(PTMP_tmp4_11);
    PrtFreeValue(*P_LVALUE_155);
    *P_LVALUE_155 = PrtCloneValue(PTMP_tmp1_13);
    
    if (PrtPrimGetBool(PTMP_tmp4_11))
    {
        PRT_VALUE** P_LVALUE_156 = &(PTMP_tmp2_13);
        PrtFreeValue(*P_LVALUE_156);
        *P_LVALUE_156 = PrtTupleGet(*P_VAR_payload_12, 1);
        
        PRT_VALUE** P_LVALUE_157 = &(PTMP_tmp3_12);
        PrtFreeValue(*P_LVALUE_157);
        *P_LVALUE_157 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp2_13, p_this->varValues[4]));
        
        PRT_VALUE** P_LVALUE_158 = &(PTMP_tmp4_11);
        PrtFreeValue(*P_LVALUE_158);
        *P_LVALUE_158 = PrtCloneValue(PTMP_tmp3_12);
    ...
    if (PrtPrimGetBool(PTMP_tmp4_11))
    {
        PRT_VALUE** P_LVALUE_159 = &(PTMP_tmp5_10);
        PrtFreeValue(*P_LVALUE_159);
        *P_LVALUE_159 = PrtTupleGet(*P_VAR_payload_12, 2);
        
        PRT_VALUE** P_LVALUE_160 = &(PTMP_tmp6_9);
        PrtFreeValue(*P_LVALUE_160);
        *P_LVALUE_160 = PrtCloneValue(PTMP_tmp5_10);
        
        PrtGoto(p_this, 3U, 1, &(PTMP_tmp6_9));
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_162 = PrtCloneValue((&P_EVENT_TRUSTEDeVote.value));
    
    PRT_VALUE** P_LVALUE_163 = &(PTMP_tmp2_14);
    PrtFreeValue(*P_LVALUE_163);
    *P_LVALUE_163 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_164 = &(PTMP_tmp3_13);
    PrtFreeValue(*P_LVALUE_164);
    *P_LVALUE_164 = PrtCloneValue(*P_VAR_vote);
    
    PRT_VALUE** P_LVALUE_165 = &(PTMP_tmp4_12);
    PrtFreeValue(*P_LVALUE_165);
    *P_LVALUE_165 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_21;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_166 = (PrtMkTuple(&P_GEND_TYPE_T3iimachine_handle, &(PTMP_tmp2_14), &(PTMP_tmp3_13), &(PTMP_tmp4_12)));
...
PRT_VALUE* P_Anon_IMPL_21(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_167 = &(PTMP_tmp0_16);
    PrtFreeValue(*P_LVALUE_167);
    *P_LVALUE_167 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_168 = &(PTMP_tmp1_15);
    PrtFreeValue(*P_LVALUE_168);
    *P_LVALUE_168 = PrtCloneValue((&P_EVENT_TRUSTEDeGetElectionResults.value));
    
    PRT_VALUE** P_LVALUE_169 = &(PTMP_tmp2_15);
...
PRT_VALUE* P_Anon_IMPL_22(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_170 = &(PTMP_tmp0_17);
    PrtFreeValue(*P_LVALUE_170);
    *P_LVALUE_170 = PrtTupleGet(*P_VAR_payload_13, 0);
    
    PRT_VALUE** P_LVALUE_171 = &(PTMP_tmp1_16);
    PrtFreeValue(*P_LVALUE_171);
    *P_LVALUE_171 = PrtMkBoolValue(PrtMapExists(PTMP_tmp0_17, p_this->varValues[0]));;
    
    PRT_VALUE** P_LVALUE_172 = &(PTMP_tmp2_16);
    PrtFreeValue(*P_LVALUE_172);
    *P_LVALUE_172 = PrtMkBoolValue(!PrtPrimGetBool(PTMP_tmp1_16));
    ...
    {
        PRT_VALUE** P_LVALUE_173 = &(PTMP_tmp3_14);
        PrtFreeValue(*P_LVALUE_173);
        *P_LVALUE_173 = PrtTupleGet(*P_VAR_payload_13, 0);
        
        PRT_VALUE** P_LVALUE_174 = &(PTMP_tmp4_13);
        PrtFreeValue(*P_LVALUE_174);
        *P_LVALUE_174 = PrtMapGet(PTMP_tmp3_14, p_this->varValues[0]);
    ...
    PRT_VALUE** P_LVALUE_175 = &(PTMP_tmp5_12);
    PrtFreeValue(*P_LVALUE_175);
    *P_LVALUE_175 = PrtTupleGet(*P_VAR_payload_13, 1);
    
    PrtFormatPrintf("", 1, PTMP_tmp5_12, 1, 0, " won the election");
...
PRT_VALUE* P_Anon_IMPL_23(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_176 = &(PTMP_tmp0_18);
    PrtFreeValue(*P_LVALUE_176);
    *P_LVALUE_176 = PrtCloneValue((&_P_EVENT_HALT_STRUCT.value));
