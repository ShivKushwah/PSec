...
static PRT_TYPE* P_NMDTUP_T_3[] = { &P_GEND_TYPE_StringType, &P_GEND_TYPE_i };
static PRT_NMDTUPTYPE P_NMDTUP_3 = { 2U, P_NMDTUP_N_3, P_NMDTUP_T_3 };
static PRT_TYPE P_GEND_TYPE_T2StringTypei = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_3 } };
static PRT_SEQTYPE P_SEQTYPE = { &P_GEND_TYPE_T2StringTypei };
static PRT_TYPE P_GEND_TYPE_ST2StringTypei = { PRT_KIND_SEQ, { .seq = &P_SEQTYPE } };
static PRT_STRING P_NMDTUP_N_4[] = { "ballotID", "votes" };
static PRT_TYPE* P_NMDTUP_T_4[] = { &P_GEND_TYPE_i, &P_GEND_TYPE_ST2StringTypei };
static PRT_NMDTUPTYPE P_NMDTUP_4 = { 2U, P_NMDTUP_N_4, P_NMDTUP_T_4 };
static PRT_TYPE P_GEND_TYPE_T2iST2StringTypei = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_4 } };
static PRT_STRING P_NMDTUP_N_5[] = { "tabulationTellerMachine", "credentialToCheck" };
static PRT_TYPE* P_NMDTUP_T_5[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_StringType };
static PRT_NMDTUPTYPE P_NMDTUP_5 = { 2U, P_NMDTUP_N_5, P_NMDTUP_T_5 };
static PRT_TYPE P_GEND_TYPE_T2machine_handleStringType_1 = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_5 } };
static PRT_MAPTYPE P_MAPTYPE = { &P_GEND_TYPE_StringType, &P_GEND_TYPE_i };
static PRT_TYPE P_GEND_TYPE_MKStringTypeVi = { PRT_KIND_MAP, { .map = &P_MAPTYPE } };
static PRT_STRING P_NMDTUP_N_6[] = { "allVotes", "whoWon" };
static PRT_TYPE* P_NMDTUP_T_6[] = { &P_GEND_TYPE_MKStringTypeVi, &P_GEND_TYPE_i };
static PRT_NMDTUPTYPE P_NMDTUP_6 = { 2U, P_NMDTUP_N_6, P_NMDTUP_T_6 };
static PRT_TYPE P_GEND_TYPE_T2MKStringTypeVii = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_6 } };
static PRT_STRING P_NMDTUP_N_7[] = { "bBoard", "supervisor" };
static PRT_TYPE* P_NMDTUP_T_7[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_machine_handle };
static PRT_NMDTUPTYPE P_NMDTUP_7 = { 2U, P_NMDTUP_N_7, P_NMDTUP_T_7 };
static PRT_TYPE P_GEND_TYPE_T2machine_handlemachine_handle = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_7 } };
static PRT_STRING P_NMDTUP_N_8[] = { "ballotBox", "bulletinBoard" };
static PRT_TYPE* P_NMDTUP_T_8[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_machine_handle };
static PRT_NMDTUPTYPE P_NMDTUP_8 = { 2U, P_NMDTUP_N_8, P_NMDTUP_T_8 };
static PRT_TYPE P_GEND_TYPE_T2machine_handlemachine_handle_1 = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_8 } };
...
static PRT_SEQTYPE P_SEQTYPE_1 = { &P_GEND_TYPE_StringType };
static PRT_TYPE P_GEND_TYPE_SStringType = { PRT_KIND_SEQ, { .seq = &P_SEQTYPE_1 } };
...
PRT_EVENTDECL P_EVENT_TRUSTEDValidateCredential = 
{
    ...
    4294967295U,
    &P_GEND_TYPE_T2machine_handleStringType_1,
    0
};
...
PRT_EVENTDECL P_EVENT_TRUSTEDProvisionSecureVotingClientMachine = 
{
    ...
    4294967295U,
    &P_GEND_TYPE_T2machine_handlemachine_handle_1,
    0
};
...
PRT_VARDECL P_SecureSupervisorMachine_VARS[] = {
    ...
    { "valid_credentials", &P_GEND_TYPE_SStringType }
};
...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_17 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_23 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlemachine_handle, &(PTMP_tmp4_1), &(PTMP_tmp5_1)));
    ...
    *P_LVALUE_27 = ((_P_GEN_funval = P_GenerateCredential2_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_31 = &(PTMP_tmp0_3);
    ...
    *P_LVALUE_31 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    {
        PRT_VALUE** P_LVALUE_32 = &(P_VAR_secureVotingClientMachine);
        PrtFreeValue(*P_LVALUE_32);
        *P_LVALUE_32 = PTMP_tmp0_3;
        PTMP_tmp0_3 = NULL;
    }
    ...
    *P_LVALUE_34 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionSecureVotingClientMachine.value));
    
    PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_35);
    *P_LVALUE_35 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_36 = &(PTMP_tmp4_2);
    ...
    *P_LVALUE_37 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlemachine_handle_1, &(PTMP_tmp3_3), &(PTMP_tmp4_2)));
    ...
    PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp6_2);
    PrtFreeValue(*P_LVALUE_38);
    *P_LVALUE_38 = PrtCloneValue(*P_VAR_requestingMachine);
    
    PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp7_1);
    PrtFreeValue(*P_LVALUE_39);
    *P_LVALUE_39 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveVotingSSM.value));
    
    PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp8_1);
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_41 = &(P_VAR_i_1);
    PrtFreeValue(*P_LVALUE_41);
    *P_LVALUE_41 = PrtCloneValue((&P_LIT_INT32_3));
    
    PRT_VALUE** P_LVALUE_42 = &(P_VAR_found);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtCloneValue((&P_LIT_BOOLEAN));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_1)))
    {
        PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp0_4);
        PrtFreeValue(*P_LVALUE_43);
        *P_LVALUE_43 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[3]));
        
        PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp1_4);
        PrtFreeValue(*P_LVALUE_44);
        *P_LVALUE_44 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_1) < PrtPrimGetInt(PTMP_tmp0_4));
        
        PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp2_4);
        PrtFreeValue(*P_LVALUE_45);
        *P_LVALUE_45 = PrtCloneValue(PTMP_tmp1_4);
        ...
        *P_LVALUE_46 = PrtSeqGet(p_this->varValues[3], P_VAR_i_1);
        ...
        *P_LVALUE_48 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp3_4, PTMP_tmp4_3));
        
        if (PrtPrimGetBool(PTMP_tmp5_3))
        {
            PRT_VALUE** P_LVALUE_49 = &(P_VAR_found);
            PrtFreeValue(*P_LVALUE_49);
            *P_LVALUE_49 = PrtCloneValue((&P_LIT_BOOLEAN_1));
        ...
        *P_LVALUE_50 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_1) + PrtPrimGetInt((&P_LIT_INT32_4)));
        
        {
            PRT_VALUE** P_LVALUE_51 = &(P_VAR_i_1);
            PrtFreeValue(*P_LVALUE_51);
            *P_LVALUE_51 = PTMP_tmp6_3;
            PTMP_tmp6_3 = NULL;
        }
    ...
    if (PrtPrimGetBool(P_VAR_found))
    {
        ...
        *P_LVALUE_52 = PrtTupleGet(*P_VAR_payload, 0);
        
        PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp8_2);
        PrtFreeValue(*P_LVALUE_53);
        *P_LVALUE_53 = PrtCloneValue(PTMP_tmp7_2);
        
        PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp9_1);
        PrtFreeValue(*P_LVALUE_54);
        *P_LVALUE_54 = PrtCloneValue((&P_EVENT_TRUSTEDValidCredential.value));
    ...
    else
    {
        ...
        *P_LVALUE_56 = PrtCloneValue(PTMP_tmp10_1);
        
        PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp12_1);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PrtCloneValue((&P_EVENT_TRUSTEDInvalidCredential.value));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_58 = PrtTupleGet(*P_VAR_payload_1, 0);
    
    {
        PRT_VALUE** P_LVALUE_59 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_59);
        *P_LVALUE_59 = PTMP_tmp0_5;
        PTMP_tmp0_5 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_60);
    *P_LVALUE_60 = PrtTupleGet(*P_VAR_payload_1, 1);
    
    {
        PRT_VALUE** P_LVALUE_61 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_61);
        *P_LVALUE_61 = PTMP_tmp1_5;
        PTMP_tmp1_5 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_62);
    *P_LVALUE_62 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtCloneValue((&P_EVENT_UNTRUSTEDGetVotingSSM.value));
    
    PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_64);
    *P_LVALUE_64 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_65 = PrtMkStringValue(PrtFormatString("SecureVotingClientMachine", 0, 0));
    ;
    
    {
        PRT_VALUE** P_LVALUE_66 = &(P_VAR_machineTypeToValidate);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
    ...
    *P_LVALUE_73 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    ...
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp6_4);
    PrtFreeValue(*P_LVALUE_74);
    *P_LVALUE_74 = (PrtMkTuple(&P_GEND_TYPE_T3StringTypeimachine_handle, &(PTMP_tmp3_6), &(PTMP_tmp4_5), &(PTMP_tmp5_4)));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_75 = &(PTMP_tmp0_7);
...
PRT_VARDECL P_SecureBulletinBoardMachine_VARS[] = {
    { "electionResults", &P_GEND_TYPE_MKStringTypeVi }
};
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_electionResultsKeys = PrtMkDefaultValue(&P_GEND_TYPE_SStringType);
    ...
    PRT_VALUE** P_LVALUE_78 = &(PTMP_tmp0_8);
    ...
    *P_LVALUE_82 = PrtCloneValue((&P_LIT_INT32_7));
    ...
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_2)))
    {
        ...
        *P_LVALUE_83 = PrtMkIntValue(PrtSeqSizeOf(P_VAR_electionResultsKeys));
        ...
        PRT_VALUE** P_LVALUE_84 = &(PTMP_tmp2_7);
        PrtFreeValue(*P_LVALUE_84);
        *P_LVALUE_84 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_2) < PrtPrimGetInt(PTMP_tmp1_8));
        
        PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp3_7);
        PrtFreeValue(*P_LVALUE_85);
        *P_LVALUE_85 = PrtCloneValue(PTMP_tmp2_7);
        ...
        *P_LVALUE_87 = PrtMapGet(p_this->varValues[0], PTMP_tmp4_6);
        ...
        PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp6_5);
        PrtFreeValue(*P_LVALUE_88);
        *P_LVALUE_88 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp5_5, (&P_LIT_INT32_7)));
        
        if (PrtPrimGetBool(PTMP_tmp6_5))
        {
            PRT_VALUE** P_LVALUE_89 = &(PTMP_tmp7_3);
            PrtFreeValue(*P_LVALUE_89);
            *P_LVALUE_89 = PrtMkIntValue(PrtPrimGetInt(P_VAR_countCandidate0) + PrtPrimGetInt((&P_LIT_INT32_8)));
            
            {
                PRT_VALUE** P_LVALUE_90 = &(P_VAR_countCandidate0);
                PrtFreeValue(*P_LVALUE_90);
                *P_LVALUE_90 = PTMP_tmp7_3;
                PTMP_tmp7_3 = NULL;
            }
        ...
        {
            PRT_VALUE** P_LVALUE_91 = &(PTMP_tmp8_3);
            PrtFreeValue(*P_LVALUE_91);
            *P_LVALUE_91 = PrtMkIntValue(PrtPrimGetInt(P_VAR_countCandidate1) + PrtPrimGetInt((&P_LIT_INT32_8)));
            
            {
                PRT_VALUE** P_LVALUE_92 = &(P_VAR_countCandidate1);
                PrtFreeValue(*P_LVALUE_92);
                *P_LVALUE_92 = PTMP_tmp8_3;
                PTMP_tmp8_3 = NULL;
            }
        ...
        PRT_VALUE** P_LVALUE_93 = &(PTMP_tmp9_2);
        PrtFreeValue(*P_LVALUE_93);
        *P_LVALUE_93 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_2) + PrtPrimGetInt((&P_LIT_INT32_8)));
        
        {
            PRT_VALUE** P_LVALUE_94 = &(P_VAR_i_2);
            PrtFreeValue(*P_LVALUE_94);
            *P_LVALUE_94 = PTMP_tmp9_2;
            PTMP_tmp9_2 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_95 = &(PTMP_tmp10_2);
    ...
    *P_LVALUE_95 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_countCandidate0) > PrtPrimGetInt(P_VAR_countCandidate1));
    ...
    {
        PRT_VALUE** P_LVALUE_97 = &(PTMP_tmp11_2);
        ...
        *P_LVALUE_97 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_countCandidate1) > PrtPrimGetInt(P_VAR_countCandidate0));
        ...
        else
        {
            ...
            *P_LVALUE_99 = PrtCloneValue((&P_LIT_INT32_9));
    ...
    *P_LVALUE_104 = (PrtMkTuple(&P_GEND_TYPE_T2MKStringTypeVii, &(PTMP_tmp14), &(PTMP_tmp15)));
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_105 = &(PTMP_tmp0_9);
    ...
    *P_LVALUE_107 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_108 = PTMP_tmp1_9;
        PTMP_tmp1_9 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_109 = &(PTMP_tmp2_8);
    PrtFreeValue(*P_LVALUE_109);
    *P_LVALUE_109 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_110 = &(PTMP_tmp3_8);
    ...
    *P_LVALUE_111 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    ...
    *P_LVALUE_112 = ((_P_GEN_funval = P_CreateUSMMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_114 = &(PTMP_tmp6_6);
    ...
    *P_LVALUE_115 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionSecureTabulationTellerMachine.value));
    ...
    PRT_VALUE** P_LVALUE_116 = &(PTMP_tmp8_4);
    PrtFreeValue(*P_LVALUE_116);
    *P_LVALUE_116 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_117 = &(PTMP_tmp9_3);
    PrtFreeValue(*P_LVALUE_117);
    *P_LVALUE_117 = PrtTupleGet(*P_VAR_payload_5, 1);
    
    PRT_VALUE** P_LVALUE_118 = &(PTMP_tmp10_3);
    PrtFreeValue(*P_LVALUE_118);
    *P_LVALUE_118 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlemachine_handle, &(PTMP_tmp8_4), &(PTMP_tmp9_3)));
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_120 = PrtCloneValue((&P_LIT_INT32_11));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_125 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypei, &(PTMP_tmp2_9), &(PTMP_tmp3_9)));
        ...
        case 2: {
                        ...
                        if (PrtPrimGetBool(*P_VAR_result))
            {
                ...
                *P_LVALUE_126 = PrtTupleGet(*P_VAR_payload_7, 2);
                ...
                PRT_VALUE** P_LVALUE_127 = &(PTMP_tmp6_7);
                ...
                *P_LVALUE_128 = PrtCloneValue((&P_EVENT_TRUSTEDeRespConfirmVote.value));
                ...
                PRT_VALUE** P_LVALUE_129 = &(PTMP_tmp8_5);
                PrtFreeValue(*P_LVALUE_129);
                *P_LVALUE_129 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[4]) + PrtPrimGetInt((&P_LIT_INT32_14)));
                
                {
                    PRT_VALUE** P_LVALUE_130 = &(p_this->varValues[4]);
                    PrtFreeValue(*P_LVALUE_130);
                    *P_LVALUE_130 = PTMP_tmp8_5;
                    PTMP_tmp8_5 = NULL;
                }
    ...
    PRT_VALUE** P_LVALUE_131 = &(PTMP_tmp9_4);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_132 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_132);
    *P_LVALUE_132 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_133 = &(PTMP_tmp1_11);
    ...
    *P_LVALUE_133 = PrtCloneValue((&P_EVENT_TRUSTEDeGetLog.value));
    ...
    switch (P_eventId_1) {
        case 3: {
            ...
            PRT_VALUE** P_LVALUE_134 = &(PTMP_tmp2_10);
            PrtFreeValue(*P_LVALUE_134);
            *P_LVALUE_134 = PrtCloneValue(p_this->varValues[1]);
            
            PRT_VALUE** P_LVALUE_135 = &(PTMP_tmp3_10);
            ...
            *P_LVALUE_136 = PrtCloneValue((&P_LIT_INT32_16));
            
            PRT_VALUE** P_LVALUE_137 = &(PTMP_tmp5_8);
            PrtFreeValue(*P_LVALUE_137);
            *P_LVALUE_137 = PrtCloneValue(*P_VAR_payload_8);
            
            PRT_VALUE** P_LVALUE_138 = &(PTMP_tmp6_8);
            PrtFreeValue(*P_LVALUE_138);
            *P_LVALUE_138 = (PrtMkTuple(&P_GEND_TYPE_T2iST2StringTypei, &(PTMP_tmp4_9), &(PTMP_tmp5_8)));
...
PRT_VARDECL P_SecureTamperEvidentLogMachine_VARS[] = {
    { "log", &P_GEND_TYPE_ST2StringTypei },
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_140 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[0]));
    ...
    PRT_VALUE** P_LVALUE_141 = &(PTMP_tmp1_12);
    PrtFreeValue(*P_LVALUE_141);
    *P_LVALUE_141 = PrtTupleGet(*P_VAR_payload_10, 0);
    
    PRT_VALUE** P_LVALUE_142 = &(PTMP_tmp2_11);
    PrtFreeValue(*P_LVALUE_142);
    *P_LVALUE_142 = PrtTupleGet(*P_VAR_payload_10, 1);
    
    PRT_VALUE** P_LVALUE_143 = &(PTMP_tmp3_11);
    PrtFreeValue(*P_LVALUE_143);
    *P_LVALUE_143 = (PrtMkTuple(&P_GEND_TYPE_T2StringTypei, &(PTMP_tmp1_12), &(PTMP_tmp2_11)));
    
    PrtSeqInsertEx(p_this->varValues[0], PTMP_tmp0_12, PTMP_tmp3_11, PRT_FALSE);
    *(&(PTMP_tmp3_11)) = NULL;
    ...
    *P_LVALUE_145 = PrtCloneValue((&P_EVENT_TRUSTEDeRespAddItem.value));
    ...
    PRT_VALUE** P_LVALUE_146 = &(PTMP_tmp6_9);
...
PRT_VARDECL P_SecureTabulationTellerMachine_VARS[] = {
    { "bulletinBoard", &P_GEND_TYPE_machine_handle },
    { "supervisor", &P_GEND_TYPE_machine_handle },
    { "allVotes", &P_GEND_TYPE_ST2StringTypei }
};
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_150 = &(PTMP_tmp0_14);
    ...
    *P_LVALUE_150 = PrtTupleGet(*P_VAR_payload_11, 0);
    
    {
        ...
        *P_LVALUE_151 = PTMP_tmp0_14;
        PTMP_tmp0_14 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_152 = &(PTMP_tmp1_14);
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_154 = &(PTMP_tmp0_15);
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_MACHINEINST_PRIV* p_this = (PRT_MACHINEINST_PRIV*)context;
    PRT_VALUE* _P_GEN_retval = NULL;
    PRT_VALUE* P_VAR_result_1 = PrtMkDefaultValue(&P_GEND_TYPE_MKStringTypeVi);
    ...
    *P_LVALUE_156 = PrtCloneValue((&P_LIT_INT32_20));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_4)))
    {
        PRT_VALUE** P_LVALUE_157 = &(PTMP_tmp0_16);
        PrtFreeValue(*P_LVALUE_157);
        *P_LVALUE_157 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[2]));
        
        PRT_VALUE** P_LVALUE_158 = &(PTMP_tmp1_15);
        PrtFreeValue(*P_LVALUE_158);
        *P_LVALUE_158 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_3) < PrtPrimGetInt(PTMP_tmp0_16));
        
        PRT_VALUE** P_LVALUE_159 = &(PTMP_tmp2_13);
        PrtFreeValue(*P_LVALUE_159);
        *P_LVALUE_159 = PrtCloneValue(PTMP_tmp1_15);
        ...
        PRT_VALUE** P_LVALUE_160 = &(PTMP_tmp3_12);
        ...
        *P_LVALUE_162 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
        
        PRT_VALUE** P_LVALUE_163 = &(PTMP_tmp6_10);
        PrtFreeValue(*P_LVALUE_163);
        *P_LVALUE_163 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
        
        PRT_VALUE** P_LVALUE_164 = &(PTMP_tmp7_6);
        PrtFreeValue(*P_LVALUE_164);
        *P_LVALUE_164 = PrtTupleGet(PTMP_tmp6_10, 0);
        
        PRT_VALUE** P_LVALUE_165 = &(PTMP_tmp8_6);
        PrtFreeValue(*P_LVALUE_165);
        *P_LVALUE_165 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handleStringType_1, &(PTMP_tmp5_10), &(PTMP_tmp7_6)));
        ...
        switch (P_eventId_2) {
            case 4: {
                ...
                *P_LVALUE_166 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
                ...
                PRT_VALUE** P_LVALUE_167 = &(PTMP_tmp10_4);
                PrtFreeValue(*P_LVALUE_167);
                *P_LVALUE_167 = PrtTupleGet(PTMP_tmp9_5, 0);
                ...
                *P_LVALUE_169 = PrtTupleGet(PTMP_tmp11_3, 1);
                
                {
                    PRT_VALUE** P_LVALUE_170 = &(*(PrtMapGetLValue(P_VAR_result_1, PTMP_tmp10_4, PRT_TRUE, &P_GEND_TYPE_MKStringTypeVi)));
                    PrtFreeValue(*P_LVALUE_170);
                    *P_LVALUE_170 = PTMP_tmp12_3;
                    PTMP_tmp12_3 = NULL;
                }
        ...
        *P_LVALUE_171 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_3) + PrtPrimGetInt((&P_LIT_INT32_21)));
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_176 = &(PTMP_tmp0_17);
    ...
    *P_LVALUE_176 = PrtTupleGet(*P_VAR_payload_13, 0);
    
    {
        ...
        *P_LVALUE_177 = PTMP_tmp0_17;
        PTMP_tmp0_17 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_178 = &(PTMP_tmp1_16);
...
PRT_VALUE* P_Anon_IMPL_20(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE* P_VAR_secure_vote = PrtMkDefaultValue(&P_GEND_TYPE_i);
    ...
    *P_LVALUE_180 = PrtTupleGet(*P_VAR_payload_14, 2);
    
    {
        ...
        *P_LVALUE_181 = PTMP_tmp0_18;
        PTMP_tmp0_18 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_182 = &(PTMP_tmp1_17);
    ...
    *P_LVALUE_182 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    {
        ...
        *P_LVALUE_183 = PTMP_tmp1_17;
        PTMP_tmp1_17 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_184 = &(PTMP_tmp2_14);
    ...
    *P_LVALUE_188 = PrtCloneValue(p_this->varValues[0]);
    ...
    PRT_VALUE** P_LVALUE_189 = &(PTMP_tmp6_11);
    PrtFreeValue(*P_LVALUE_189);
    *P_LVALUE_189 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    PRT_VALUE** P_LVALUE_190 = &(PTMP_tmp7_7);
    PrtFreeValue(*P_LVALUE_190);
    *P_LVALUE_190 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    
    PRT_VALUE** P_LVALUE_191 = &(PTMP_tmp8_7);
    PrtFreeValue(*P_LVALUE_191);
    *P_LVALUE_191 = (PrtMkTuple(&P_GEND_TYPE_T3StringTypeimachine_handle, &(PTMP_tmp5_11), &(PTMP_tmp6_11), &(PTMP_tmp7_7)));
...
PRT_VALUE* P_Anon_IMPL_22(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_192 = &(PTMP_tmp0_19);
    PrtFreeValue(*P_LVALUE_192);
    *P_LVALUE_192 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_193 = &(PTMP_tmp1_18);
...
PRT_VALUE* P_Anon_IMPL_23(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_195 = &(PTMP_tmp0_20);
    PrtFreeValue(*P_LVALUE_195);
    *P_LVALUE_195 = PrtTupleGet(*P_VAR_payload_15, 0);
    
    PRT_VALUE** P_LVALUE_196 = &(PTMP_tmp1_19);
    PrtFreeValue(*P_LVALUE_196);
    *P_LVALUE_196 = PrtMkBoolValue(PrtMapExists(PTMP_tmp0_20, p_this->varValues[0]));;
    
    PRT_VALUE** P_LVALUE_197 = &(PTMP_tmp2_16);
    PrtFreeValue(*P_LVALUE_197);
    *P_LVALUE_197 = PrtMkBoolValue(!PrtPrimGetBool(PTMP_tmp1_19));
    ...
    *P_LVALUE_201 = PrtCloneValue((&P_EVENT_UNTRUSTEDGetResults.value));
    ...
    PRT_VALUE** P_LVALUE_202 = &(PTMP_tmp6_12);
    PrtFreeValue(*P_LVALUE_202);
    *P_LVALUE_202 = PrtTupleGet(*P_VAR_payload_15, 1);
    
    PRT_VALUE** P_LVALUE_203 = &(PTMP_tmp7_8);
    PrtFreeValue(*P_LVALUE_203);
    *P_LVALUE_203 = PrtCloneValue(P_VAR_voteCounted);
    
    PRT_VALUE** P_LVALUE_204 = &(PTMP_tmp8_8);
    PrtFreeValue(*P_LVALUE_204);
    *P_LVALUE_204 = (PrtMkTuple(&P_GEND_TYPE_T2ib, &(PTMP_tmp6_12), &(PTMP_tmp7_8)));
...
PRT_VALUE* P_Anon_IMPL_24(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_205 = &(PTMP_tmp0_21);
