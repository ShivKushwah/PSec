...
static PRT_STRING P_NMDTUP_N_7[] = { "bBoard", "bBoardCapability" };
...
static PRT_STRING P_NMDTUP_N_9[] = { "ballotBox", "bulletinBoard", "username", "password", "ballotBoxCapability", "bulletinBoardCapability" };
static PRT_TYPE* P_NMDTUP_T_9[] = { &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_machine_handle, &P_GEND_TYPE_i, &P_GEND_TYPE_i, &P_GEND_TYPE_capability, &P_GEND_TYPE_capability };
static PRT_NMDTUPTYPE P_NMDTUP_9 = { 6U, P_NMDTUP_N_9, P_NMDTUP_T_9 };
static PRT_TYPE P_GEND_TYPE_T6machine_handlemachine_handleiicapabilitycapability = { PRT_KIND_NMDTUP, { .nmTuple = &P_NMDTUP_9 } };
...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_19 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlecapability, &(PTMP_tmp1_1), &(PTMP_tmp3_1)));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_90 = PrtMapGetKeys(p_this->varValues[0]);
    
    {
        PRT_VALUE** P_LVALUE_91 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_91);
        *P_LVALUE_91 = PTMP_tmp0_5;
        PTMP_tmp0_5 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_92 = &(p_this->varValues[2]);
    ...
    *P_LVALUE_94 = PrtCloneValue((&P_LIT_INT32_9));
    ...
    {
        PRT_VALUE** P_LVALUE_95 = &(PTMP_tmp1_5);
        PrtFreeValue(*P_LVALUE_95);
        *P_LVALUE_95 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[1]));
        
        PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp2_5);
        PrtFreeValue(*P_LVALUE_96);
        *P_LVALUE_96 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[2]) < PrtPrimGetInt(PTMP_tmp1_5));
        
        PRT_VALUE** P_LVALUE_97 = &(PTMP_tmp3_5);
        PrtFreeValue(*P_LVALUE_97);
        *P_LVALUE_97 = PrtCloneValue(PTMP_tmp2_5);
        ...
        *P_LVALUE_98 = PrtSeqGet(p_this->varValues[1], p_this->varValues[2]);
        
        PRT_VALUE** P_LVALUE_99 = &(PTMP_tmp5_5);
        PrtFreeValue(*P_LVALUE_99);
        *P_LVALUE_99 = PrtMapGet(p_this->varValues[0], PTMP_tmp4_5);
        
        PRT_VALUE** P_LVALUE_100 = &(PTMP_tmp6_4);
        PrtFreeValue(*P_LVALUE_100);
        *P_LVALUE_100 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp5_5, (&P_LIT_INT32_9)));
        
        if (PrtPrimGetBool(PTMP_tmp6_4))
        {
            PRT_VALUE** P_LVALUE_101 = &(PTMP_tmp7_4);
            PrtFreeValue(*P_LVALUE_101);
            *P_LVALUE_101 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[3]) + PrtPrimGetInt((&P_LIT_INT32_10)));
            
            {
                PRT_VALUE** P_LVALUE_102 = &(p_this->varValues[3]);
                PrtFreeValue(*P_LVALUE_102);
                *P_LVALUE_102 = PTMP_tmp7_4;
                PTMP_tmp7_4 = NULL;
            }
        ...
        else
        {
            ...
            *P_LVALUE_103 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[4]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        ...
        *P_LVALUE_105 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[2]) + PrtPrimGetInt((&P_LIT_INT32_10)));
        
        {
            PRT_VALUE** P_LVALUE_106 = &(p_this->varValues[2]);
            PrtFreeValue(*P_LVALUE_106);
            *P_LVALUE_106 = PTMP_tmp9_3;
            PTMP_tmp9_3 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_107 = &(PTMP_tmp10_3);
    PrtFreeValue(*P_LVALUE_107);
    *P_LVALUE_107 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[3]) > PrtPrimGetInt(p_this->varValues[4]));
    ...
    else
    {
        ...
        *P_LVALUE_109 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[4]) > PrtPrimGetInt(p_this->varValues[3]));
        ...
        if (PrtPrimGetBool(PTMP_tmp11_2))
        {
            ...
            *P_LVALUE_110 = PrtCloneValue((&P_LIT_INT32_10));
        ...
        else
        {
            ...
            *P_LVALUE_111 = PrtCloneValue((&P_LIT_INT32_11));
    ...
    *P_LVALUE_112 = PrtCloneValue(*P_VAR_payload_4);
    ...
    *P_LVALUE_116 = (PrtMkTuple(&P_GEND_TYPE_T2MKiVii, &(PTMP_tmp14_1), &(PTMP_tmp15_1)));
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_122 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlecapability_1, &(PTMP_tmp1_6), &(PTMP_tmp3_6)));
    ...
    *P_LVALUE_127 = (PrtMkTuple(&P_GEND_TYPE_T2machine_handlecapability, &(PTMP_tmp6_5), &(PTMP_tmp7_5)));
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_136 = (PrtMkTuple(&P_GEND_TYPE_T2ii, &(PTMP_tmp2_7), &(PTMP_tmp3_7)));
    ...
    switch (P_eventId) {
        case 2: {
                        ...
                        if (PrtPrimGetBool(*P_VAR_result))
            {
                ...
                *P_LVALUE_140 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[4]) + PrtPrimGetInt((&P_LIT_INT32_15)));
                
                {
                    PRT_VALUE** P_LVALUE_141 = &(p_this->varValues[4]);
                    PrtFreeValue(*P_LVALUE_141);
                    *P_LVALUE_141 = PTMP_tmp8_5;
                    PTMP_tmp8_5 = NULL;
                }
    ...
    PRT_VALUE** P_LVALUE_142 = &(PTMP_tmp9_5);
    ...
    *P_LVALUE_144 = PrtCloneValue((&P_EVENT_TRUSTEDeGetLog.value));
    ...
    switch (P_eventId_1) {
        case 3: {
            ...
            *P_LVALUE_149 = (PrtMkTuple(&P_GEND_TYPE_T2iST2ii, &(PTMP_tmp4_8), &(PTMP_tmp5_8)));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_150 = &(PTMP_tmp0_9);
    PrtFreeValue(*P_LVALUE_150);
    *P_LVALUE_150 = PrtTupleGet(*P_VAR_payload_9, 0);
    
    {
        PRT_VALUE** P_LVALUE_151 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_151);
        *P_LVALUE_151 = PTMP_tmp0_9;
        PTMP_tmp0_9 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_152 = &(PTMP_tmp1_9);
    PrtFreeValue(*P_LVALUE_152);
    *P_LVALUE_152 = PrtTupleGet(*P_VAR_payload_9, 1);
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_158 = PrtCloneValue((&P_EVENT_TRUSTEDeRespAddItem.value));
    
    PRT_VALUE** P_LVALUE_159 = &(PTMP_tmp6_8);
    PrtFreeValue(*P_LVALUE_159);
    *P_LVALUE_159 = PrtCloneValue((&P_LIT_BOOLEAN_3));
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_160 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_160);
    *P_LVALUE_160 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_161 = &(PTMP_tmp1_11);
    PrtFreeValue(*P_LVALUE_161);
    *P_LVALUE_161 = PrtCloneValue((&P_EVENT_TRUSTEDeRespGetLog.value));
    
    PRT_VALUE** P_LVALUE_162 = &(PTMP_tmp2_10);
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_163 = &(PTMP_tmp0_12);
    PrtFreeValue(*P_LVALUE_163);
    *P_LVALUE_163 = PrtTupleGet(*P_VAR_payload_11, 0);
    
    {
        PRT_VALUE** P_LVALUE_164 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_164);
        *P_LVALUE_164 = PTMP_tmp0_12;
        PTMP_tmp0_12 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_165 = &(PTMP_tmp1_12);
    PrtFreeValue(*P_LVALUE_165);
    *P_LVALUE_165 = PrtTupleGet(*P_VAR_payload_11, 1);
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_166 = &(PTMP_tmp0_13);
    PrtFreeValue(*P_LVALUE_166);
    *P_LVALUE_166 = PrtTupleGet(*P_VAR_payload_12, 1);
    
    {
        PRT_VALUE** P_LVALUE_167 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_167);
        *P_LVALUE_167 = PTMP_tmp0_13;
        PTMP_tmp0_13 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_168 = &(P_VAR_i);
    PrtFreeValue(*P_LVALUE_168);
    *P_LVALUE_168 = PrtCloneValue((&P_LIT_INT32_21));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_4)))
    {
        PRT_VALUE** P_LVALUE_169 = &(PTMP_tmp0_14);
        PrtFreeValue(*P_LVALUE_169);
        *P_LVALUE_169 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[1]));
        
        PRT_VALUE** P_LVALUE_170 = &(PTMP_tmp1_13);
        PrtFreeValue(*P_LVALUE_170);
        *P_LVALUE_170 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i) < PrtPrimGetInt(PTMP_tmp0_14));
        
        PRT_VALUE** P_LVALUE_171 = &(PTMP_tmp2_11);
        PrtFreeValue(*P_LVALUE_171);
        *P_LVALUE_171 = PrtCloneValue(PTMP_tmp1_13);
        ...
        PRT_VALUE** P_LVALUE_172 = &(PTMP_tmp3_10);
        PrtFreeValue(*P_LVALUE_172);
        *P_LVALUE_172 = PrtSeqGet(p_this->varValues[1], P_VAR_i);
        
        PRT_VALUE** P_LVALUE_173 = &(PTMP_tmp4_10);
        PrtFreeValue(*P_LVALUE_173);
        *P_LVALUE_173 = PrtTupleGet(PTMP_tmp3_10, 0);
        
        PRT_VALUE** P_LVALUE_174 = &(PTMP_tmp5_10);
        PrtFreeValue(*P_LVALUE_174);
        *P_LVALUE_174 = PrtSeqGet(p_this->varValues[1], P_VAR_i);
        
        PRT_VALUE** P_LVALUE_175 = &(PTMP_tmp6_9);
        PrtFreeValue(*P_LVALUE_175);
        *P_LVALUE_175 = PrtTupleGet(PTMP_tmp5_10, 1);
        
        {
            PRT_VALUE** P_LVALUE_176 = &(*(PrtMapGetLValue(P_VAR_result_1, PTMP_tmp4_10, PRT_TRUE, &P_GEND_TYPE_MKiVi)));
            PrtFreeValue(*P_LVALUE_176);
            *P_LVALUE_176 = PTMP_tmp6_9;
            PTMP_tmp6_9 = NULL;
        }
        
        PRT_VALUE** P_LVALUE_177 = &(PTMP_tmp7_7);
        PrtFreeValue(*P_LVALUE_177);
        *P_LVALUE_177 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i) + PrtPrimGetInt((&P_LIT_INT32_22)));
        
        {
            PRT_VALUE** P_LVALUE_178 = &(P_VAR_i);
            PrtFreeValue(*P_LVALUE_178);
            *P_LVALUE_178 = PTMP_tmp7_7;
            PTMP_tmp7_7 = NULL;
        }
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_182 = &(PTMP_tmp0_15);
    PrtFreeValue(*P_LVALUE_182);
    *P_LVALUE_182 = PrtTupleGet(*P_VAR_payload_13, 2);
    
    PRT_VALUE** P_LVALUE_183 = &(PTMP_tmp1_14);
    PrtFreeValue(*P_LVALUE_183);
    *P_LVALUE_183 = PrtTupleGet(*P_VAR_payload_13, 3);
    
    PRT_VALUE** P_LVALUE_184 = &(PTMP_tmp2_12);
    PrtFreeValue(*P_LVALUE_184);
    *P_LVALUE_184 = PrtMkIntValue(PrtPrimGetInt(PTMP_tmp0_15) + PrtPrimGetInt(PTMP_tmp1_14));
    
    {
        PRT_VALUE** P_LVALUE_185 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_185);
        *P_LVALUE_185 = PTMP_tmp2_12;
        PTMP_tmp2_12 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_186 = &(PTMP_tmp3_11);
    PrtFreeValue(*P_LVALUE_186);
    *P_LVALUE_186 = PrtTupleGet(*P_VAR_payload_13, 2);
    
    {
        PRT_VALUE** P_LVALUE_187 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_187);
        *P_LVALUE_187 = PTMP_tmp3_11;
        PTMP_tmp3_11 = NULL;
    }
    ...
    *P_LVALUE_188 = PrtTupleGet(*P_VAR_payload_13, 3);
    ...
    {
        PRT_VALUE** P_LVALUE_189 = &(p_this->varValues[4]);
        PrtFreeValue(*P_LVALUE_189);
        *P_LVALUE_189 = PTMP_tmp4_11;
        PTMP_tmp4_11 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_190 = &(PTMP_tmp5_11);
    PrtFreeValue(*P_LVALUE_190);
    *P_LVALUE_190 = PrtTupleGet(*P_VAR_payload_13, 0);
    
    {
        PRT_VALUE** P_LVALUE_191 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_191);
        *P_LVALUE_191 = PTMP_tmp5_11;
        PTMP_tmp5_11 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_192 = &(PTMP_tmp6_10);
    PrtFreeValue(*P_LVALUE_192);
    *P_LVALUE_192 = PrtTupleGet(*P_VAR_payload_13, 1);
    
    {
        PRT_VALUE** P_LVALUE_193 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_193);
        *P_LVALUE_193 = PTMP_tmp6_10;
        PTMP_tmp6_10 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_194 = &(PTMP_tmp7_8);
    PrtFreeValue(*P_LVALUE_194);
    *P_LVALUE_194 = PrtTupleGet(*P_VAR_payload_13, 4);
    ...
    PRT_VALUE** P_LVALUE_195 = &(PTMP_tmp8_7);
    PrtFreeValue(*P_LVALUE_195);
    *P_LVALUE_195 = PrtTupleGet(*P_VAR_payload_13, 5);
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_196 = PrtTupleGet(*P_VAR_payload_14, 0);
    
    PRT_VALUE** P_LVALUE_197 = &(PTMP_tmp1_15);
    PrtFreeValue(*P_LVALUE_197);
    *P_LVALUE_197 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp0_16, p_this->varValues[3]));
    ...
    *P_LVALUE_198 = PrtCloneValue(PTMP_tmp1_15);
    ...
    if (PrtPrimGetBool(PTMP_tmp4_12))
    {
        ...
        *P_LVALUE_199 = PrtTupleGet(*P_VAR_payload_14, 1);
        ...
        PRT_VALUE** P_LVALUE_200 = &(PTMP_tmp3_12);
        PrtFreeValue(*P_LVALUE_200);
        *P_LVALUE_200 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp2_13, p_this->varValues[4]));
        
        PRT_VALUE** P_LVALUE_201 = &(PTMP_tmp4_12);
        PrtFreeValue(*P_LVALUE_201);
        *P_LVALUE_201 = PrtCloneValue(PTMP_tmp3_12);
    ...
    if (PrtPrimGetBool(PTMP_tmp4_12))
    {
        PRT_VALUE** P_LVALUE_202 = &(PTMP_tmp5_12);
        PrtFreeValue(*P_LVALUE_202);
        *P_LVALUE_202 = PrtTupleGet(*P_VAR_payload_14, 2);
        
        PRT_VALUE** P_LVALUE_203 = &(PTMP_tmp6_11);
        PrtFreeValue(*P_LVALUE_203);
        *P_LVALUE_203 = PrtCloneValue(PTMP_tmp5_12);
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_204 = &(PTMP_tmp0_17);
    PrtFreeValue(*P_LVALUE_204);
    *P_LVALUE_204 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_205 = &(PTMP_tmp1_16);
    PrtFreeValue(*P_LVALUE_205);
    *P_LVALUE_205 = PrtCloneValue((&P_EVENT_TRUSTEDeVote.value));
    
    PRT_VALUE** P_LVALUE_206 = &(PTMP_tmp2_14);
    ...
    *P_LVALUE_207 = PrtCloneValue(*P_VAR_vote);
    ...
    *P_LVALUE_208 = ((_P_GEN_funval = P_GetThis_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    PRT_VALUE** P_LVALUE_209 = &(PTMP_tmp5_13);
    PrtFreeValue(*P_LVALUE_209);
    *P_LVALUE_209 = (PrtMkTuple(&P_GEND_TYPE_T3iimachine_handle, &(PTMP_tmp2_14), &(PTMP_tmp3_13), &(PTMP_tmp4_13)));
...
PRT_VALUE* P_Anon_IMPL_21(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_210 = &(PTMP_tmp0_18);
    PrtFreeValue(*P_LVALUE_210);
    *P_LVALUE_210 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_211 = &(PTMP_tmp1_17);
    PrtFreeValue(*P_LVALUE_211);
    *P_LVALUE_211 = PrtCloneValue((&P_EVENT_TRUSTEDeGetElectionResults.value));
    
    PRT_VALUE** P_LVALUE_212 = &(PTMP_tmp2_15);
...
PRT_VALUE* P_Anon_IMPL_22(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_213 = &(PTMP_tmp0_19);
    PrtFreeValue(*P_LVALUE_213);
    *P_LVALUE_213 = PrtTupleGet(*P_VAR_payload_15, 0);
    
    PRT_VALUE** P_LVALUE_214 = &(PTMP_tmp1_18);
    PrtFreeValue(*P_LVALUE_214);
    *P_LVALUE_214 = PrtMkBoolValue(PrtMapExists(PTMP_tmp0_19, p_this->varValues[0]));;
    
    PRT_VALUE** P_LVALUE_215 = &(PTMP_tmp2_16);
    PrtFreeValue(*P_LVALUE_215);
    *P_LVALUE_215 = PrtMkBoolValue(!PrtPrimGetBool(PTMP_tmp1_18));
    ...
    else
    {
        ...
        *P_LVALUE_216 = PrtTupleGet(*P_VAR_payload_15, 0);
        
        PRT_VALUE** P_LVALUE_217 = &(PTMP_tmp4_14);
        PrtFreeValue(*P_LVALUE_217);
        *P_LVALUE_217 = PrtMapGet(PTMP_tmp3_14, p_this->varValues[0]);
    ...
    *P_LVALUE_218 = PrtTupleGet(*P_VAR_payload_15, 1);
...
PRT_VALUE* P_Anon_IMPL_23(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_219 = &(PTMP_tmp0_20);
