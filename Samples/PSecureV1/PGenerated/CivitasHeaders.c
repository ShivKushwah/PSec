...
PRT_VALUE* P_Anon_IMPL_1(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_15 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_17 = &(PTMP_tmp1_2);
    ...
    *P_LVALUE_17 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    
    {
        ...
        *P_LVALUE_18 = PTMP_tmp1_2;
        PTMP_tmp1_2 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_19 = &(PTMP_tmp2_2);
    PrtFreeValue(*P_LVALUE_19);
    *P_LVALUE_19 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_20 = &(PTMP_tmp3_2);
    PrtFreeValue(*P_LVALUE_20);
    *P_LVALUE_20 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionSecureBallotBoxMachine.value));
    ...
    *P_LVALUE_22 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    
    PRT_VALUE** P_LVALUE_23 = &(PTMP_tmp6_1);
    PrtFreeValue(*P_LVALUE_23);
    *P_LVALUE_23 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_machine_handle, &(PTMP_tmp4_1), &(PTMP_tmp5_1)));
    ...
    PRT_VALUE** P_LVALUE_24 = &(PTMP_tmp7);
    ...
    *P_LVALUE_25 = ((_P_GEN_funval = P_GenerateCredential1_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_26 = &(PTMP_tmp9);
    PrtFreeValue(*P_LVALUE_26);
    *P_LVALUE_26 = ((_P_GEN_funargs[0] = &(PTMP_tmp8)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8), PTMP_tmp8 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_27 = &(PTMP_tmp10);
    PrtFreeValue(*P_LVALUE_27);
    *P_LVALUE_27 = PrtCloneValue(PrtCastValue(PTMP_tmp9, &P_GEND_TYPE_secure_StringType));
    
    PrtSeqInsertEx(p_this->varValues[3], PTMP_tmp7, PTMP_tmp10, PRT_FALSE);
    *(&(PTMP_tmp10)) = NULL;
    
    PRT_VALUE** P_LVALUE_28 = &(PTMP_tmp11);
    PrtFreeValue(*P_LVALUE_28);
    *P_LVALUE_28 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[3]));
    
    PRT_VALUE** P_LVALUE_29 = &(PTMP_tmp12);
    PrtFreeValue(*P_LVALUE_29);
    *P_LVALUE_29 = ((_P_GEN_funval = P_GenerateCredential2_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp13);
    PrtFreeValue(*P_LVALUE_30);
    *P_LVALUE_30 = ((_P_GEN_funargs[0] = &(PTMP_tmp12)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp12), PTMP_tmp12 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_31 = PrtCloneValue(PrtCastValue(PTMP_tmp13, &P_GEND_TYPE_secure_StringType));
    ...
    *P_LVALUE_33 = PrtCloneValue((&P_EVENT_TRUSTEDeStartElection.value));
    
    PRT_VALUE** P_LVALUE_34 = &(PTMP_tmp17);
    PrtFreeValue(*P_LVALUE_34);
    *P_LVALUE_34 = PrtCloneValue((&P_LIT_INT32_1));
    
    PRT_VALUE** P_LVALUE_35 = &(PTMP_tmp18);
    PrtFreeValue(*P_LVALUE_35);
    *P_LVALUE_35 = ((_P_GEN_funargs[0] = &(PTMP_tmp17)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp17), PTMP_tmp17 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_2;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_36 = PrtCloneValue(PrtCastValue(PTMP_tmp18, &P_GEND_TYPE_s));
...
PRT_VALUE* P_Anon_IMPL_2(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_37 = &(PTMP_tmp0_3);
    ...
    *P_LVALUE_37 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    ...
    
    {
        ...
        *P_LVALUE_38 = PTMP_tmp0_3;
        PTMP_tmp0_3 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_39 = &(PTMP_tmp1_3);
    PrtFreeValue(*P_LVALUE_39);
    *P_LVALUE_39 = PrtCloneValue(P_VAR_secureVotingClientMachine);
    
    PRT_VALUE** P_LVALUE_40 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_40);
    *P_LVALUE_40 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionSecureVotingClientMachine.value));
    
    PRT_VALUE** P_LVALUE_41 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_41);
    *P_LVALUE_41 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_42 = &(PTMP_tmp4_2);
    PrtFreeValue(*P_LVALUE_42);
    *P_LVALUE_42 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_43 = &(PTMP_tmp5_2);
    PrtFreeValue(*P_LVALUE_43);
    *P_LVALUE_43 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_machine_handle_1, &(PTMP_tmp3_3), &(PTMP_tmp4_2)));
    ...
    PRT_VALUE** P_LVALUE_44 = &(PTMP_tmp6_2);
    PrtFreeValue(*P_LVALUE_44);
    *P_LVALUE_44 = PrtCloneValue(*P_VAR_requestingMachine);
    
    PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp7_1);
    PrtFreeValue(*P_LVALUE_45);
    *P_LVALUE_45 = PrtCloneValue((&P_EVENT_UNTRUSTEDReceiveVotingSSM.value));
    
    PRT_VALUE** P_LVALUE_46 = &(PTMP_tmp8_1);
    PrtFreeValue(*P_LVALUE_46);
    *P_LVALUE_46 = PrtCloneValue(P_VAR_secureVotingClientMachine);
    
    PRT_VALUE** P_LVALUE_47 = &(PTMP_tmp9_1);
    PrtFreeValue(*P_LVALUE_47);
    *P_LVALUE_47 = ((_P_GEN_funargs[0] = &(PTMP_tmp8_1)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8_1), PTMP_tmp8_1 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_3;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_48 = &(PTMP_tmp10_1);
    PrtFreeValue(*P_LVALUE_48);
    *P_LVALUE_48 = PrtCloneValue(PrtCastValue(PTMP_tmp9_1, &P_GEND_TYPE_machine_handle));
...
PRT_VALUE* P_Anon_IMPL_3(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_49 = &(P_VAR_i_1);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = PrtCloneValue((&P_LIT_INT32_3));
    
    PRT_VALUE** P_LVALUE_50 = &(P_VAR_found);
    PrtFreeValue(*P_LVALUE_50);
    *P_LVALUE_50 = PrtCloneValue((&P_LIT_BOOLEAN));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_1)))
    {
        PRT_VALUE** P_LVALUE_51 = &(PTMP_tmp0_4);
        PrtFreeValue(*P_LVALUE_51);
        *P_LVALUE_51 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[3]));
        
        PRT_VALUE** P_LVALUE_52 = &(PTMP_tmp1_4);
        PrtFreeValue(*P_LVALUE_52);
        *P_LVALUE_52 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_1) < PrtPrimGetInt(PTMP_tmp0_4));
        
        PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp2_4);
        PrtFreeValue(*P_LVALUE_53);
        *P_LVALUE_53 = PrtCloneValue(PTMP_tmp1_4);
        ...
        PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp3_4);
        PrtFreeValue(*P_LVALUE_54);
        *P_LVALUE_54 = PrtSeqGet(p_this->varValues[3], P_VAR_i_1);
        
        PRT_VALUE** P_LVALUE_55 = &(PTMP_tmp4_3);
        PrtFreeValue(*P_LVALUE_55);
        *P_LVALUE_55 = ((_P_GEN_funargs[0] = &(PTMP_tmp3_4)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp3_4), PTMP_tmp3_4 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_4;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_56 = &(PTMP_tmp5_3);
        PrtFreeValue(*P_LVALUE_56);
        *P_LVALUE_56 = PrtCloneValue(PrtCastValue(PTMP_tmp4_3, &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp6_3);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PrtTupleGet(*P_VAR_payload, 1);
        
        PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp7_2);
        PrtFreeValue(*P_LVALUE_58);
        *P_LVALUE_58 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_3)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_3), PTMP_tmp6_3 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_4;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp8_2);
        PrtFreeValue(*P_LVALUE_59);
        *P_LVALUE_59 = PrtCloneValue(PrtCastValue(PTMP_tmp7_2, &P_GEND_TYPE_StringType));
        
        PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp9_2);
        PrtFreeValue(*P_LVALUE_60);
        *P_LVALUE_60 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp5_3, PTMP_tmp8_2));
        
        if (PrtPrimGetBool(PTMP_tmp9_2))
        {
            PRT_VALUE** P_LVALUE_61 = &(P_VAR_found);
            PrtFreeValue(*P_LVALUE_61);
            *P_LVALUE_61 = PrtCloneValue((&P_LIT_BOOLEAN_1));
        ...
        PRT_VALUE** P_LVALUE_62 = &(PTMP_tmp10_2);
        PrtFreeValue(*P_LVALUE_62);
        *P_LVALUE_62 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_1) + PrtPrimGetInt((&P_LIT_INT32_4)));
        
        {
            PRT_VALUE** P_LVALUE_63 = &(P_VAR_i_1);
            PrtFreeValue(*P_LVALUE_63);
            *P_LVALUE_63 = PTMP_tmp10_2;
            PTMP_tmp10_2 = NULL;
        }
    ...
    {
        PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp11_1);
        PrtFreeValue(*P_LVALUE_64);
        *P_LVALUE_64 = PrtTupleGet(*P_VAR_payload, 0);
        
        PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp12_1);
        PrtFreeValue(*P_LVALUE_65);
        *P_LVALUE_65 = PrtCloneValue(PTMP_tmp11_1);
        
        PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp13_1);
        PrtFreeValue(*P_LVALUE_66);
        *P_LVALUE_66 = PrtCloneValue((&P_EVENT_TRUSTEDValidCredential.value));
    ...
    {
        PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp14_1);
        PrtFreeValue(*P_LVALUE_67);
        *P_LVALUE_67 = PrtTupleGet(*P_VAR_payload, 0);
        
        PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp15_1);
        PrtFreeValue(*P_LVALUE_68);
        *P_LVALUE_68 = PrtCloneValue(PTMP_tmp14_1);
        
        PRT_VALUE** P_LVALUE_69 = &(PTMP_tmp16_1);
        PrtFreeValue(*P_LVALUE_69);
        *P_LVALUE_69 = PrtCloneValue((&P_EVENT_TRUSTEDInvalidCredential.value));
...
PRT_VALUE* P_Anon_IMPL_4(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_70 = &(PTMP_tmp0_5);
    ...
    *P_LVALUE_72 = PrtTupleGet(*P_VAR_payload_1, 1);
    
    {
        ...
        *P_LVALUE_73 = PTMP_tmp1_5;
        PTMP_tmp1_5 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_74);
    *P_LVALUE_74 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_75 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_75);
    *P_LVALUE_75 = PrtCloneValue((&P_EVENT_UNTRUSTEDGetVotingSSM.value));
    
    PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_76);
    *P_LVALUE_76 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_77 = PrtCloneValue(*P_VAR_payload_2);
    
    PRT_VALUE** P_LVALUE_78 = &(p_this->varValues[3]);
    PrtFreeValue(*P_LVALUE_78);
    *P_LVALUE_78 = PrtCloneValue((&P_LIT_INT32_6));
    
    PRT_VALUE** P_LVALUE_79 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_79);
    *P_LVALUE_79 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_80 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_80);
    *P_LVALUE_80 = PrtCloneValue((&P_EVENT_UNTRUSTEDVoteRequest.value));
    ...
    *P_LVALUE_82 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_83 = &(PTMP_tmp4_5);
    ...
    *P_LVALUE_84 = (PrtMkTuple(&P_GEND_TYPE_T3StringTypeimachine_handle, &(PTMP_tmp2_6), &(PTMP_tmp3_6), &(PTMP_tmp4_5)));
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_85 = &(PTMP_tmp0_7);
    PrtFreeValue(*P_LVALUE_85);
    *P_LVALUE_85 = PrtTupleGet(*P_VAR_payload_3, 1);
    ...
    PRT_VALUE** P_LVALUE_86 = &(PTMP_tmp1_7);
    PrtFreeValue(*P_LVALUE_86);
    *P_LVALUE_86 = PrtTupleGet(*P_VAR_payload_3, 0);
...
PRT_VALUE* P_Anon_IMPL_7(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_87 = &(p_this->varValues[0]);
    PrtFreeValue(*P_LVALUE_87);
    *P_LVALUE_87 = PrtCloneValue(*P_VAR_payload_4);
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_88 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_88);
    *P_LVALUE_88 = PrtMapGetKeys(p_this->varValues[0]);
    
    {
        PRT_VALUE** P_LVALUE_89 = &(P_VAR_electionResultsKeys);
        PrtFreeValue(*P_LVALUE_89);
        *P_LVALUE_89 = PTMP_tmp0_8;
        PTMP_tmp0_8 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_90 = &(P_VAR_i_2);
    PrtFreeValue(*P_LVALUE_90);
    *P_LVALUE_90 = PrtCloneValue((&P_LIT_INT32_7));
    
    PRT_VALUE** P_LVALUE_91 = &(PTMP_tmp1_8);
    PrtFreeValue(*P_LVALUE_91);
    *P_LVALUE_91 = PrtCloneValue((&P_LIT_INT32_7));
    
    PRT_VALUE** P_LVALUE_92 = &(PTMP_tmp2_7);
    PrtFreeValue(*P_LVALUE_92);
    *P_LVALUE_92 = ((_P_GEN_funargs[0] = &(PTMP_tmp1_8)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp1_8), PTMP_tmp1_8 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_9;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_93 = PrtCloneValue(PrtCastValue(PTMP_tmp2_7, &P_GEND_TYPE_s));
    
    {
        PRT_VALUE** P_LVALUE_94 = &(P_VAR_countCandidate0);
        PrtFreeValue(*P_LVALUE_94);
        *P_LVALUE_94 = PTMP_tmp3_7;
        PTMP_tmp3_7 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_95 = &(PTMP_tmp4_6);
    PrtFreeValue(*P_LVALUE_95);
    *P_LVALUE_95 = PrtCloneValue((&P_LIT_INT32_7));
    
    PRT_VALUE** P_LVALUE_96 = &(PTMP_tmp5_5);
    PrtFreeValue(*P_LVALUE_96);
    *P_LVALUE_96 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_6)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_6), PTMP_tmp4_6 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_9;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_97 = &(PTMP_tmp6_4);
    PrtFreeValue(*P_LVALUE_97);
    *P_LVALUE_97 = PrtCloneValue(PrtCastValue(PTMP_tmp5_5, &P_GEND_TYPE_s));
    
    {
        PRT_VALUE** P_LVALUE_98 = &(P_VAR_countCandidate1);
        PrtFreeValue(*P_LVALUE_98);
        *P_LVALUE_98 = PTMP_tmp6_4;
        PTMP_tmp6_4 = NULL;
    }
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_2)))
    {
        PRT_VALUE** P_LVALUE_99 = &(PTMP_tmp7_3);
        PrtFreeValue(*P_LVALUE_99);
        *P_LVALUE_99 = PrtMkIntValue(PrtSeqSizeOf(P_VAR_electionResultsKeys));
        
        PRT_VALUE** P_LVALUE_100 = &(PTMP_tmp8_3);
        PrtFreeValue(*P_LVALUE_100);
        *P_LVALUE_100 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_2) < PrtPrimGetInt(PTMP_tmp7_3));
        
        PRT_VALUE** P_LVALUE_101 = &(PTMP_tmp9_3);
        PrtFreeValue(*P_LVALUE_101);
        *P_LVALUE_101 = PrtCloneValue(PTMP_tmp8_3);
        ...
        PRT_VALUE** P_LVALUE_102 = &(PTMP_tmp10_3);
        PrtFreeValue(*P_LVALUE_102);
        *P_LVALUE_102 = PrtSeqGet(P_VAR_electionResultsKeys, P_VAR_i_2);
        
        PRT_VALUE** P_LVALUE_103 = &(PTMP_tmp11_2);
        PrtFreeValue(*P_LVALUE_103);
        *P_LVALUE_103 = PrtMapGet(p_this->varValues[0], PTMP_tmp10_3);
        
        PRT_VALUE** P_LVALUE_104 = &(PTMP_tmp12_2);
        PrtFreeValue(*P_LVALUE_104);
        *P_LVALUE_104 = ((_P_GEN_funargs[0] = &(PTMP_tmp11_2)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp11_2), PTMP_tmp11_2 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_9;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_105 = &(PTMP_tmp13_2);
        PrtFreeValue(*P_LVALUE_105);
        *P_LVALUE_105 = PrtCloneValue(PrtCastValue(PTMP_tmp12_2, &P_GEND_TYPE_i));
        
        PRT_VALUE** P_LVALUE_106 = &(PTMP_tmp14_2);
        PrtFreeValue(*P_LVALUE_106);
        *P_LVALUE_106 = PrtMkBoolValue(PrtIsEqualValue(PTMP_tmp13_2, (&P_LIT_INT32_7)));
        
        if (PrtPrimGetBool(PTMP_tmp14_2))
        {
            PRT_VALUE** P_LVALUE_107 = &(PTMP_tmp15_2);
            PrtFreeValue(*P_LVALUE_107);
            *P_LVALUE_107 = PrtCloneValue((&P_LIT_INT32_8));
            
            PRT_VALUE** P_LVALUE_108 = &(PTMP_tmp16_2);
            PrtFreeValue(*P_LVALUE_108);
            *P_LVALUE_108 = ((_P_GEN_funargs[0] = &(PTMP_tmp15_2)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp15_2), PTMP_tmp15_2 = NULL), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_9;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            PRT_VALUE** P_LVALUE_109 = &(PTMP_tmp17_1);
            PrtFreeValue(*P_LVALUE_109);
            *P_LVALUE_109 = PrtCloneValue(PrtCastValue(PTMP_tmp16_2, &P_GEND_TYPE_s));
            
            PRT_VALUE** P_LVALUE_110 = &(PTMP_tmp18_1);
            PrtFreeValue(*P_LVALUE_110);
            *P_LVALUE_110 = PrtMkSecureIntValue(PrtPrimGetSecureInt(P_VAR_countCandidate0) + PrtPrimGetSecureInt(PTMP_tmp17_1));
            
            {
                PRT_VALUE** P_LVALUE_111 = &(P_VAR_countCandidate0);
                PrtFreeValue(*P_LVALUE_111);
                *P_LVALUE_111 = PTMP_tmp18_1;
                PTMP_tmp18_1 = NULL;
            }
        ...
        {
            PRT_VALUE** P_LVALUE_112 = &(PTMP_tmp19_1);
            PrtFreeValue(*P_LVALUE_112);
            *P_LVALUE_112 = PrtCloneValue((&P_LIT_INT32_8));
            
            PRT_VALUE** P_LVALUE_113 = &(PTMP_tmp20);
            PrtFreeValue(*P_LVALUE_113);
            *P_LVALUE_113 = ((_P_GEN_funargs[0] = &(PTMP_tmp19_1)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp19_1), PTMP_tmp19_1 = NULL), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_9;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            PRT_VALUE** P_LVALUE_114 = &(PTMP_tmp21);
            PrtFreeValue(*P_LVALUE_114);
            *P_LVALUE_114 = PrtCloneValue(PrtCastValue(PTMP_tmp20, &P_GEND_TYPE_s));
            
            PRT_VALUE** P_LVALUE_115 = &(PTMP_tmp22);
            PrtFreeValue(*P_LVALUE_115);
            *P_LVALUE_115 = PrtMkSecureIntValue(PrtPrimGetSecureInt(P_VAR_countCandidate1) + PrtPrimGetSecureInt(PTMP_tmp21));
            
            {
                PRT_VALUE** P_LVALUE_116 = &(P_VAR_countCandidate1);
                PrtFreeValue(*P_LVALUE_116);
                *P_LVALUE_116 = PTMP_tmp22;
                PTMP_tmp22 = NULL;
            }
        ...
        PRT_VALUE** P_LVALUE_117 = &(PTMP_tmp23);
        PrtFreeValue(*P_LVALUE_117);
        *P_LVALUE_117 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_2) + PrtPrimGetInt((&P_LIT_INT32_8)));
        
        {
            PRT_VALUE** P_LVALUE_118 = &(P_VAR_i_2);
            PrtFreeValue(*P_LVALUE_118);
            *P_LVALUE_118 = PTMP_tmp23;
            PTMP_tmp23 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_119 = &(PTMP_tmp24);
    PrtFreeValue(*P_LVALUE_119);
    *P_LVALUE_119 = PrtMkSecureBoolValue(PrtPrimGetSecureInt(P_VAR_countCandidate0) > PrtPrimGetSecureInt(P_VAR_countCandidate1));
    
    if (PrtPrimGetBool(PTMP_tmp24))
    {
        PRT_VALUE** P_LVALUE_120 = &(PTMP_tmp25);
        PrtFreeValue(*P_LVALUE_120);
        *P_LVALUE_120 = PrtCloneValue((&P_LIT_INT32_7));
        
        PRT_VALUE** P_LVALUE_121 = &(PTMP_tmp26);
        PrtFreeValue(*P_LVALUE_121);
        *P_LVALUE_121 = ((_P_GEN_funargs[0] = &(PTMP_tmp25)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp25), PTMP_tmp25 = NULL), (_P_GEN_funval));
        if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
            goto p_return_9;
        }
        if (p_this->isHalted == PRT_TRUE) {
        ...
        PRT_VALUE** P_LVALUE_122 = &(PTMP_tmp27);
        PrtFreeValue(*P_LVALUE_122);
        *P_LVALUE_122 = PrtCloneValue(PrtCastValue(PTMP_tmp26, &P_GEND_TYPE_s));
        
        {
            PRT_VALUE** P_LVALUE_123 = &(P_VAR_winner);
            PrtFreeValue(*P_LVALUE_123);
            *P_LVALUE_123 = PTMP_tmp27;
            PTMP_tmp27 = NULL;
        }
    ...
    {
        PRT_VALUE** P_LVALUE_124 = &(PTMP_tmp28);
        PrtFreeValue(*P_LVALUE_124);
        *P_LVALUE_124 = PrtMkSecureBoolValue(PrtPrimGetSecureInt(P_VAR_countCandidate1) > PrtPrimGetSecureInt(P_VAR_countCandidate0));
        
        if (PrtPrimGetBool(PTMP_tmp28))
        {
            PRT_VALUE** P_LVALUE_125 = &(PTMP_tmp29);
            PrtFreeValue(*P_LVALUE_125);
            *P_LVALUE_125 = PrtCloneValue((&P_LIT_INT32_8));
            
            PRT_VALUE** P_LVALUE_126 = &(PTMP_tmp30);
            PrtFreeValue(*P_LVALUE_126);
            *P_LVALUE_126 = ((_P_GEN_funargs[0] = &(PTMP_tmp29)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp29), PTMP_tmp29 = NULL), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_9;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            PRT_VALUE** P_LVALUE_127 = &(PTMP_tmp31);
            PrtFreeValue(*P_LVALUE_127);
            *P_LVALUE_127 = PrtCloneValue(PrtCastValue(PTMP_tmp30, &P_GEND_TYPE_s));
            
            {
                PRT_VALUE** P_LVALUE_128 = &(P_VAR_winner);
                PrtFreeValue(*P_LVALUE_128);
                *P_LVALUE_128 = PTMP_tmp31;
                PTMP_tmp31 = NULL;
            }
        ...
        {
            PRT_VALUE** P_LVALUE_129 = &(PTMP_tmp32);
            PrtFreeValue(*P_LVALUE_129);
            *P_LVALUE_129 = PrtCloneValue((&P_LIT_INT32_9));
            
            PRT_VALUE** P_LVALUE_130 = &(PTMP_tmp33);
            PrtFreeValue(*P_LVALUE_130);
            *P_LVALUE_130 = ((_P_GEN_funargs[0] = &(PTMP_tmp32)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp32), PTMP_tmp32 = NULL), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_9;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            PRT_VALUE** P_LVALUE_131 = &(PTMP_tmp34);
            PrtFreeValue(*P_LVALUE_131);
            *P_LVALUE_131 = PrtCloneValue(PrtCastValue(PTMP_tmp33, &P_GEND_TYPE_s));
            
            {
                PRT_VALUE** P_LVALUE_132 = &(P_VAR_winner);
                PrtFreeValue(*P_LVALUE_132);
                *P_LVALUE_132 = PTMP_tmp34;
                PTMP_tmp34 = NULL;
            }
    ...
    PRT_VALUE** P_LVALUE_133 = &(PTMP_tmp35);
    PrtFreeValue(*P_LVALUE_133);
    *P_LVALUE_133 = PrtCloneValue(*P_VAR_requestingMachine_1);
    
    PRT_VALUE** P_LVALUE_134 = &(PTMP_tmp36);
    PrtFreeValue(*P_LVALUE_134);
    *P_LVALUE_134 = PrtCloneValue((&P_EVENT_TRUSTEDeRespElectionResults.value));
    
    PRT_VALUE** P_LVALUE_135 = &(PTMP_tmp37);
    PrtFreeValue(*P_LVALUE_135);
    *P_LVALUE_135 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_136 = &(PTMP_tmp38);
    PrtFreeValue(*P_LVALUE_136);
    *P_LVALUE_136 = PrtCloneValue(P_VAR_winner);
    
    PRT_VALUE** P_LVALUE_137 = &(PTMP_tmp39);
    PrtFreeValue(*P_LVALUE_137);
    *P_LVALUE_137 = (PrtMkTuple(&P_GEND_TYPE_T2MKsecure_StringTypeVss, &(PTMP_tmp37), &(PTMP_tmp38)));
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_138 = PrtTupleGet(*P_VAR_payload_5, 0);
    
    {
        PRT_VALUE** P_LVALUE_139 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_139);
        *P_LVALUE_139 = PTMP_tmp0_9;
        PTMP_tmp0_9 = NULL;
    }
    ...
    PRT_VALUE** P_LVALUE_140 = &(PTMP_tmp1_9);
    PrtFreeValue(*P_LVALUE_140);
    *P_LVALUE_140 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    {
        PRT_VALUE** P_LVALUE_141 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_141);
        *P_LVALUE_141 = PTMP_tmp1_9;
        PTMP_tmp1_9 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_142 = &(PTMP_tmp2_8);
    ...
    *P_LVALUE_143 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionSecureTamperEvidentLogMachine.value));
    
    PRT_VALUE** P_LVALUE_144 = &(PTMP_tmp4_7);
    PrtFreeValue(*P_LVALUE_144);
    *P_LVALUE_144 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    ...
    *P_LVALUE_145 = ((_P_GEN_funval = P_CreateSecureMachineRequest_IMPL(context, _P_GEN_funargs)), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_147 = &(PTMP_tmp6_5);
    PrtFreeValue(*P_LVALUE_147);
    *P_LVALUE_147 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_148 = &(PTMP_tmp7_4);
    PrtFreeValue(*P_LVALUE_148);
    *P_LVALUE_148 = PrtCloneValue((&P_EVENT_TRUSTEDProvisionSecureTabulationTellerMachine.value));
    
    PRT_VALUE** P_LVALUE_149 = &(PTMP_tmp8_4);
    PrtFreeValue(*P_LVALUE_149);
    *P_LVALUE_149 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_150 = &(PTMP_tmp9_4);
    PrtFreeValue(*P_LVALUE_150);
    *P_LVALUE_150 = PrtTupleGet(*P_VAR_payload_5, 1);
    
    PRT_VALUE** P_LVALUE_151 = &(PTMP_tmp10_4);
    PrtFreeValue(*P_LVALUE_151);
    *P_LVALUE_151 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_machine_handle, &(PTMP_tmp8_4), &(PTMP_tmp9_4)));
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_152 = &(PTMP_tmp0_10);
    PrtFreeValue(*P_LVALUE_152);
    *P_LVALUE_152 = PrtCloneValue(*P_VAR_payload_6);
    
    PRT_VALUE** P_LVALUE_153 = &(PTMP_tmp1_10);
    PrtFreeValue(*P_LVALUE_153);
    *P_LVALUE_153 = ((_P_GEN_funargs[0] = &(PTMP_tmp0_10)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp0_10), PTMP_tmp0_10 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_11;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_154 = &(PTMP_tmp2_9);
    PrtFreeValue(*P_LVALUE_154);
    *P_LVALUE_154 = PrtCloneValue(PrtCastValue(PTMP_tmp1_10, &P_GEND_TYPE_i));
    
    {
        PRT_VALUE** P_LVALUE_155 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_155);
        *P_LVALUE_155 = PTMP_tmp2_9;
        PTMP_tmp2_9 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_156 = &(p_this->varValues[4]);
    PrtFreeValue(*P_LVALUE_156);
    *P_LVALUE_156 = PrtCloneValue((&P_LIT_INT32_11));
...
PRT_VALUE* P_Anon_IMPL_11(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_157 = &(PTMP_tmp0_11);
    PrtFreeValue(*P_LVALUE_157);
    *P_LVALUE_157 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_158 = &(PTMP_tmp1_11);
    PrtFreeValue(*P_LVALUE_158);
    *P_LVALUE_158 = PrtCloneValue((&P_EVENT_TRUSTEDeAddItem.value));
    
    PRT_VALUE** P_LVALUE_159 = &(PTMP_tmp2_10);
    PrtFreeValue(*P_LVALUE_159);
    *P_LVALUE_159 = PrtTupleGet(*P_VAR_payload_7, 0);
    
    PRT_VALUE** P_LVALUE_160 = &(PTMP_tmp3_9);
    PrtFreeValue(*P_LVALUE_160);
    *P_LVALUE_160 = PrtTupleGet(*P_VAR_payload_7, 1);
    
    PRT_VALUE** P_LVALUE_161 = &(PTMP_tmp4_8);
    PrtFreeValue(*P_LVALUE_161);
    *P_LVALUE_161 = (PrtMkTuple(&P_GEND_TYPE_T2secure_StringTypes, &(PTMP_tmp2_10), &(PTMP_tmp3_9)));
    ...
    switch (P_eventId) {
        case 2: {
            ...
            PRT_VALUE P_LIT_INT32_14 = { PRT_VALUE_KIND_INT, { .nt = 1 } };
                        PRT_VALUE** P_LVALUE_162 = &(PTMP_tmp5_7);
            PrtFreeValue(*P_LVALUE_162);
            *P_LVALUE_162 = PrtCloneValue(*P_VAR_result);
            
            PRT_VALUE** P_LVALUE_163 = &(PTMP_tmp6_6);
            PrtFreeValue(*P_LVALUE_163);
            *P_LVALUE_163 = ((_P_GEN_funargs[0] = &(PTMP_tmp5_7)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp5_7), PTMP_tmp5_7 = NULL), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_12;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            PRT_VALUE** P_LVALUE_164 = &(PTMP_tmp7_5);
            PrtFreeValue(*P_LVALUE_164);
            *P_LVALUE_164 = PrtCloneValue(PrtCastValue(PTMP_tmp6_6, &P_GEND_TYPE_b));
            
            if (PrtPrimGetBool(PTMP_tmp7_5))
            {
                PRT_VALUE** P_LVALUE_165 = &(PTMP_tmp8_5);
                PrtFreeValue(*P_LVALUE_165);
                *P_LVALUE_165 = PrtTupleGet(*P_VAR_payload_7, 2);
                
                PRT_VALUE** P_LVALUE_166 = &(PTMP_tmp9_5);
                PrtFreeValue(*P_LVALUE_166);
                *P_LVALUE_166 = PrtCloneValue(PTMP_tmp8_5);
                
                PRT_VALUE** P_LVALUE_167 = &(PTMP_tmp10_5);
                PrtFreeValue(*P_LVALUE_167);
                *P_LVALUE_167 = PrtCloneValue((&P_EVENT_TRUSTEDeRespConfirmVote.value));
                ...
                PRT_VALUE** P_LVALUE_168 = &(PTMP_tmp11_3);
                PrtFreeValue(*P_LVALUE_168);
                *P_LVALUE_168 = PrtMkIntValue(PrtPrimGetInt(p_this->varValues[4]) + PrtPrimGetInt((&P_LIT_INT32_14)));
                
                {
                    PRT_VALUE** P_LVALUE_169 = &(p_this->varValues[4]);
                    PrtFreeValue(*P_LVALUE_169);
                    *P_LVALUE_169 = PTMP_tmp11_3;
                    PTMP_tmp11_3 = NULL;
                }
    ...
    PRT_VALUE** P_LVALUE_170 = &(PTMP_tmp12_3);
    PrtFreeValue(*P_LVALUE_170);
    *P_LVALUE_170 = PrtMkBoolValue(PrtPrimGetInt(p_this->varValues[4]) >= PrtPrimGetInt(p_this->varValues[3]));
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_171 = &(PTMP_tmp0_12);
    PrtFreeValue(*P_LVALUE_171);
    *P_LVALUE_171 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_172 = &(PTMP_tmp1_12);
    PrtFreeValue(*P_LVALUE_172);
    *P_LVALUE_172 = PrtCloneValue((&P_EVENT_TRUSTEDeGetLog.value));
    ...
    switch (P_eventId_1) {
        case 3: {
            ...
            PRT_VALUE** P_LVALUE_173 = &(PTMP_tmp2_11);
            PrtFreeValue(*P_LVALUE_173);
            *P_LVALUE_173 = PrtCloneValue(p_this->varValues[1]);
            
            PRT_VALUE** P_LVALUE_174 = &(PTMP_tmp3_10);
            PrtFreeValue(*P_LVALUE_174);
            *P_LVALUE_174 = PrtCloneValue((&P_EVENT_TRUSTEDeAllVotes.value));
            
            PRT_VALUE** P_LVALUE_175 = &(PTMP_tmp4_9);
            PrtFreeValue(*P_LVALUE_175);
            *P_LVALUE_175 = PrtCloneValue((&P_LIT_INT32_16));
            
            PRT_VALUE** P_LVALUE_176 = &(PTMP_tmp5_8);
            PrtFreeValue(*P_LVALUE_176);
            *P_LVALUE_176 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_9)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_9), PTMP_tmp4_9 = NULL), (_P_GEN_funval));
            if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
                goto p_return_14;
            }
            if (p_this->isHalted == PRT_TRUE) {
            ...
            PRT_VALUE** P_LVALUE_177 = &(PTMP_tmp6_7);
            PrtFreeValue(*P_LVALUE_177);
            *P_LVALUE_177 = PrtCloneValue(PrtCastValue(PTMP_tmp5_8, &P_GEND_TYPE_s));
            
            PRT_VALUE** P_LVALUE_178 = &(PTMP_tmp7_6);
            PrtFreeValue(*P_LVALUE_178);
            *P_LVALUE_178 = PrtCloneValue(*P_VAR_payload_8);
            
            PRT_VALUE** P_LVALUE_179 = &(PTMP_tmp8_6);
            PrtFreeValue(*P_LVALUE_179);
            *P_LVALUE_179 = (PrtMkTuple(&P_GEND_TYPE_T2sST2secure_StringTypes, &(PTMP_tmp6_7), &(PTMP_tmp7_6)));
...
PRT_VALUE* P_Anon_IMPL_13(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_180 = &(p_this->varValues[1]);
    PrtFreeValue(*P_LVALUE_180);
    *P_LVALUE_180 = PrtCloneValue(*P_VAR_payload_9);
...
PRT_VALUE* P_Anon_IMPL_14(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_181 = &(PTMP_tmp0_13);
    PrtFreeValue(*P_LVALUE_181);
    *P_LVALUE_181 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[0]));
    
    PRT_VALUE** P_LVALUE_182 = &(PTMP_tmp1_13);
    PrtFreeValue(*P_LVALUE_182);
    *P_LVALUE_182 = PrtTupleGet(*P_VAR_payload_10, 0);
    
    PRT_VALUE** P_LVALUE_183 = &(PTMP_tmp2_12);
    PrtFreeValue(*P_LVALUE_183);
    *P_LVALUE_183 = PrtTupleGet(*P_VAR_payload_10, 1);
    
    PRT_VALUE** P_LVALUE_184 = &(PTMP_tmp3_11);
    PrtFreeValue(*P_LVALUE_184);
    *P_LVALUE_184 = (PrtMkTuple(&P_GEND_TYPE_T2secure_StringTypes, &(PTMP_tmp1_13), &(PTMP_tmp2_12)));
    
    PrtSeqInsertEx(p_this->varValues[0], PTMP_tmp0_13, PTMP_tmp3_11, PRT_FALSE);
    *(&(PTMP_tmp3_11)) = NULL;
    
    PRT_VALUE** P_LVALUE_185 = &(PTMP_tmp4_10);
    PrtFreeValue(*P_LVALUE_185);
    *P_LVALUE_185 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_186 = &(PTMP_tmp5_9);
    PrtFreeValue(*P_LVALUE_186);
    *P_LVALUE_186 = PrtCloneValue((&P_EVENT_TRUSTEDeRespAddItem.value));
    
    PRT_VALUE** P_LVALUE_187 = &(PTMP_tmp6_8);
    PrtFreeValue(*P_LVALUE_187);
    *P_LVALUE_187 = PrtCloneValue((&P_LIT_BOOLEAN_3));
    
    PRT_VALUE** P_LVALUE_188 = &(PTMP_tmp7_7);
    PrtFreeValue(*P_LVALUE_188);
    *P_LVALUE_188 = ((_P_GEN_funargs[0] = &(PTMP_tmp6_8)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp6_8), PTMP_tmp6_8 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_17;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_189 = &(PTMP_tmp8_7);
    PrtFreeValue(*P_LVALUE_189);
    *P_LVALUE_189 = PrtCloneValue(PrtCastValue(PTMP_tmp7_7, &P_GEND_TYPE_sb));
...
PRT_VALUE* P_Anon_IMPL_15(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_190 = &(PTMP_tmp0_14);
    PrtFreeValue(*P_LVALUE_190);
    *P_LVALUE_190 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_191 = &(PTMP_tmp1_14);
    PrtFreeValue(*P_LVALUE_191);
    *P_LVALUE_191 = PrtCloneValue((&P_EVENT_TRUSTEDeRespGetLog.value));
    
    PRT_VALUE** P_LVALUE_192 = &(PTMP_tmp2_13);
    PrtFreeValue(*P_LVALUE_192);
    *P_LVALUE_192 = PrtCloneValue(p_this->varValues[0]);
...
PRT_VALUE* P_Anon_IMPL_16(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_193 = PrtTupleGet(*P_VAR_payload_11, 0);
    
    {
        PRT_VALUE** P_LVALUE_194 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_194);
        *P_LVALUE_194 = PTMP_tmp0_15;
        PTMP_tmp0_15 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_195 = &(PTMP_tmp1_15);
    PrtFreeValue(*P_LVALUE_195);
    *P_LVALUE_195 = PrtTupleGet(*P_VAR_payload_11, 1);
    
    {
        PRT_VALUE** P_LVALUE_196 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_196);
        *P_LVALUE_196 = PTMP_tmp1_15;
        PTMP_tmp1_15 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_17(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_197 = &(PTMP_tmp0_16);
    PrtFreeValue(*P_LVALUE_197);
    *P_LVALUE_197 = PrtTupleGet(*P_VAR_payload_12, 1);
    
    {
        PRT_VALUE** P_LVALUE_198 = &(p_this->varValues[2]);
        PrtFreeValue(*P_LVALUE_198);
        *P_LVALUE_198 = PTMP_tmp0_16;
        PTMP_tmp0_16 = NULL;
    }
...
PRT_VALUE* P_Anon_IMPL_18(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_199 = &(P_VAR_i_3);
    PrtFreeValue(*P_LVALUE_199);
    *P_LVALUE_199 = PrtCloneValue((&P_LIT_INT32_20));
    
    while (PrtPrimGetBool((&P_LIT_BOOLEAN_4)))
    {
        PRT_VALUE** P_LVALUE_200 = &(PTMP_tmp0_17);
        PrtFreeValue(*P_LVALUE_200);
        *P_LVALUE_200 = PrtMkIntValue(PrtSeqSizeOf(p_this->varValues[2]));
        
        PRT_VALUE** P_LVALUE_201 = &(PTMP_tmp1_16);
        PrtFreeValue(*P_LVALUE_201);
        *P_LVALUE_201 = PrtMkBoolValue(PrtPrimGetInt(P_VAR_i_3) < PrtPrimGetInt(PTMP_tmp0_17));
        
        PRT_VALUE** P_LVALUE_202 = &(PTMP_tmp2_14);
        PrtFreeValue(*P_LVALUE_202);
        *P_LVALUE_202 = PrtCloneValue(PTMP_tmp1_16);
        ...
        *P_LVALUE_203 = PrtCloneValue(p_this->varValues[1]);
        
        PRT_VALUE** P_LVALUE_204 = &(PTMP_tmp4_11);
        PrtFreeValue(*P_LVALUE_204);
        *P_LVALUE_204 = PrtCloneValue((&P_EVENT_TRUSTEDValidateCredential.value));
        
        PRT_VALUE** P_LVALUE_205 = &(PTMP_tmp5_10);
        PrtFreeValue(*P_LVALUE_205);
        *P_LVALUE_205 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
        
        PRT_VALUE** P_LVALUE_206 = &(PTMP_tmp6_9);
        PrtFreeValue(*P_LVALUE_206);
        *P_LVALUE_206 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
        
        PRT_VALUE** P_LVALUE_207 = &(PTMP_tmp7_8);
        PrtFreeValue(*P_LVALUE_207);
        *P_LVALUE_207 = PrtTupleGet(PTMP_tmp6_9, 0);
        
        PRT_VALUE** P_LVALUE_208 = &(PTMP_tmp8_8);
        PrtFreeValue(*P_LVALUE_208);
        *P_LVALUE_208 = (PrtMkTuple(&P_GEND_TYPE_T2secure_machine_handlesecure_StringType, &(PTMP_tmp5_10), &(PTMP_tmp7_8)));
        ...
        switch (P_eventId_2) {
            case 4: {
                                PRT_VALUE** P_LVALUE_209 = &(PTMP_tmp9_6);
                PrtFreeValue(*P_LVALUE_209);
                *P_LVALUE_209 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
                
                PRT_VALUE** P_LVALUE_210 = &(PTMP_tmp10_6);
                PrtFreeValue(*P_LVALUE_210);
                *P_LVALUE_210 = PrtTupleGet(PTMP_tmp9_6, 0);
                
                PRT_VALUE** P_LVALUE_211 = &(PTMP_tmp11_4);
                PrtFreeValue(*P_LVALUE_211);
                *P_LVALUE_211 = PrtSeqGet(p_this->varValues[2], P_VAR_i_3);
                
                PRT_VALUE** P_LVALUE_212 = &(PTMP_tmp12_4);
                PrtFreeValue(*P_LVALUE_212);
                *P_LVALUE_212 = PrtTupleGet(PTMP_tmp11_4, 1);
                
                {
                    PRT_VALUE** P_LVALUE_213 = &(*(PrtMapGetLValue(P_VAR_result_1, PTMP_tmp10_6, PRT_TRUE, &P_GEND_TYPE_MKsecure_StringTypeVs)));
                    PrtFreeValue(*P_LVALUE_213);
                    *P_LVALUE_213 = PTMP_tmp12_4;
                    PTMP_tmp12_4 = NULL;
                }
        ...
        PRT_VALUE** P_LVALUE_214 = &(PTMP_tmp13_3);
        PrtFreeValue(*P_LVALUE_214);
        *P_LVALUE_214 = PrtMkIntValue(PrtPrimGetInt(P_VAR_i_3) + PrtPrimGetInt((&P_LIT_INT32_21)));
        
        {
            PRT_VALUE** P_LVALUE_215 = &(P_VAR_i_3);
            PrtFreeValue(*P_LVALUE_215);
            *P_LVALUE_215 = PTMP_tmp13_3;
            PTMP_tmp13_3 = NULL;
        }
    ...
    PRT_VALUE** P_LVALUE_216 = &(PTMP_tmp14_3);
    PrtFreeValue(*P_LVALUE_216);
    *P_LVALUE_216 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_217 = &(PTMP_tmp15_3);
    PrtFreeValue(*P_LVALUE_217);
    *P_LVALUE_217 = PrtCloneValue((&P_EVENT_TRUSTEDeElectionResults.value));
    
    PRT_VALUE** P_LVALUE_218 = &(PTMP_tmp16_3);
    PrtFreeValue(*P_LVALUE_218);
    *P_LVALUE_218 = PrtCloneValue(P_VAR_result_1);
...
PRT_VALUE* P_Anon_IMPL_19(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_219 = PrtTupleGet(*P_VAR_payload_13, 0);
    
    {
        PRT_VALUE** P_LVALUE_220 = &(p_this->varValues[1]);
    ...
    *P_LVALUE_221 = PrtTupleGet(*P_VAR_payload_13, 1);
    
    {
        PRT_VALUE** P_LVALUE_222 = &(p_this->varValues[2]);
...
PRT_VALUE* P_Anon_IMPL_20(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_223 = &(PTMP_tmp0_19);
    PrtFreeValue(*P_LVALUE_223);
    *P_LVALUE_223 = PrtTupleGet(*P_VAR_payload_14, 2);
    
    {
        PRT_VALUE** P_LVALUE_224 = &(p_this->varValues[3]);
        PrtFreeValue(*P_LVALUE_224);
        *P_LVALUE_224 = PTMP_tmp0_19;
        PTMP_tmp0_19 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_225 = &(PTMP_tmp1_18);
    PrtFreeValue(*P_LVALUE_225);
    *P_LVALUE_225 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    PRT_VALUE** P_LVALUE_226 = &(PTMP_tmp2_15);
    PrtFreeValue(*P_LVALUE_226);
    *P_LVALUE_226 = ((_P_GEN_funargs[0] = &(PTMP_tmp1_18)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp1_18), PTMP_tmp1_18 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_25;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_227 = PrtCloneValue(PrtCastValue(PTMP_tmp2_15, &P_GEND_TYPE_s));
    
    {
        PRT_VALUE** P_LVALUE_228 = &(P_VAR_secure_vote);
        PrtFreeValue(*P_LVALUE_228);
        *P_LVALUE_228 = PTMP_tmp3_13;
        PTMP_tmp3_13 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_229 = &(PTMP_tmp4_12);
    PrtFreeValue(*P_LVALUE_229);
    *P_LVALUE_229 = PrtTupleGet(*P_VAR_payload_14, 0);
    
    PRT_VALUE** P_LVALUE_230 = &(PTMP_tmp5_11);
    PrtFreeValue(*P_LVALUE_230);
    *P_LVALUE_230 = ((_P_GEN_funargs[0] = &(PTMP_tmp4_12)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp4_12), PTMP_tmp4_12 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_25;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_231 = &(PTMP_tmp6_10);
    PrtFreeValue(*P_LVALUE_231);
    *P_LVALUE_231 = PrtCloneValue(PrtCastValue(PTMP_tmp5_11, &P_GEND_TYPE_secure_StringType));
    
    {
        PRT_VALUE** P_LVALUE_232 = &(p_this->varValues[0]);
        PrtFreeValue(*P_LVALUE_232);
        *P_LVALUE_232 = PTMP_tmp6_10;
        PTMP_tmp6_10 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_233 = &(PTMP_tmp7_9);
    PrtFreeValue(*P_LVALUE_233);
    *P_LVALUE_233 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_234 = &(PTMP_tmp8_9);
    PrtFreeValue(*P_LVALUE_234);
    *P_LVALUE_234 = PrtCloneValue((&P_EVENT_TRUSTEDeVote.value));
    
    PRT_VALUE** P_LVALUE_235 = &(PTMP_tmp9_7);
    PrtFreeValue(*P_LVALUE_235);
    *P_LVALUE_235 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_236 = &(PTMP_tmp10_7);
    PrtFreeValue(*P_LVALUE_236);
    *P_LVALUE_236 = PrtTupleGet(*P_VAR_payload_14, 1);
    
    PRT_VALUE** P_LVALUE_237 = &(PTMP_tmp11_5);
    PrtFreeValue(*P_LVALUE_237);
    *P_LVALUE_237 = ((_P_GEN_funargs[0] = &(PTMP_tmp10_7)), (_P_GEN_funval = P_Endorse_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp10_7), PTMP_tmp10_7 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_25;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_238 = PrtCloneValue(PrtCastValue(PTMP_tmp11_5, &P_GEND_TYPE_s));
    
    PRT_VALUE** P_LVALUE_239 = &(PTMP_tmp13_4);
    PrtFreeValue(*P_LVALUE_239);
    *P_LVALUE_239 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
    
    PRT_VALUE** P_LVALUE_240 = &(PTMP_tmp14_4);
    PrtFreeValue(*P_LVALUE_240);
    *P_LVALUE_240 = (PrtMkTuple(&P_GEND_TYPE_T3secure_StringTypessecure_machine_handle, &(PTMP_tmp9_7), &(PTMP_tmp12_5), &(PTMP_tmp13_4)));
...
PRT_VALUE* P_Anon_IMPL_22(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_241 = &(PTMP_tmp0_20);
    PrtFreeValue(*P_LVALUE_241);
    *P_LVALUE_241 = PrtCloneValue(p_this->varValues[2]);
    
    PRT_VALUE** P_LVALUE_242 = &(PTMP_tmp1_19);
    PrtFreeValue(*P_LVALUE_242);
    *P_LVALUE_242 = PrtCloneValue((&P_EVENT_TRUSTEDeGetElectionResults.value));
    
    PRT_VALUE** P_LVALUE_243 = &(PTMP_tmp2_16);
    PrtFreeValue(*P_LVALUE_243);
    *P_LVALUE_243 = PrtCloneValue((P_GetThis_IMPL(context, _P_GEN_funargs)));
...
PRT_VALUE* P_Anon_IMPL_23(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_244 = PrtTupleGet(*P_VAR_payload_15, 0);
    
    PRT_VALUE** P_LVALUE_245 = &(PTMP_tmp1_20);
    PrtFreeValue(*P_LVALUE_245);
    *P_LVALUE_245 = PrtMkSecureBoolValue(PrtMapExists(PTMP_tmp0_21, p_this->varValues[0]));;
    
    PRT_VALUE** P_LVALUE_246 = &(PTMP_tmp2_17);
    PrtFreeValue(*P_LVALUE_246);
    *P_LVALUE_246 = PrtMkSecureBoolValue(!PrtPrimGetSecureBool(PTMP_tmp1_20));
    
    PRT_VALUE** P_LVALUE_247 = &(PTMP_tmp3_14);
    PrtFreeValue(*P_LVALUE_247);
    *P_LVALUE_247 = ((_P_GEN_funargs[0] = &(PTMP_tmp2_17)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp2_17), PTMP_tmp2_17 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_28;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_248 = &(PTMP_tmp4_13);
    PrtFreeValue(*P_LVALUE_248);
    *P_LVALUE_248 = PrtCloneValue(PrtCastValue(PTMP_tmp3_14, &P_GEND_TYPE_b));
    
    if (PrtPrimGetBool(PTMP_tmp4_13))
    {
        PrtPrintf("ERROR: Vote not found!");
        
        PRT_VALUE** P_LVALUE_249 = &(PTMP_tmp5_12);
        PrtFreeValue(*P_LVALUE_249);
        *P_LVALUE_249 = PrtCloneValue((&_P_EVENT_HALT_STRUCT.value));
    ...
    {
        PRT_VALUE** P_LVALUE_250 = &(P_VAR_voteCounted);
        PrtFreeValue(*P_LVALUE_250);
        *P_LVALUE_250 = PrtCloneValue((&P_LIT_BOOLEAN_5));
        
    }
    
    
    PRT_VALUE** P_LVALUE_251 = &(PTMP_tmp6_11);
    PrtFreeValue(*P_LVALUE_251);
    *P_LVALUE_251 = PrtCloneValue(p_this->varValues[3]);
    
    PRT_VALUE** P_LVALUE_252 = &(PTMP_tmp7_10);
    PrtFreeValue(*P_LVALUE_252);
    *P_LVALUE_252 = PrtCloneValue((&P_EVENT_UNTRUSTEDGetResults.value));
    
    PRT_VALUE** P_LVALUE_253 = &(PTMP_tmp8_10);
    PrtFreeValue(*P_LVALUE_253);
    *P_LVALUE_253 = PrtTupleGet(*P_VAR_payload_15, 1);
    
    PRT_VALUE** P_LVALUE_254 = &(PTMP_tmp9_8);
    PrtFreeValue(*P_LVALUE_254);
    *P_LVALUE_254 = ((_P_GEN_funargs[0] = &(PTMP_tmp8_10)), (_P_GEN_funval = P_Declassify_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp8_10), PTMP_tmp8_10 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_28;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    PRT_VALUE** P_LVALUE_255 = &(PTMP_tmp10_8);
    PrtFreeValue(*P_LVALUE_255);
    *P_LVALUE_255 = PrtCloneValue(PrtCastValue(PTMP_tmp9_8, &P_GEND_TYPE_i));
    
    PRT_VALUE** P_LVALUE_256 = &(PTMP_tmp11_6);
    PrtFreeValue(*P_LVALUE_256);
    *P_LVALUE_256 = PrtCloneValue(P_VAR_voteCounted);
    
    PRT_VALUE** P_LVALUE_257 = &(PTMP_tmp12_6);
    PrtFreeValue(*P_LVALUE_257);
    *P_LVALUE_257 = (PrtMkTuple(&P_GEND_TYPE_T2ib, &(PTMP_tmp10_8), &(PTMP_tmp11_6)));
...
PRT_VALUE* P_Anon_IMPL_24(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_258 = &(PTMP_tmp0_22);
