...
PRT_VALUE* P_Anon_IMPL_5(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_73);
    *P_LVALUE_73 = PrtMkStringValue(PrtFormatString("SecureVotingClientMachine", 0, 0));
    ;
    
    {
        PRT_VALUE** P_LVALUE_74 = &(P_VAR_machineTypeToValidate);
        PrtFreeValue(*P_LVALUE_74);
        *P_LVALUE_74 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_75 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_75);
    *P_LVALUE_75 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp2_5);
    PrtFreeValue(*P_LVALUE_76);
    *P_LVALUE_76 = PrtCloneValue(P_VAR_machineTypeToValidate);
    
    PRT_VALUE** P_LVALUE_77 = &(PTMP_tmp3_5);
    PrtFreeValue(*P_LVALUE_77);
    *P_LVALUE_77 = ((_P_GEN_funargs[0] = &(PTMP_tmp1_6)), (_P_GEN_funargs[1] = &(PTMP_tmp2_5)), (_P_GEN_funval = P_localAuthenticate_IMPL(context, _P_GEN_funargs)), (PrtFreeValue(PTMP_tmp1_6), PTMP_tmp1_6 = NULL), (PrtFreeValue(PTMP_tmp2_5), PTMP_tmp2_5 = NULL), (_P_GEN_funval));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_6;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_78 = PrtCloneValue(*P_VAR_payload_2);
